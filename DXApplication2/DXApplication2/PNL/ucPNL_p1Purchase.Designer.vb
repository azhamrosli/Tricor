...
Partial Class ucPNL_p1Purchase
    ...
    Private Sub InitializeComponent()
        ...
        Me.PLPURCHASEBindingSource = New System.Windows.Forms.BindingSource(Me.components)
        Me.colPL_PLTYPE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPL_KEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPL_PLFCSKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPL_SOURCENO = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPL_DESC = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPL_AMOUNT = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPL_NOTE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPL_DETAIL = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPL_1 = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPL_2 = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPL_DEDUCTIBLE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLD_PLTYPE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLD_KEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLD_PLFCSKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLD_SOURCENO = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLD_PLFCSDKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLD_DESC = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLD_AMOUNT = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLD_NOTE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLD_DEDUCTIBLE = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        CType(Me.PLPURCHASEBindingSource, System.ComponentModel.ISupportInitialize).BeginInit()
        Me.SuspendLayout()
        '
        'GridView2
        '
        Me.GridView2.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colPLD_PLTYPE, Me.colPLD_KEY, Me.colPLD_PLFCSKEY, Me.colPLD_SOURCENO, Me.colPLD_PLFCSDKEY, Me.colPLD_DESC, Me.colPLD_AMOUNT, Me.colPLD_DEDUCTIBLE, Me.colPLD_NOTE})
        ...
        'GridControl1
        '
        Me.GridControl1.DataSource = Me.PLPURCHASEBindingSource
        Me.GridControl1.Dock = System.Windows.Forms.DockStyle.Fill
        GridLevelNode1.LevelTemplate = Me.GridView2
        GridLevelNode1.RelationName = "FK_PL_PURCHASE_PL_PURCHASE_DETAIL"
        ...
        'GridView1
        '
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colPL_PLTYPE, Me.colPL_KEY, Me.colPL_PLFCSKEY, Me.colPL_SOURCENO, Me.colPL_DESC, Me.colPL_AMOUNT, Me.colPL_NOTE, Me.colPL_DEDUCTIBLE, Me.colPL_DETAIL, Me.colPL_1, Me.colPL_2})
    ...
    "ues with select child row(s)."
        ...
        '
        'PLPURCHASEBindingSource
        '
        Me.PLPURCHASEBindingSource.DataMember = "PL_PURCHASE"
        Me.PLPURCHASEBindingSource.DataSource = Me.DsPNL1
        '
        'colPL_PLTYPE
        '
        Me.colPL_PLTYPE.FieldName = "PL_PLTYPE"
        Me.colPL_PLTYPE.Name = "colPL_PLTYPE"
        '
        'colPL_KEY
        '
        ...
        'colPL_PLFCSKEY
        '
        Me.colPL_PLFCSKEY.FieldName = "PL_PLFCSKEY"
        Me.colPL_PLFCSKEY.Name = "colPL_PLFCSKEY"
        '
        'colPL_SOURCENO
        '
        Me.colPL_SOURCENO.Caption = "Source No"
        Me.colPL_SOURCENO.ColumnEdit = Me.cboSourceNo
        Me.colPL_SOURCENO.FieldName = "PL_SOURCENO"
        Me.colPL_SOURCENO.Name = "colPL_SOURCENO"
        Me.colPL_SOURCENO.Visible = True
        Me.colPL_SOURCENO.VisibleIndex = 0
        Me.colPL_SOURCENO.Width = 120
        '
        'colPL_DESC
        '
        Me.colPL_DESC.Caption = "Description"
        Me.colPL_DESC.FieldName = "PL_DESC"
        Me.colPL_DESC.Name = "colPL_DESC"
        Me.colPL_DESC.Visible = True
        Me.colPL_DESC.VisibleIndex = 1
        Me.colPL_DESC.Width = 300
        '
        'colPL_AMOUNT
        '
        Me.colPL_AMOUNT.Caption = "Amount"
        Me.colPL_AMOUNT.ColumnEdit = Me.txtNumberic
        Me.colPL_AMOUNT.FieldName = "PL_AMOUNT"
        Me.colPL_AMOUNT.Name = "colPL_AMOUNT"
        Me.colPL_AMOUNT.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "PL_AMOUNT", "{0:n0}")})
        Me.colPL_AMOUNT.Visible = True
        Me.colPL_AMOUNT.VisibleIndex = 2
        Me.colPL_AMOUNT.Width = 120
        '
        'colPL_NOTE
        '
        Me.colPL_NOTE.Caption = "Note"
        Me.colPL_NOTE.ColumnEdit = Me.txtNote
        Me.colPL_NOTE.FieldName = "PL_NOTE"
        Me.colPL_NOTE.Name = "colPL_NOTE"
        Me.colPL_NOTE.Visible = True
        Me.colPL_NOTE.VisibleIndex = 3
        Me.colPL_NOTE.Width = 300
        '
        'colPL_DETAIL
        '
        Me.colPL_DETAIL.Caption = "Details"
        Me.colPL_DETAIL.FieldName = "PL_DETAIL"
        Me.colPL_DETAIL.Name = "colPL_DETAIL"
        Me.colPL_DETAIL.OptionsColumn.AllowEdit = False
        Me.colPL_DETAIL.OptionsColumn.TabStop = False
        Me.colPL_DETAIL.Visible = True
        Me.colPL_DETAIL.VisibleIndex = 5
        Me.colPL_DETAIL.Width = 120
        '
        'colPL_1
        '
        ...
        'colPL_DEDUCTIBLE
        '
        Me.colPL_DEDUCTIBLE.Caption = "Deductible"
        Me.colPL_DEDUCTIBLE.ColumnEdit = Me.chk
        Me.colPL_DEDUCTIBLE.FieldName = "PL_DEDUCTIBLE"
        Me.colPL_DEDUCTIBLE.Name = "colPL_DEDUCTIBLE"
        Me.colPL_DEDUCTIBLE.Visible = True
        Me.colPL_DEDUCTIBLE.VisibleIndex = 4
        Me.colPL_DEDUCTIBLE.Width = 120
        '
        'colPLD_PLTYPE
        '
        Me.colPLD_PLTYPE.FieldName = "PLD_PLTYPE"
        Me.colPLD_PLTYPE.Name = "colPLD_PLTYPE"
        '
        'colPLD_KEY
        '
        Me.colPLD_KEY.FieldName = "PLD_KEY"
        Me.colPLD_KEY.Name = "colPLD_KEY"
        '
        'colPLD_PLFCSKEY
        '
        Me.colPLD_PLFCSKEY.FieldName = "PLD_PLFCSKEY"
        Me.colPLD_PLFCSKEY.Name = "colPLD_PLFCSKEY"
        '
        'colPLD_SOURCENO
        '
        Me.colPLD_SOURCENO.FieldName = "PLD_SOURCENO"
        Me.colPLD_SOURCENO.Name = "colPLD_SOURCENO"
        '
        'colPLD_PLFCSDKEY
        '
        Me.colPLD_PLFCSDKEY.FieldName = "PLD_PLFCSDKEY"
        Me.colPLD_PLFCSDKEY.Name = "colPLD_PLFCSDKEY"
        '
        'colPLD_DESC
        '
        Me.colPLD_DESC.Caption = "Description"
        Me.colPLD_DESC.FieldName = "PLD_DESC"
        Me.colPLD_DESC.Name = "colPLD_DESC"
        Me.colPLD_DESC.Visible = True
        Me.colPLD_DESC.VisibleIndex = 0
        Me.colPLD_DESC.Width = 300
        '
        'colPLD_AMOUNT
        '
        Me.colPLD_AMOUNT.Caption = "Amount"
        Me.colPLD_AMOUNT.ColumnEdit = Me.txtNumberic
        Me.colPLD_AMOUNT.FieldName = "PLD_AMOUNT"
        Me.colPLD_AMOUNT.Name = "colPLD_AMOUNT"
        Me.colPLD_AMOUNT.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "PLD_AMOUNT", "{0:n0}")})
        Me.colPLD_AMOUNT.Visible = True
        Me.colPLD_AMOUNT.VisibleIndex = 1
        Me.colPLD_AMOUNT.Width = 120
        '
        'colPLD_NOTE
        '
        Me.colPLD_NOTE.Caption = "Note"
        Me.colPLD_NOTE.ColumnEdit = Me.txtNote
        Me.colPLD_NOTE.FieldName = "PLD_NOTE"
        Me.colPLD_NOTE.Name = "colPLD_NOTE"
        Me.colPLD_NOTE.Visible = True
        Me.colPLD_NOTE.VisibleIndex = 3
        Me.colPLD_NOTE.Width = 300
        '
        'colPLD_DEDUCTIBLE
        '
        Me.colPLD_DEDUCTIBLE.Caption = "Deductible"
        Me.colPLD_DEDUCTIBLE.ColumnEdit = Me.chk
        Me.colPLD_DEDUCTIBLE.FieldName = "PLD_DEDUCTIBLE"
        Me.colPLD_DEDUCTIBLE.Name = "colPLD_DEDUCTIBLE"
        Me.colPLD_DEDUCTIBLE.Visible = True
        Me.colPLD_DEDUCTIBLE.VisibleIndex = 2
        Me.colPLD_DEDUCTIBLE.Width = 120
        '
        'ucPNL_p1Purchase
        '
        ...
        CType(Me.PLPURCHASEBindingSource, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents colPLD_PLTYPE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLD_KEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLD_PLFCSKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLD_SOURCENO As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLD_PLFCSDKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLD_DESC As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLD_AMOUNT As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLD_DEDUCTIBLE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLD_NOTE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents PLPURCHASEBindingSource As System.Windows.Forms.BindingSource
    Friend WithEvents DsPNL1 As EasyTemplate_Taxcom_B.dsPNL
    Friend WithEvents colPL_PLTYPE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPL_KEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPL_PLFCSKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPL_SOURCENO As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPL_DESC As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPL_AMOUNT As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPL_NOTE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPL_DEDUCTIBLE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPL_DETAIL As DevExpress.XtraGrid.Columns.GridColumn
