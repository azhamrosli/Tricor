...
Public Class frm_rptLampiranA1
    ...
    Private Sub LoadData()
        Try
            ...
            Dim dt As DataTable = ADO.Load_Tax_Computation(mdlProcess.ArgParam2, mdlProcess.ArgParam3)
    ...
    Private Sub TempAINonTaxableIncome()
        Try
            If ADO.Delete_REPORT1_AI(ErrorLog) = False Then
            ...
            dtPNL = ADO.Load_PNL(mdlProcess.ArgParam2, mdlProcess.ArgParam3, ErrorLog)
            ...
            For i As Integer = 0 To dtPNL.Rows.Count - 1
                If dtPNL IsNot Nothing AndAlso IsDBNull(dtPNL.Rows(0)("PL_KEY")) = False Then
                    ...
                    NO = 1
                    dtPNLDetails = ADO.Load_rptLampiranA1_AiNonTaxableIncome(Header & " - 1", CInt(dtPNL.Rows(0)("PL_KEY")), ErrorLog)

                    If dtPNLDetails IsNot Nothing Then
                        RowIvt = 0
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report1_AI(IIf(IsDBNull(row("NTIDFA_KEY")), 0, row("NTIDFA_KEY")), NO, Header, IIf(IsDBNull(row("NTIDFA_NTIDFAKEY")), 0, row("NTIDFA_NTIDFAKEY")), _
                    ...
                    dtPNLDetails = ADO.Load_rptLampiranA1_AiNonTaxableIncome(Header & " - 2", CInt(dtPNL.Rows(0)("PL_KEY")), ErrorLog)

                    If dtPNLDetails IsNot Nothing Then
                        RowIvt = 0
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT1_AI_DETAIL(IIf(IsDBNull(row("NTIDFAD_KEY")), 0, row("NTIDFAD_KEY")), NO, IIf(IsDBNull(row("NTIDFAD_EXDEPKEY")), 0, row("NTIDFAD_EXDEPKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report1_AI(IIf(IsDBNull(row("NTIDI_KEY")), 0, row("NTIDI_KEY")), NO, Header, IIf(IsDBNull(row("NTIDI_NTIDIKEY")), 0, row("NTIDI_NTIDIKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT1_AI_DETAIL(IIf(IsDBNull(row("NTIDID_KEY")), 0, row("NTIDID_KEY")), NO, IIf(IsDBNull(row("NTIDID_NTIDIKEY")), 0, row("NTIDID_NTIDIKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report1_AI(IIf(IsDBNull(row("NTIFIR_KEY")), 0, row("NTIFIR_KEY")), NO, Header, IIf(IsDBNull(row("NTIFIR_NTIFIRKEY")), 0, row("NTIFIR_NTIFIRKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT1_AI_DETAIL(IIf(IsDBNull(row("NTIFIRD_KEY")), 0, row("NTIFIRD_KEY")), NO, IIf(IsDBNull(row("NTIFIRD_NTIFIRKEY")), 0, row("NTIFIRD_NTIFIRKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report1_AI(IIf(IsDBNull(row("NTIRFECT_KEY")), 0, row("NTIRFECT_KEY")), NO, Header, IIf(IsDBNull(row("NTIRFECT_NTIRFECTKEY")), 0, row("NTIRFECT_NTIRFECTKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT1_AI_DETAIL(IIf(IsDBNull(row("NTIRFECTD_KEY")), 0, row("NTIRFECTD_KEY")), NO, IIf(IsDBNull(row("NTIRFECTD_NTIRFECTKEY")), 0, row("NTIRFECTD_NTIRFECTKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report1_AI(IIf(IsDBNull(row("NTIUT_KEY")), 0, row("NTIUT_KEY")), NO, Header, IIf(IsDBNull(row("NTIUT_NTIUTKEY")), 0, row("NTIUT_NTIUTKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT1_AI_DETAIL(IIf(IsDBNull(row("NTIUTD_KEY")), 0, row("NTIUTD_KEY")), NO, IIf(IsDBNull(row("NTIUTD_NTIUTKEY")), 0, row("NTIUTD_NTIUTKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report1_AI(IIf(IsDBNull(row("NTIUNT_KEY")), 0, row("NTIUNT_KEY")), NO, Header, IIf(IsDBNull(row("NTIUNT_NTIUNTKEY")), 0, row("NTIUNT_NTIUNTKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT1_AI_DETAIL(IIf(IsDBNull(row("NTIUNTD_KEY")), 0, row("NTIUNTD_KEY")), NO, IIf(IsDBNull(row("NTIUNTD_NTIUNTKEY")), 0, row("NTIUNTD_NTIUNTKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report1_AI(IIf(IsDBNull(row("NT_KEY")), 0, row("NT_KEY")), NO, Header, IIf(IsDBNull(row("NT_NTKEY")), 0, row("NT_NTKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT1_AI_DETAIL(IIf(IsDBNull(row("NTD_KEY")), 0, row("NTD_KEY")), NO, IIf(IsDBNull(row("NTD_NTKEY")), 0, row("NTD_NTKEY")), _
    ...
    Private Sub TempAdjustedIncome()
        Try
            If ADO.Delete_REPORT_AI(ErrorLog) = False Then
            ...
            For i As Integer = 0 To dtPNL.Rows.Count - 1
                If dtPNL IsNot Nothing AndAlso IsDBNull(dtPNL.Rows(0)("PL_KEY")) = False Then
                    ...
                    NO = 2
                    dtPNLDetails = ADO.Load_rptLampiranA1_AdjustedIncome(Header & " - 1", CInt(dtPNL.Rows(0)("PL_KEY")), ErrorLog)

                    If dtPNLDetails IsNot Nothing Then
                        RowIvt = 0
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report_AI(IIf(IsDBNull(row("EXDEP_KEY")), 0, row("EXDEP_KEY")), NO, Header, IIf(IsDBNull(row("EXDEP_EXDEPKEY")), 0, row("EXDEP_EXDEPKEY")), _
                    ...
                    dtPNLDetails = ADO.Load_rptLampiranA1_AdjustedIncome(Header & " - 2", CInt(dtPNL.Rows(0)("PL_KEY")), ErrorLog)

                    If dtPNLDetails IsNot Nothing Then
                        RowIvt = 0
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT_AI_DETAIL(IIf(IsDBNull(row("EXDEPD_KEY")), 0, row("EXDEPD_KEY")), NO, IIf(IsDBNull(row("EXDEPD_EXDEPKEY")), 0, row("EXDEPD_EXDEPKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report_AI(IIf(IsDBNull(row("EXNA_KEY")), 0, row("EXNA_KEY")), NO, Header, IIf(IsDBNull(row("EXNA_EXNAKEY")), 0, row("EXNA_EXNAKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT_AI_DETAIL(IIf(IsDBNull(row("EXNAD_KEY")), 0, row("EXNAD_KEY")), NO, IIf(IsDBNull(row("EXNAD_EXNAKEY")), 0, row("EXNAD_EXNAKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report_AI(IIf(IsDBNull(row("EXI_KEY")), 0, row("EXI_KEY")), NO, Header, IIf(IsDBNull(row("EXI_EXIKEY")), 0, row("EXI_EXIKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT_AI_DETAIL(IIf(IsDBNull(row("EXID_KEY")), 0, row("EXID_KEY")), NO, IIf(IsDBNull(row("EXID_EXIKEY")), 0, row("EXID_EXIKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report_AI(IIf(IsDBNull(row("EXL_KEY")), 0, row("EXL_KEY")), NO, Header, IIf(IsDBNull(row("EXL_EXLKEY")), 0, row("EXL_EXLKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT_AI_DETAIL(IIf(IsDBNull(row("EXLD_KEY")), 0, row("EXLD_KEY")), NO, IIf(IsDBNull(row("EXLD_EXLKEY")), 0, row("EXLD_EXLKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report_AI(IIf(IsDBNull(row("EXC_KEY")), 0, row("EXC_KEY")), NO, Header, IIf(IsDBNull(row("EXC_EXCKEY")), 0, row("EXC_EXCKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT_AI_DETAIL(IIf(IsDBNull(row("EXCD_KEY")), 0, row("EXCD_KEY")), NO, IIf(IsDBNull(row("EXCD_EXCKEY")), 0, row("EXCD_EXCKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report_AI(IIf(IsDBNull(row("EXS_KEY")), 0, row("EXS_KEY")), NO, Header, IIf(IsDBNull(row("EXS_EXSKEY")), 0, row("EXS_EXSKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT_AI_DETAIL(IIf(IsDBNull(row("EXSD_KEY")), 0, row("EXSD_KEY")), NO, IIf(IsDBNull(row("EXSD_EXSKEY")), 0, row("EXSD_EXSKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report_AI(IIf(IsDBNull(row("EXRO_KEY")), 0, row("EXRO_KEY")), NO, Header, IIf(IsDBNull(row("EXRO_EXROKEY")), 0, row("EXRO_EXROKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT_AI_DETAIL(IIf(IsDBNull(row("EXROD_KEY")), 0, row("EXROD_KEY")), NO, IIf(IsDBNull(row("EXROD_EXROKEY")), 0, row("EXROD_EXROKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report_AI(IIf(IsDBNull(row("EXRENT_KEY")), 0, row("EXRENT_KEY")), NO, Header, IIf(IsDBNull(row("EXRENT_EXRENTKEY")), 0, row("EXRENT_EXRENTKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT_AI_DETAIL(IIf(IsDBNull(row("EXRENTD_KEY")), 0, row("EXRENTD_KEY")), NO, IIf(IsDBNull(row("EXRENTD_EXRENTKEY")), 0, row("EXRENTD_EXRENTKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report_AI(IIf(IsDBNull(row("EXREP_KEY")), 0, row("EXREP_KEY")), NO, Header, IIf(IsDBNull(row("EXREP_EXREPKEY")), 0, row("EXREP_EXREPKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT_AI_DETAIL(IIf(IsDBNull(row("EXREPD_KEY")), 0, row("EXREPD_KEY")), NO, IIf(IsDBNull(row("EXREPD_EXREPKEY")), 0, row("EXREPD_EXREPKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report_AI(IIf(IsDBNull(row("EXRES_KEY")), 0, row("EXRES_KEY")), NO, Header, IIf(IsDBNull(row("EXRES_EXRESKEY")), 0, row("EXRES_EXRESKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT_AI_DETAIL(IIf(IsDBNull(row("EXRESD_KEY")), 0, row("EXRESD_KEY")), NO, IIf(IsDBNull(row("EXRESD_EXRESKEY")), 0, row("EXRESD_EXRESKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report_AI(IIf(IsDBNull(row("EXP_KEY")), 0, row("EXP_KEY")), NO, Header, IIf(IsDBNull(row("EXP_EXPKEY")), 0, row("EXP_EXPKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT_AI_DETAIL(IIf(IsDBNull(row("EXPD_KEY")), 0, row("EXPD_KEY")), NO, IIf(IsDBNull(row("EXPD_EXPKEY")), 0, row("EXPD_EXPKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report_AI(IIf(IsDBNull(row("EXT_KEY")), 0, row("EXT_KEY")), NO, Header, IIf(IsDBNull(row("EXT_EXTKEY")), 0, row("EXT_EXTKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT_AI_DETAIL(IIf(IsDBNull(row("EXTD_KEY")), 0, row("EXTD_KEY")), NO, IIf(IsDBNull(row("EXTD_EXTKEY")), 0, row("EXTD_EXTKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report_AI(IIf(IsDBNull(row("EXODEP_KEY")), 0, row("EXODEP_KEY")), NO, Header, IIf(IsDBNull(row("EXODEP_EXODEPKEY")), 0, row("EXODEP_EXODEPKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT_AI_DETAIL(IIf(IsDBNull(row("EXODEPD_KEY")), 0, row("EXODEPD_KEY")), NO, IIf(IsDBNull(row("EXODEPD_EXODEPKEY")), 0, row("EXODEPD_EXODEPKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report_AI(IIf(IsDBNull(row("EXOAD_KEY")), 0, row("EXOAD_KEY")), NO, Header, IIf(IsDBNull(row("EXOAD_EXOADKEY")), 0, row("EXOAD_EXOADKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT_AI_DETAIL(IIf(IsDBNull(row("EXOADD_KEY")), 0, row("EXOADD_KEY")), NO, IIf(IsDBNull(row("EXOADD_EXOADKEY")), 0, row("EXOADD_EXOADKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report_AI(IIf(IsDBNull(row("EXONAD_KEY")), 0, row("EXONAD_KEY")), NO, Header, IIf(IsDBNull(row("EXONAD_EXONADKEY")), 0, row("EXONAD_EXONADKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT_AI_DETAIL(IIf(IsDBNull(row("EXONADD_KEY")), 0, row("EXONADD_KEY")), NO, IIf(IsDBNull(row("EXONADD_EXONADKEY")), 0, row("EXONADD_EXONADKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report_AI(IIf(IsDBNull(row("EXOZ_KEY")), 0, row("EXOZ_KEY")), NO, Header, IIf(IsDBNull(row("EXOZ_EXOZKEY")), 0, row("EXOZ_EXOZKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT_AI_DETAIL(IIf(IsDBNull(row("EXOZD_KEY")), 0, row("EXOZD_KEY")), NO, IIf(IsDBNull(row("EXOZD_EXOZKEY")), 0, row("EXOZD_EXOZKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report_AI(IIf(IsDBNull(row("EXOENS_KEY")), 0, row("EXOENS_KEY")), NO, Header, IIf(IsDBNull(row("EXOENS_EXOENSKEY")), 0, row("EXOENS_EXOENSKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT_AI_DETAIL(IIf(IsDBNull(row("EXOENSD_KEY")), 0, row("EXOENSD_KEY")), NO, IIf(IsDBNull(row("EXOENSD_EXOENSKEY")), 0, row("EXOENSD_EXOENSKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report_AI(IIf(IsDBNull(row("EXOES_KEY")), 0, row("EXOES_KEY")), NO, Header, IIf(IsDBNull(row("EXOES_EXOESKEY")), 0, row("EXOES_EXOESKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT_AI_DETAIL(IIf(IsDBNull(row("EXOESD_KEY")), 0, row("EXOESD_KEY")), NO, IIf(IsDBNull(row("EXOESD_EXOESKEY")), 0, row("EXOESD_EXOESKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report_AI(IIf(IsDBNull(row("EXOP_KEY")), 0, row("EXOP_KEY")), NO, Header, IIf(IsDBNull(row("EXOP_EXOPKEY")), 0, row("EXOP_EXOPKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT_AI_DETAIL(IIf(IsDBNull(row("EXOPD_KEY")), 0, row("EXOPD_KEY")), NO, IIf(IsDBNull(row("EXOPD_EXOPKEY")), 0, row("EXOPD_EXOPKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report_AI(IIf(IsDBNull(row("EXOPA_KEY")), 0, row("EXOPA_KEY")), NO, Header, IIf(IsDBNull(row("EXOPA_EXOPAKEY")), 0, row("EXOPA_EXOPAKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT_AI_DETAIL(IIf(IsDBNull(row("EXOPAD_KEY")), 0, row("EXOPAD_KEY")), NO, IIf(IsDBNull(row("EXOPAD_EXOPAKEY")), 0, row("EXOPAD_EXOPAKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report_AI(IIf(IsDBNull(row("EXOLP_KEY")), 0, row("EXOLP_KEY")), NO, Header, IIf(IsDBNull(row("EXOLP_EXOLPKEY")), 0, row("EXOLP_EXOLPKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT_AI_DETAIL(IIf(IsDBNull(row("EXOLPD_KEY")), 0, row("EXOLPD_KEY")), NO, IIf(IsDBNull(row("EXOLPD_EXOLPKEY")), 0, row("EXOLPD_EXOLPKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report_AI(IIf(IsDBNull(row("EXOWO_KEY")), 0, row("EXOWO_KEY")), NO, Header, IIf(IsDBNull(row("EXOWO_EXOWOKEY")), 0, row("EXOWO_EXOWOKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT_AI_DETAIL(IIf(IsDBNull(row("EXOWOD_KEY")), 0, row("EXOWOD_KEY")), NO, IIf(IsDBNull(row("EXOWOD_EXOWOKEY")), 0, row("EXOWOD_EXOWOKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report_AI(IIf(IsDBNull(row("EXOIS_KEY")), 0, row("EXOIS_KEY")), NO, Header, IIf(IsDBNull(row("EXOIS_EXOISKEY")), 0, row("EXOIS_EXOISKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT_AI_DETAIL(IIf(IsDBNull(row("EXOISD_KEY")), 0, row("EXOISD_KEY")), NO, IIf(IsDBNull(row("EXOISD_EXOISKEY")), 0, row("EXOISD_EXOISKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report_AI(IIf(IsDBNull(row("EXOCE_KEY")), 0, row("EXOCE_KEY")), NO, Header, IIf(IsDBNull(row("EXOCE_EXOCEKEY")), 0, row("EXOCE_EXOCEKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT_AI_DETAIL(IIf(IsDBNull(row("EXOCED_KEY")), 0, row("EXOCED_KEY")), NO, IIf(IsDBNull(row("EXOCED_EXOCEKEY")), 0, row("EXOCED_EXOCEKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report_AI(IIf(IsDBNull(row("EXO_KEY")), 0, row("EXO_KEY")), NO, Header, IIf(IsDBNull(row("EXO_EXOKEY")), 0, row("EXO_EXOKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT_AI_DETAIL(IIf(IsDBNull(row("EXOD_KEY")), 0, row("EXOD_KEY")), NO, IIf(IsDBNull(row("EXOD_EXOKEY")), 0, row("EXOD_EXOKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report_AI(IIf(IsDBNull(row("EXTF_KEY")), 0, row("EXTF_KEY")), NO, Header, IIf(IsDBNull(row("EXTF_EXTFKEY")), 0, row("EXTF_EXTFKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT_AI_DETAIL(IIf(IsDBNull(row("EXTFD_KEY")), 0, row("EXTFD_KEY")), NO, IIf(IsDBNull(row("EXTFD_EXTFKEY")), 0, row("EXTFD_EXTFKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report_AI(IIf(IsDBNull(row("EXES_KEY")), 0, row("EXES_KEY")), NO, Header, IIf(IsDBNull(row("EXES_EXESKEY")), 0, row("EXES_EXESKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT_AI_DETAIL(IIf(IsDBNull(row("EXESD_KEY")), 0, row("EXESD_KEY")), NO, IIf(IsDBNull(row("EXESD_EXESKEY")), 0, row("EXESD_EXESKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report_AI(IIf(IsDBNull(row("PLFRUP_KEY")), 0, row("PLFRUP_KEY")), NO, Header, IIf(IsDBNull(row("PLFRUP_PLFRUPKEY")), 0, row("PLFRUP_PLFRUPKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT_AI_DETAIL(IIf(IsDBNull(row("PLFRUPD_KEY")), 0, row("PLFRUPD_KEY")), NO, IIf(IsDBNull(row("PLFRUPD_PLFRUPKEY")), 0, row("PLFRUPD_PLFRUPKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report_AI(IIf(IsDBNull(row("EXORT_KEY")), 0, row("EXORT_KEY")), NO, Header, IIf(IsDBNull(row("EXORT_EXORTKEY")), 0, row("EXORT_EXORTKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT_AI_DETAIL(IIf(IsDBNull(row("EXORTD_KEY")), 0, row("EXORTD_KEY")), NO, IIf(IsDBNull(row("EXORTD_EXORTKEY")), 0, row("EXORTD_EXORTKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report_AI(IIf(IsDBNull(row("EXDF_KEY")), 0, row("EXDF_KEY")), NO, Header, IIf(IsDBNull(row("EXDF_EXDFKEY")), 0, row("EXDF_EXDFKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT_AI_DETAIL(IIf(IsDBNull(row("EXDFD_KEY")), 0, row("EXDFD_KEY")), NO, IIf(IsDBNull(row("EXDFD_EXDFKEY")), 0, row("EXDFD_EXDFKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_Report_AI(IIf(IsDBNull(row("EXJK_KEY")), 0, row("EXJK_KEY")), NO, Header, IIf(IsDBNull(row("EXJK_EXJKKEY")), 0, row("EXJK_EXJKKEY")), _
                    ...
                    If dtPNLDetails IsNot Nothing Then
                        ...
                        For Each row As DataRow In dtPNLDetails.Rows
                            RowIvt += 1
                            ADO.Save_REPORT_AI_DETAIL(IIf(IsDBNull(row("EXJKD_KEY")), 0, row("EXJKD_KEY")), NO, IIf(IsDBNull(row("EXJKD_EXJKKEY")), 0, row("EXJKD_EXJKKEY")), _
    ...
    Private Sub TempValSecA()
        Try
            ...
            If ADO.Delete_REPORT_AI_BAL(mdlProcess.ArgParam2, ErrorLog) = False Then
                MsgBox("Failed to clear Report AI BAL." & vbCrLf & ErrorLog.ErrorMessage, MsgBoxStyle.Critical)
                Exit Sub
            End If


            Dim dtBusinessSource As DataTable = ADO.Load_rptLampiranA1_BusinessSource(mdlProcess.ArgParam2, mdlProcess.ArgParam3, ErrorLog)
            ...
            For i As Integer = 0 To dtBusinessSource.Rows.Count - 1
                ...
                If IsDBNull(dtBusinessSource.Rows(i)("BC_KEY")) = False AndAlso IsDBNull(dtBusinessSource.Rows(i)("BC_YA")) = False Then
                    ...
                    dtPNL = ADO.Load_PNL(dtBusinessSource.Rows(i)("BC_KEY").ToString, dtBusinessSource.Rows(i)("BC_YA").ToString, ErrorLog)
                    ...
                    If dtPNL IsNot Nothing AndAlso IsDBNull(dtPNL.Rows(0)("PL_KEY")) = False Then
                        ...
                        dtPNLDetails = ADO.Load_PNL_NonAllowDetails(Header, CInt(dtPNL.Rows(0)("PL_KEY")), CInt(dtBusinessSource.Rows(i)("BC_KEY")), ErrorLog)

                        If dtPNLDetails IsNot Nothing Then
                            NA_Exp = 0
                            CalcNa(dtPNLDetails, ColumnName, NA_Exp)
                            ADO.Save_Report_AI_BAL(CInt(dtPNL.Rows(0)("PL_KEY")), mdlProcess.ArgParam2, dtPNL.Rows(0)("PL_YA").ToString, _
                        ...
                        If CInt(dtBusinessSource.Rows(i)("BC_SOURCENO")) > 1 Then
                            dtPNLDetails = ADO.Load_PNL_NonAllowDetails(Header & " - 1", CInt(dtPNL.Rows(0)("PL_KEY")), CInt(dtBusinessSource.Rows(i)("BC_KEY")), ErrorLog)
                            ...
                            dtPNLDetails = ADO.Load_PNL_NonAllowDetails(Header & " - 2", CInt(dtPNL.Rows(0)("PL_KEY")), CInt(dtBusinessSource.Rows(i)("BC_KEY")), ErrorLog)
                        ...
                        If CInt(dtBusinessSource.Rows(i)("BC_SOURCENO")) > 1 Then
                            ...
                            dtPNLDetails = ADO.Load_PNL_NonAllowDetails(Header & " - 3", CInt(dtPNL.Rows(0)("PL_KEY")), CInt(dtBusinessSource.Rows(i)("BC_KEY")), ErrorLog)
