...
Public Class ucPNL_p2InterestIncome
    ...
    Public Const MainTable As String = "INCOME_NBINTEREST" 'PLFST_SALES
    Public Const MainTable_Details As String = "INCOME_NBINTEREST_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "NOBII_NOBIIKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "NOBIID_NOBIIKEY" 'PLFSD_PLFSKEY
    ...
    Public Sub LoadData(Optional ByRef Errorlog As clsError = Nothing)
        Try
            ...
            INCOMENBINTERESTBindingSource.DataSource = DsPNL1.Tables(MainTable)
