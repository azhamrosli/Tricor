...
Public Class ucPNL_p2ProDisInvestment
    Public txtAmount As DevExpress.XtraEditors.TextEdit
    Public RefNo As String = Nothing
    Public YA As String = Nothing
    Public isEdit As Boolean = False

    Public Const MainTable As String = "INCOME_NTDISPOSALINVEST" 'PLFST_SALES
    Public Const MainTable_Details As String = "INCOME_NTDISPOSALINVEST_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "NTIDI_NTIDIKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "NTIDID_NTIDIKEY" 'PLFSD_PLFSKEY
    ...
    Public Sub LoadData(Optional ByRef Errorlog As clsError = Nothing)
        Try
            ...
            INCOMENTDISPOSALINVESTBindingSource.DataSource = DsPNL1.Tables(MainTable)
