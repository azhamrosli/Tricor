...
Public Class ucPNL_p2ProDispPlantEq
    Public txtAmount As DevExpress.XtraEditors.TextEdit
    Public RefNo As String = Nothing
    Public YA As String = Nothing
    Public isEdit As Boolean = False

    Public Const MainTable As String = "INCOME_NTDISPOSALFA" 'PLFST_SALES
    Public Const MainTable_Details As String = "INCOME_NTDISPOSALFA_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "NTIDFA_NTIDFAKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "NTIDFAD_NTIDFAKEY" 'PLFSD_PLFSKEY
    ...
    Public Sub LoadData(Optional ByRef Errorlog As clsError = Nothing)
        Try
            ...
            INCOMENTDISPOSALFABindingSource.DataSource = DsPNL1.Tables(MainTable)
