...
Partial Class ucPNL_p1AllowanceExpenses
    ...
    Private Sub InitializeComponent()
        ...
        'GridView2
        '
        Me.GridView2.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colEXAD_KEY, Me.colEXAD_EXAKEY, Me.colEXAD_SOURCENO, Me.colEXAD_EXADKEY, Me.colEXAD_DESC, Me.colEXAD_AMOUNT, Me.colEXAD_DEDUCTIBLE, Me.colEXAD_NOTE})
        ...
        GridLevelNode2.RelationName = "FK_EXPENSES_ALLOW_EXPENSES_ALLOW_DETAIL"
        ...
        'GridView1
        '
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colEXA_KEY, Me.colEXA_EXAKEY, Me.colEXA_SOURCENO, Me.colEXA_DESC, Me.colEXA_AMOUNT, Me.colEXA_DEDUCTIBLE, Me.colEXA_NOTE, Me.colEXA_DETAIL})
        ...
        Me.btnAdd.SuperTip = SuperToolTip6
        '
        'btnAddChild
        '
        ...
        Me.btnAddChild.SuperTip = SuperToolTip7
        '
        'btnDelete
        '
        ...
        ToolTipItem8.Text = "Delete record Ctrl + Y"
        SuperToolTip8.Items.Add(ToolTipTitleItem8)
        SuperToolTip8.Items.Add(ToolTipItem8)
        Me.btnDelete.SuperTip = SuperToolTip8
        '
        'btnDeleteChild
        '
        ...
        ToolTipItem9.Text = "Delete record Ctrl + U" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "How to use : Please select the main row first then contin" & _
    "ues with select child row(s)."
        SuperToolTip9.Items.Add(ToolTipTitleItem9)
        SuperToolTip9.Items.Add(ToolTipItem9)
        Me.btnDeleteChild.SuperTip = SuperToolTip9
        '
        'btnExpand
        '
        ...
        Me.btnExpand.SuperTip = SuperToolTip10
        '
        'btnMoveUp
        '
