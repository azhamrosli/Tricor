...
Public Class ucPNL_p2ReaForeExGainNonTrade
    Public txtAmount As DevExpress.XtraEditors.TextEdit
    Public RefNo As String = Nothing
    Public YA As String = Nothing
    Public isEdit As Boolean = False

    Public Const MainTable As String = "INCOME_NTREALFE" 'PLFST_SALES
    Public Const MainTable_Details As String = "INCOME_NTREALFE_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "NTIRFECT_NTIRFECTKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "NTIRFECTD_NTIRFECTKEY" 'PLFSD_PLFSKEY
    Public Const MainAmount As String = "NTIRFECT_AMOUNT" 'PLFS_AMOUNT
    Public Const MainAmount_Details As String = "NTIRFECTD_AMOUNT" 'PLFSD_AMOUNT
    Public Const MainSourceNo As String = "NTIRFECT_SOURCENO" 'PLFS_SOURCENO
    Public Const MainSourceNo_Details As String = "NTIRFECTD_SOURCENO" 'PLFS_SOURCENO
    Public Const MainDetail As String = "NTIRFECT_DETAIL"  'PLFS_DETAIL
    Public Const MainDetails_Desc As String = "NTIRFECTD_DESC"  'PLFSD_DESC
    Public Const Main_Desc As String = "NTIRFECT_DESC"  'PLFSD_DESC
    ...
    Public Sub LoadData(Optional ByRef Errorlog As clsError = Nothing)
        Try
            ...
            INCOMENTREALFEBindingSource.DataSource = DsPNL1.Tables(MainTable)
