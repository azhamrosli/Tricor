...
Partial Public Class rpt_ITA
    ...
    Private Sub InitializeComponent()
        ...
        Me.XrLabel1.Text = "Investment Tax Allowance (ITA)"
        ...
        Me.DetailReport.DataMember = "TAX_COMPUTATION.FK_TAX_COMPUTATION_TAX_ITA_ADJUSTMENT"
        ...
        '
        Me.lbl_Adjustment_Amount.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "TAX_COMPUTATION.FK_TAX_COMPUTATION_TAX_ITA_ADJUSTMENT.ITAADJ_AMOUNT", "{0:n0}")})
        ...
        'XrLabel2
        '
        Me.XrLabel2.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "TAX_COMPUTATION.FK_TAX_COMPUTATION_TAX_ITA_ADJUSTMENT.ITAADJ_ITEM", "Add: {0}")})
        ...
        'lbl_TC_CB_RA_CURR
        '
        Me.lbl_TC_CB_RA_CURR.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "TAX_COMPUTATION.TC_CB_ITA_CURR", "({0:n0})")})
        ...
        Me.XrLabel11.Text = "Less: ITA claimed during the year" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "(restricted to 70% of statutory business incom" & _
    "e)"
        ...
        Me.DetailReport2.DataMember = "TAX_COMPUTATION.FK_TAX_COMPUTATION_TAX_ITA_WITHDRAWAL"
        ...
        'XrLabel18
        '
        Me.XrLabel18.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "TAX_COMPUTATION.FK_TAX_COMPUTATION_TAX_ITA_WITHDRAWAL.ITAW_AMOUNT", "Less : {0}")})
        ...
        Me.IFWithDrawalYES.DataMember = "TAX_COMPUTATION.FK_TAX_COMPUTATION_TAX_ITA_WITHDRAWAL"
        ...
        Me.IFWithDrawalNO.DataMember = "TAX_COMPUTATION.FK_TAX_COMPUTATION_TAX_ITA_WITHDRAWAL"
        ...
        Me.XrLabel16.Text = "Add: Unutilised ITA b/f"
    ...
    "AL]"
        ...
        Me.XrLabel22.Text = "Unutilised ITA c/f to year of assessment [TC_YA]"
        ...
        'SUM_WITHDRAWAL_ITA
        '
        Me.SUM_WITHDRAWAL_ITA.DataMember = "TAX_COMPUTATION.FK_TAX_COMPUTATION_TAX_ITA_WITHDRAWAL"
        Me.SUM_WITHDRAWAL_ITA.Expression = "Sum([ITAW_AMOUNT])"
        Me.SUM_WITHDRAWAL_ITA.Name = "SUM_WITHDRAWAL_ITA"
        '
        'SUM_ADJUSTMENT_ITA
        '
        ...
        Me.CalculatedFields.AddRange(New DevExpress.XtraReports.UI.CalculatedField() {Me.SUM_ADJUSTMENT, Me.CalcRA_Less_Withdrawal, Me.CalcRA_Plus_Withdrawal, Me.SUM_WITHDRAWAL, Me.TOTAL, Me.SUM_WITHDRAWAL_ITA, Me.SUM_ADJUSTMENT_ITA})
