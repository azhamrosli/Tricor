...
Public Class frmCA_Report_SummaryQE
    ...
    Private Sub LoadData()
        Try
            ...
            Select Case TypeReport
                Case 12
                    dt = ADO.Load_CAReport_SummaryQE_Temp(ID)
            End Select

            If mdlProcess.GenerateTable_SummaryQE(dt, ds, ErrorLog) Then
                GridControl1.DataSource = ds.Tables("CA_REPORT_SUMMARY_QE_2")
            ...
            Else
                MsgBox("Failed to generate data report.", MsgBoxStyle.Critical)
            End If
            'ds = New dsCA
    ...
    Private Sub PrintExport(ByVal isExport As Boolean)
        ...
        Try
            ...
            If mdlProcess.PrintReport_SummaryQE(ds, Title, ID, False, rpt, rpt_Note, ErrorLog) Then
                ...
                End If
            Else
                MsgBox("Failed to load summary QE report.", MsgBoxStyle.Critical)
            End If
