...
Partial Class frmHP_Report
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmHP_Report))
        ...
        Me.colBF_PRINCIPAL = New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn()
        Me.colBF_INTEREST = New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn()
        Me.gridBand12 = New DevExpress.XtraGrid.Views.BandedGrid.GridBand()
        Me.colCURR_PRINCIPAL = New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn()
        Me.colCURR_INTEREST = New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn()
        Me.gridBand13 = New DevExpress.XtraGrid.Views.BandedGrid.GridBand()
        Me.colCF_PRINCIPAL = New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn()
        Me.colCF_INTEREST = New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn()
        Me.colID_Key = New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn()
        Me.colHP_KEY = New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn()
        ...
        Me.colHP_PRINCIPAL = New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn()
        Me.colHP_INTEREST_RATE = New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn()
        Me.colHP_INTEREST = New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn()
        Me.colHP_TOTAL = New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn()
        ...
        'GridControl1
        '
        Me.GridControl1.DataSource = Me.HPREPORTTEMPBindingSource
        ...
        Me.BandedGridView1.Bands.AddRange(New DevExpress.XtraGrid.Views.BandedGrid.GridBand() {Me.gridBand3, Me.gridBand11, Me.gridBand12, Me.gridBand13})
        Me.BandedGridView1.ColumnPanelRowHeight = 50
        Me.BandedGridView1.Columns.AddRange(New DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn() {Me.colID_Key, Me.colHP_KEY, Me.colID, Me.colRefNo, Me.colYA, Me.colCA_NAME, Me.colCA_SOURCENO, Me.colCA_YA, Me.colHP_CODE, Me.colCA_ASSET, Me.colCA_CATEGORY_CODE, Me.colCA_PURCHASE_YEAR, Me.colHP_PRINCIPAL, Me.colHP_INTEREST_RATE, Me.colHP_INTEREST, Me.colHP_TOTAL, Me.colBF_PRINCIPAL, Me.colBF_INTEREST, Me.colCURR_PRINCIPAL, Me.colCURR_INTEREST, Me.colCF_PRINCIPAL, Me.colCF_INTEREST, Me.colIndexNo})
        Me.BandedGridView1.GridControl = Me.GridControl1
        Me.BandedGridView1.GroupCount = 1
        Me.BandedGridView1.GroupSummary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "BF_PRINCIPAL", Me.colBF_PRINCIPAL, "{0:n2}"), New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "BF_INTEREST", Me.colBF_INTEREST, "{0:n2}"), New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "CURR_PRINCIPAL", Me.colCURR_PRINCIPAL, "{0:n2}"), New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "CURR_INTEREST", Me.colCURR_INTEREST, "{0:n2}"), New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "CF_PRINCIPAL", Me.colCURR_PRINCIPAL, "{0:n2}"), New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "CF_INTEREST", Me.colCF_INTEREST, "{0:n2}")})
        ...
        Me.BandedGridView1.SortInfo.AddRange(New DevExpress.XtraGrid.Columns.GridColumnSortInfo() {New DevExpress.XtraGrid.Columns.GridColumnSortInfo(Me.colCA_CATEGORY_CODE, DevExpress.Data.ColumnSortOrder.Ascending)})
        '
        'gridBand3
        '
        Me.gridBand3.Caption = "Particulars"
        ...
        Me.colCA_PURCHASE_YEAR.Width = 91
        '
        'gridBand11
        '
        Me.gridBand11.Caption = "BALANCE AT BEGINNING / ACQUISTION AT COST"
        Me.gridBand11.Columns.Add(Me.colBF_PRINCIPAL)
        Me.gridBand11.Columns.Add(Me.colBF_INTEREST)
        ...
        'colBF_PRINCIPAL
        '
        Me.colBF_PRINCIPAL.Caption = "Capital / Cost"
        Me.colBF_PRINCIPAL.FieldName = "BF_PRINCIPAL"
        Me.colBF_PRINCIPAL.Name = "colBF_PRINCIPAL"
        Me.colBF_PRINCIPAL.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "BF_PRINCIPAL", "{0:n2}")})
        Me.colBF_PRINCIPAL.Visible = True
        '
        'colBF_INTEREST
        '
        Me.colBF_INTEREST.Caption = "H.P. Interest"
        Me.colBF_INTEREST.FieldName = "BF_INTEREST"
        Me.colBF_INTEREST.Name = "colBF_INTEREST"
        Me.colBF_INTEREST.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "BF_INTEREST", "{0:n2}")})
        Me.colBF_INTEREST.Visible = True
        '
        'gridBand12
        '
        Me.gridBand12.Caption = "PAYMENT IN THE YEAR"
        Me.gridBand12.Columns.Add(Me.colCURR_PRINCIPAL)
        Me.gridBand12.Columns.Add(Me.colCURR_INTEREST)
        ...
        'colCURR_PRINCIPAL
        '
        Me.colCURR_PRINCIPAL.Caption = "Capital Instalments"
        Me.colCURR_PRINCIPAL.FieldName = "CURR_PRINCIPAL"
        Me.colCURR_PRINCIPAL.Name = "colCURR_PRINCIPAL"
        Me.colCURR_PRINCIPAL.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "CURR_PRINCIPAL", "{0:n2}")})
        Me.colCURR_PRINCIPAL.Visible = True
        '
        'colCURR_INTEREST
        '
        Me.colCURR_INTEREST.Caption = "H.P. Interest Paid"
        Me.colCURR_INTEREST.FieldName = "CURR_INTEREST"
        Me.colCURR_INTEREST.Name = "colCURR_INTEREST"
        Me.colCURR_INTEREST.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "CURR_INTEREST", "{0:n2}")})
        Me.colCURR_INTEREST.Visible = True
        '
        'gridBand13
        '
        Me.gridBand13.Caption = "BALANCE AT END"
        Me.gridBand13.Columns.Add(Me.colCF_PRINCIPAL)
        Me.gridBand13.Columns.Add(Me.colCF_INTEREST)
        ...
        'colCF_PRINCIPAL
        '
        Me.colCF_PRINCIPAL.Caption = "Capital"
        Me.colCF_PRINCIPAL.FieldName = "CF_PRINCIPAL"
        Me.colCF_PRINCIPAL.Name = "colCF_PRINCIPAL"
        Me.colCF_PRINCIPAL.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "CF_PRINCIPAL", "{0:n2}")})
        Me.colCF_PRINCIPAL.Visible = True
        '
        'colCF_INTEREST
        '
        Me.colCF_INTEREST.Caption = "H.P. Interest"
        Me.colCF_INTEREST.FieldName = "CF_INTEREST"
        Me.colCF_INTEREST.Name = "colCF_INTEREST"
        Me.colCF_INTEREST.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "CF_INTEREST", "{0:n2}")})
        Me.colCF_INTEREST.Visible = True
        '
        'colID_Key
        '
        ...
        Me.colHP_INTEREST_RATE.Visible = True
        '
        'colHP_INTEREST
        '
    ...
    Friend WithEvents colBF_PRINCIPAL As DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn
    Friend WithEvents colBF_INTEREST As DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn
    Friend WithEvents gridBand12 As DevExpress.XtraGrid.Views.BandedGrid.GridBand
    Friend WithEvents colCURR_PRINCIPAL As DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn
    Friend WithEvents colCURR_INTEREST As DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn
    Friend WithEvents gridBand13 As DevExpress.XtraGrid.Views.BandedGrid.GridBand
    Friend WithEvents colCF_PRINCIPAL As DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn
    Friend WithEvents colCF_INTEREST As DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn
    Friend WithEvents colID_Key As DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn
    Friend WithEvents colHP_KEY As DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn
    ...
    Friend WithEvents colHP_PRINCIPAL As DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn
    Friend WithEvents colHP_INTEREST_RATE As DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn
    Friend WithEvents colHP_INTEREST As DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn
    Friend WithEvents colHP_TOTAL As DevExpress.XtraGrid.Views.BandedGrid.BandedGridColumn
