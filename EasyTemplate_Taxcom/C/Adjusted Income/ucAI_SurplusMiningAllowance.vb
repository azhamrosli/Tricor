...
Public Class ucAI_SurplusMiningAllowance
    ...
    Private Sub ucAI_SurplusMiningAllowance_Load(sender As Object, e As EventArgs) Handles Me.Load
        Try
            If AdjustedIncome Is Nothing Then
                AdjustedIncome = New AdjustedIncome
            End If
            SURPLUSRECOVEREDBindingSource.DataSource = AdjustedIncome.dsAdjustIncome
    ...
    Private Sub GridView1_RowDeleted(sender As Object, e As DevExpress.Data.RowDeletedEventArgs) Handles GridView1.RowDeleted
        Try
            AdjustedIncome.TypeSubData = EasyTemplate_Taxcom.AdjustedIncome.EnumTypeSubData.SURPLUS_MINING_ALLOW
    ...
    Private Sub GridView1_ValidateRow(sender As Object, e As ValidateRowEventArgs) Handles GridView1.ValidateRow
        Try
            If TypeOf sender Is GridView Then
                ...
                If IsDBNull(row("SR_AMOUNT")) = True Then
    ...
    Private Sub GridView1_InitNewRow(sender As Object, e As InitNewRowEventArgs) Handles GridView1.InitNewRow
        Try
            GridView1.GetDataRow(e.RowHandle)("SR_DESC") = Me.Parent.Text
            GridView1.GetDataRow(e.RowHandle)("SR_SOURCENO") = SourceNo.EditValue
        Catch ex As Exception
            Dim st As New StackTrace(True)
            st = New StackTrace(ex, True)
    ...
    Private Sub btnDelete_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles btnDelete.ItemClick
        Try
            ...
            AdjustedIncome.dsAdjustIncome.Tables("SURPLUS_RECOVERED").AcceptChanges()
