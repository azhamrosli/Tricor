...
Public Class ucAI_RevenueExp
    ...
    Private Sub ucAI_Taxin_Load(sender As Object, e As EventArgs) Handles Me.Load
        Try
            ...
            End If
            REVENUEEXPENDITUREBindingSource.DataSource = AdjustedIncome.dsAdjustIncome
    ...
    Private Sub GridView1_RowDeleted(sender As Object, e As DevExpress.Data.RowDeletedEventArgs) Handles GridView1.RowDeleted
        Try
            AdjustedIncome.TypeSubData = EasyTemplate_Taxcom.AdjustedIncome.EnumTypeSubData.REVENUE_EXPENDITURE
    ...
    Private Sub GridView1_ValidateRow(sender As Object, e As ValidateRowEventArgs) Handles GridView1.ValidateRow
        Try
            If TypeOf sender Is GridView Then
                ...
                If IsDBNull(row("RE_AMOUNT")) = True Then
    ...
    Private Sub GridView1_InitNewRow(sender As Object, e As InitNewRowEventArgs) Handles GridView1.InitNewRow
        Try
            GridView1.GetDataRow(e.RowHandle)("RE_DESC") = Me.Parent.Text
            GridView1.GetDataRow(e.RowHandle)("RE_SOURCENO") = SourceNo.EditValue
        Catch ex As Exception
            Dim st As New StackTrace(True)
            st = New StackTrace(ex, True)
    ...
    Private Sub btnDelete_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles btnDelete.ItemClick
        Try
            ...
            AdjustedIncome.dsAdjustIncome.Tables("REVENUE_EXPENDITURE").AcceptChanges()
