...
Partial Class ucPNL_p2ProDisInvestment
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ucPNL_p2ProDisInvestment))
        ...
        Me.colNTIDID_KEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNTIDID_NTIDIKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNTIDID_NTIDIDKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNTIDID_DESC = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNTIDID_AMOUNT = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.txtNumberic = New DevExpress.XtraEditors.Repository.RepositoryItemTextEdit()
        Me.colNTIDID_NOTE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.txtNote = New DevExpress.XtraEditors.Repository.RepositoryItemMemoEdit()
        Me.colNTIDID_SOURCENO = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.GridControl1 = New DevExpress.XtraGrid.GridControl()
        Me.INCOMENTDISPOSALINVESTBindingSource = New System.Windows.Forms.BindingSource(Me.components)
        Me.DsPNL1 = New EasyTemplate_Taxcom.dsPNL()
        Me.GridView1 = New DevExpress.XtraGrid.Views.Grid.GridView()
        Me.colNTIDI_KEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNTIDI_NTIDIKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNTIDI_SOURCENO = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.colNTIDI_DESC = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNTIDI_AMOUNT = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNTIDI_NOTE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNTIDI_DETAIL = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        CType(Me.INCOMENTDISPOSALINVESTBindingSource, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        'GridView2
        '
        Me.GridView2.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colNTIDID_KEY, Me.colNTIDID_NTIDIKEY, Me.colNTIDID_NTIDIDKEY, Me.colNTIDID_DESC, Me.colNTIDID_AMOUNT, Me.colNTIDID_NOTE, Me.colNTIDID_SOURCENO})
        ...
        'colNTIDID_KEY
        '
        Me.colNTIDID_KEY.FieldName = "NTIDID_KEY"
        Me.colNTIDID_KEY.Name = "colNTIDID_KEY"
        '
        'colNTIDID_NTIDIKEY
        '
        Me.colNTIDID_NTIDIKEY.FieldName = "NTIDID_NTIDIKEY"
        Me.colNTIDID_NTIDIKEY.Name = "colNTIDID_NTIDIKEY"
        '
        'colNTIDID_NTIDIDKEY
        '
        Me.colNTIDID_NTIDIDKEY.FieldName = "NTIDID_NTIDIDKEY"
        Me.colNTIDID_NTIDIDKEY.Name = "colNTIDID_NTIDIDKEY"
        '
        'colNTIDID_DESC
        '
        Me.colNTIDID_DESC.Caption = "Description"
        Me.colNTIDID_DESC.FieldName = "NTIDID_DESC"
        Me.colNTIDID_DESC.Name = "colNTIDID_DESC"
        Me.colNTIDID_DESC.Visible = True
        Me.colNTIDID_DESC.VisibleIndex = 0
        Me.colNTIDID_DESC.Width = 300
        '
        'colNTIDID_AMOUNT
        '
        Me.colNTIDID_AMOUNT.Caption = "Amount"
        Me.colNTIDID_AMOUNT.ColumnEdit = Me.txtNumberic
        Me.colNTIDID_AMOUNT.FieldName = "NTIDID_AMOUNT"
        Me.colNTIDID_AMOUNT.Name = "colNTIDID_AMOUNT"
        Me.colNTIDID_AMOUNT.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "NTIDID_AMOUNT", "SUM={0:0.##}")})
        Me.colNTIDID_AMOUNT.Visible = True
        Me.colNTIDID_AMOUNT.VisibleIndex = 1
        Me.colNTIDID_AMOUNT.Width = 120
        '
        'txtNumberic
        '
        ...
        'colNTIDID_NOTE
        '
        Me.colNTIDID_NOTE.Caption = "Remarks"
        Me.colNTIDID_NOTE.ColumnEdit = Me.txtNote
        Me.colNTIDID_NOTE.FieldName = "NTIDID_NOTE"
        Me.colNTIDID_NOTE.Name = "colNTIDID_NOTE"
        Me.colNTIDID_NOTE.Visible = True
        Me.colNTIDID_NOTE.VisibleIndex = 2
        Me.colNTIDID_NOTE.Width = 300
        '
        'txtNote
        '
        ...
        'colNTIDID_SOURCENO
        '
        Me.colNTIDID_SOURCENO.FieldName = "NTIDID_SOURCENO"
        Me.colNTIDID_SOURCENO.Name = "colNTIDID_SOURCENO"
        Me.colNTIDID_SOURCENO.Width = 20
        '
        'GridControl1
        '
        Me.GridControl1.DataSource = Me.INCOMENTDISPOSALINVESTBindingSource
        Me.GridControl1.Dock = System.Windows.Forms.DockStyle.Fill
        Me.GridControl1.EmbeddedNavigator.Margin = New System.Windows.Forms.Padding(3, 4, 3, 4)
        GridLevelNode1.LevelTemplate = Me.GridView2
        GridLevelNode1.RelationName = "FK_INCOME_NTDISPOSALINVEST_INCOME_NTDISPOSALINVEST_DETAIL"
        ...
        Me.GridControl1.Size = New System.Drawing.Size(1012, 474)
        Me.GridControl1.TabIndex = 0
        Me.GridControl1.UseEmbeddedNavigator = True
        Me.GridControl1.ViewCollection.AddRange(New DevExpress.XtraGrid.Views.Base.BaseView() {Me.GridView1, Me.GridView2})
        '
        'INCOMENTDISPOSALINVESTBindingSource
        '
        Me.INCOMENTDISPOSALINVESTBindingSource.DataMember = "INCOME_NTDISPOSALINVEST"
        Me.INCOMENTDISPOSALINVESTBindingSource.DataSource = Me.DsPNL1
        '
        'DsPNL1
        '
        ...
        'GridView1
        '
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colNTIDI_KEY, Me.colNTIDI_NTIDIKEY, Me.colNTIDI_SOURCENO, Me.colNTIDI_DESC, Me.colNTIDI_AMOUNT, Me.colNTIDI_NOTE, Me.colNTIDI_DETAIL})
        ...
        'colNTIDI_KEY
        '
        Me.colNTIDI_KEY.FieldName = "NTIDI_KEY"
        Me.colNTIDI_KEY.Name = "colNTIDI_KEY"
        '
        'colNTIDI_NTIDIKEY
        '
        Me.colNTIDI_NTIDIKEY.FieldName = "NTIDI_NTIDIKEY"
        Me.colNTIDI_NTIDIKEY.Name = "colNTIDI_NTIDIKEY"
        '
        'colNTIDI_SOURCENO
        '
        Me.colNTIDI_SOURCENO.Caption = "Source No"
        Me.colNTIDI_SOURCENO.ColumnEdit = Me.cboSourceNo
        Me.colNTIDI_SOURCENO.FieldName = "NTIDI_SOURCENO"
        Me.colNTIDI_SOURCENO.Name = "colNTIDI_SOURCENO"
        Me.colNTIDI_SOURCENO.Visible = True
        Me.colNTIDI_SOURCENO.VisibleIndex = 0
        Me.colNTIDI_SOURCENO.Width = 150
        '
        'cboSourceNo
        '
        ...
        'colNTIDI_DESC
        '
        Me.colNTIDI_DESC.Caption = "Description"
        Me.colNTIDI_DESC.FieldName = "NTIDI_DESC"
        Me.colNTIDI_DESC.Name = "colNTIDI_DESC"
        Me.colNTIDI_DESC.Visible = True
        Me.colNTIDI_DESC.VisibleIndex = 1
        Me.colNTIDI_DESC.Width = 300
        '
        'colNTIDI_AMOUNT
        '
        Me.colNTIDI_AMOUNT.Caption = "Amount"
        Me.colNTIDI_AMOUNT.ColumnEdit = Me.txtNumberic
        Me.colNTIDI_AMOUNT.FieldName = "NTIDI_AMOUNT"
        Me.colNTIDI_AMOUNT.Name = "colNTIDI_AMOUNT"
        Me.colNTIDI_AMOUNT.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "NTIDI_AMOUNT", "SUM={0:0.##}")})
        Me.colNTIDI_AMOUNT.Visible = True
        Me.colNTIDI_AMOUNT.VisibleIndex = 2
        Me.colNTIDI_AMOUNT.Width = 150
        '
        'colNTIDI_NOTE
        '
        Me.colNTIDI_NOTE.Caption = "Remarks"
        Me.colNTIDI_NOTE.ColumnEdit = Me.txtNote
        Me.colNTIDI_NOTE.FieldName = "NTIDI_NOTE"
        Me.colNTIDI_NOTE.Name = "colNTIDI_NOTE"
        Me.colNTIDI_NOTE.Visible = True
        Me.colNTIDI_NOTE.VisibleIndex = 3
        Me.colNTIDI_NOTE.Width = 300
        '
        'colNTIDI_DETAIL
        '
        Me.colNTIDI_DETAIL.Caption = "Details"
        Me.colNTIDI_DETAIL.FieldName = "NTIDI_DETAIL"
        Me.colNTIDI_DETAIL.Name = "colNTIDI_DETAIL"
        Me.colNTIDI_DETAIL.OptionsColumn.ReadOnly = True
        Me.colNTIDI_DETAIL.OptionsColumn.TabStop = False
        Me.colNTIDI_DETAIL.Visible = True
        Me.colNTIDI_DETAIL.VisibleIndex = 4
        Me.colNTIDI_DETAIL.Width = 150
        '
        'BarManager1
        '
    ...
    " continues with select delete row(s)."
        ...
        Me.barDockControlTop.Size = New System.Drawing.Size(1012, 39)
        '
        ...
        Me.barDockControlRight.Location = New System.Drawing.Point(1012, 39)
        ...
        Me.Name = "ucPNL_p2ProDisInvestment"
        Me.Size = New System.Drawing.Size(1012, 513)
        CType(Me.GridView2, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.txtNumberic, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.txtNote, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.GridControl1, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.INCOMENTDISPOSALINVESTBindingSource, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents INCOMENTDISPOSALINVESTBindingSource As System.Windows.Forms.BindingSource
    Friend WithEvents colNTIDID_KEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNTIDID_NTIDIKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNTIDID_NTIDIDKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNTIDID_DESC As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNTIDID_AMOUNT As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNTIDID_NOTE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNTIDID_SOURCENO As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNTIDI_KEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNTIDI_NTIDIKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNTIDI_SOURCENO As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNTIDI_DESC As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNTIDI_AMOUNT As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNTIDI_NOTE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNTIDI_DETAIL As DevExpress.XtraGrid.Columns.GridColumn
