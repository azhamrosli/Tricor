...
Partial Class ucPNL_p2OtherBizIncome
    ...
    Private Sub InitializeComponent()
        ...
        Me.colNSBID_KEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNSBID_NSBIKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNSBID_NSBIDKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNSBID_DESC = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNSBID_AMOUNT = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.txtNumberic = New DevExpress.XtraEditors.Repository.RepositoryItemTextEdit()
        Me.colNSBID_NOTE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.txtNote = New DevExpress.XtraEditors.Repository.RepositoryItemMemoEdit()
        Me.colNSBID_SOURCENO = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.GridControl1 = New DevExpress.XtraGrid.GridControl()
        Me.NONSOURCEBUSINESSINCOMEBindingSource = New System.Windows.Forms.BindingSource(Me.components)
        Me.DsPNL1 = New EasyTemplate_Taxcom.dsPNL()
        Me.GridView1 = New DevExpress.XtraGrid.Views.Grid.GridView()
        Me.colNSBI_KEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNSBI_NSBIKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNSBI_SOURCENO = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.colNSBI_DESC = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNSBI_AMOUNT = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNSBI_NOTE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNSBI_DETAIL = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        CType(Me.NONSOURCEBUSINESSINCOMEBindingSource, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        'GridView2
        '
        Me.GridView2.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colNSBID_KEY, Me.colNSBID_NSBIKEY, Me.colNSBID_NSBIDKEY, Me.colNSBID_DESC, Me.colNSBID_AMOUNT, Me.colNSBID_NOTE, Me.colNSBID_SOURCENO})
        ...
        'colNSBID_KEY
        '
        Me.colNSBID_KEY.FieldName = "NSBID_KEY"
        Me.colNSBID_KEY.Name = "colNSBID_KEY"
        '
        'colNSBID_NSBIKEY
        '
        Me.colNSBID_NSBIKEY.FieldName = "NSBID_NSBIKEY"
        Me.colNSBID_NSBIKEY.Name = "colNSBID_NSBIKEY"
        '
        'colNSBID_NSBIDKEY
        '
        Me.colNSBID_NSBIDKEY.FieldName = "NSBID_NSBIDKEY"
        Me.colNSBID_NSBIDKEY.Name = "colNSBID_NSBIDKEY"
        '
        'colNSBID_DESC
        '
        Me.colNSBID_DESC.Caption = "Description"
        Me.colNSBID_DESC.FieldName = "NSBID_DESC"
        Me.colNSBID_DESC.Name = "colNSBID_DESC"
        Me.colNSBID_DESC.Visible = True
        Me.colNSBID_DESC.VisibleIndex = 0
        Me.colNSBID_DESC.Width = 300
        '
        'colNSBID_AMOUNT
        '
        Me.colNSBID_AMOUNT.Caption = "Amount"
        Me.colNSBID_AMOUNT.ColumnEdit = Me.txtNumberic
        Me.colNSBID_AMOUNT.FieldName = "NSBID_AMOUNT"
        Me.colNSBID_AMOUNT.Name = "colNSBID_AMOUNT"
        Me.colNSBID_AMOUNT.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "NSBID_AMOUNT", "SUM={0:0.##}")})
        Me.colNSBID_AMOUNT.Visible = True
        Me.colNSBID_AMOUNT.VisibleIndex = 1
        Me.colNSBID_AMOUNT.Width = 120
        '
        'txtNumberic
        '
        ...
        'colNSBID_NOTE
        '
        Me.colNSBID_NOTE.Caption = "Remarks"
        Me.colNSBID_NOTE.ColumnEdit = Me.txtNote
        Me.colNSBID_NOTE.FieldName = "NSBID_NOTE"
        Me.colNSBID_NOTE.Name = "colNSBID_NOTE"
        Me.colNSBID_NOTE.OptionsColumn.ReadOnly = True
        Me.colNSBID_NOTE.OptionsColumn.TabStop = False
        Me.colNSBID_NOTE.Visible = True
        Me.colNSBID_NOTE.VisibleIndex = 2
        Me.colNSBID_NOTE.Width = 300
        '
        'txtNote
        '
        ...
        'colNSBID_SOURCENO
        '
        Me.colNSBID_SOURCENO.FieldName = "NSBID_SOURCENO"
        Me.colNSBID_SOURCENO.Name = "colNSBID_SOURCENO"
        Me.colNSBID_SOURCENO.Width = 80
        '
        'GridControl1
        '
        Me.GridControl1.DataSource = Me.NONSOURCEBUSINESSINCOMEBindingSource
        Me.GridControl1.Dock = System.Windows.Forms.DockStyle.Fill
        Me.GridControl1.EmbeddedNavigator.Margin = New System.Windows.Forms.Padding(3, 4, 3, 4)
        GridLevelNode1.LevelTemplate = Me.GridView2
        GridLevelNode1.RelationName = "FK_NONSOURCE_BUSINESSINCOME_NONSOURCE_BUSINESSINCOME_DETAIL"
        ...
        Me.GridControl1.Size = New System.Drawing.Size(1114, 474)
        Me.GridControl1.TabIndex = 0
        Me.GridControl1.UseEmbeddedNavigator = True
        Me.GridControl1.ViewCollection.AddRange(New DevExpress.XtraGrid.Views.Base.BaseView() {Me.GridView1, Me.GridView2})
        '
        'NONSOURCEBUSINESSINCOMEBindingSource
        '
        Me.NONSOURCEBUSINESSINCOMEBindingSource.DataMember = "NONSOURCE_BUSINESSINCOME"
        Me.NONSOURCEBUSINESSINCOMEBindingSource.DataSource = Me.DsPNL1
        '
        'DsPNL1
        '
        ...
        'GridView1
        '
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colNSBI_KEY, Me.colNSBI_NSBIKEY, Me.colNSBI_SOURCENO, Me.colNSBI_DESC, Me.colNSBI_AMOUNT, Me.colNSBI_NOTE, Me.colNSBI_DETAIL})
        ...
        'colNSBI_KEY
        '
        Me.colNSBI_KEY.FieldName = "NSBI_KEY"
        Me.colNSBI_KEY.Name = "colNSBI_KEY"
        '
        'colNSBI_NSBIKEY
        '
        Me.colNSBI_NSBIKEY.FieldName = "NSBI_NSBIKEY"
        Me.colNSBI_NSBIKEY.Name = "colNSBI_NSBIKEY"
        '
        'colNSBI_SOURCENO
        '
        Me.colNSBI_SOURCENO.Caption = "Source No"
        Me.colNSBI_SOURCENO.ColumnEdit = Me.cboSourceNo
        Me.colNSBI_SOURCENO.FieldName = "NSBI_SOURCENO"
        Me.colNSBI_SOURCENO.Name = "colNSBI_SOURCENO"
        Me.colNSBI_SOURCENO.Visible = True
        Me.colNSBI_SOURCENO.VisibleIndex = 0
        Me.colNSBI_SOURCENO.Width = 80
        '
        'cboSourceNo
        '
        ...
        'colNSBI_DESC
        '
        Me.colNSBI_DESC.Caption = "Description"
        Me.colNSBI_DESC.FieldName = "NSBI_DESC"
        Me.colNSBI_DESC.Name = "colNSBI_DESC"
        Me.colNSBI_DESC.Visible = True
        Me.colNSBI_DESC.VisibleIndex = 1
        Me.colNSBI_DESC.Width = 300
        '
        'colNSBI_AMOUNT
        '
        Me.colNSBI_AMOUNT.Caption = "Amount"
        Me.colNSBI_AMOUNT.ColumnEdit = Me.txtNumberic
        Me.colNSBI_AMOUNT.FieldName = "NSBI_AMOUNT"
        Me.colNSBI_AMOUNT.Name = "colNSBI_AMOUNT"
        Me.colNSBI_AMOUNT.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "NSBI_AMOUNT", "SUM={0:0.##}")})
        Me.colNSBI_AMOUNT.Visible = True
        Me.colNSBI_AMOUNT.VisibleIndex = 2
        Me.colNSBI_AMOUNT.Width = 150
        '
        'colNSBI_NOTE
        '
        Me.colNSBI_NOTE.Caption = "Remarks"
        Me.colNSBI_NOTE.ColumnEdit = Me.txtNote
        Me.colNSBI_NOTE.FieldName = "NSBI_NOTE"
        Me.colNSBI_NOTE.Name = "colNSBI_NOTE"
        Me.colNSBI_NOTE.Visible = True
        Me.colNSBI_NOTE.VisibleIndex = 3
        Me.colNSBI_NOTE.Width = 300
        '
        'colNSBI_DETAIL
        '
        Me.colNSBI_DETAIL.Caption = "Details"
        Me.colNSBI_DETAIL.FieldName = "NSBI_DETAIL"
        Me.colNSBI_DETAIL.Name = "colNSBI_DETAIL"
        Me.colNSBI_DETAIL.OptionsColumn.ReadOnly = True
        Me.colNSBI_DETAIL.OptionsColumn.TabStop = False
        Me.colNSBI_DETAIL.Visible = True
        Me.colNSBI_DETAIL.VisibleIndex = 4
        Me.colNSBI_DETAIL.Width = 150
        '
        'BarManager1
        '
    ...
    " continues with select delete row(s)."
        ...
        Me.barDockControlTop.Size = New System.Drawing.Size(1114, 39)
        '
        ...
        Me.barDockControlRight.Location = New System.Drawing.Point(1114, 39)
        ...
        Me.Size = New System.Drawing.Size(1114, 513)
        CType(Me.GridView2, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.txtNumberic, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.txtNote, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.GridControl1, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.NONSOURCEBUSINESSINCOMEBindingSource, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents colNSBID_KEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNSBID_NSBIKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNSBID_NSBIDKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNSBID_DESC As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNSBID_AMOUNT As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNSBID_NOTE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNSBID_SOURCENO As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents NONSOURCEBUSINESSINCOMEBindingSource As System.Windows.Forms.BindingSource
    Friend WithEvents colNSBI_KEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNSBI_NSBIKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNSBI_SOURCENO As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNSBI_DESC As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNSBI_AMOUNT As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNSBI_NOTE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNSBI_DETAIL As DevExpress.XtraGrid.Columns.GridColumn
