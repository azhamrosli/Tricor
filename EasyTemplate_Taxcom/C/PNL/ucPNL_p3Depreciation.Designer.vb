...
Partial Class ucPNL_p3Depreciation
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ucPNL_p3Depreciation))
        ...
        Me.colEXODEPD_KEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXODEPD_EXODEPKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXODEPD_SOURCENO = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXODEPD_EXODEPDKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXODEPD_DESC = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXODEPD_AMOUNT = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.colEXODEPD_NOTE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.txtNote = New DevExpress.XtraEditors.Repository.RepositoryItemMemoEdit()
        Me.colEXODEPD_DEDUCTIBLE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.chkBox = New DevExpress.XtraEditors.Repository.RepositoryItemCheckEdit()
        Me.colEXODEPD_DEDUCTIBLE_ADD = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.OTHEREXDEPRECIATIONBindingSource = New System.Windows.Forms.BindingSource(Me.components)
        Me.DsPNL1 = New EasyTemplate_Taxcom.dsPNL()
        Me.GridView1 = New DevExpress.XtraGrid.Views.Grid.GridView()
        Me.colEXODEP_KEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXODEP_EXODEPKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXODEP_SOURCENO = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.colEXODEP_DESC = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXODEP_AMOUNT = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPecentage = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXODEP_NOTE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXODEP_DEDUCTIBLE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXODEP_DEDUCTIBLE_ADD = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXODEP_DETAIL = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        CType(Me.OTHEREXDEPRECIATIONBindingSource, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        'GridView2
        '
        Me.GridView2.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colEXODEPD_KEY, Me.colEXODEPD_EXODEPKEY, Me.colEXODEPD_SOURCENO, Me.colEXODEPD_EXODEPDKEY, Me.colEXODEPD_DESC, Me.colEXODEPD_AMOUNT, Me.colPecentage1, Me.colEXODEPD_NOTE, Me.colEXODEPD_DEDUCTIBLE, Me.colEXODEPD_DEDUCTIBLE_ADD, Me.colRowIndex1, Me.colPecentageAmount1})
        ...
        'colEXODEPD_KEY
        '
        Me.colEXODEPD_KEY.FieldName = "EXODEPD_KEY"
        Me.colEXODEPD_KEY.Name = "colEXODEPD_KEY"
        '
        'colEXODEPD_EXODEPKEY
        '
        Me.colEXODEPD_EXODEPKEY.FieldName = "EXODEPD_EXODEPKEY"
        Me.colEXODEPD_EXODEPKEY.Name = "colEXODEPD_EXODEPKEY"
        '
        'colEXODEPD_SOURCENO
        '
        Me.colEXODEPD_SOURCENO.FieldName = "EXODEPD_SOURCENO"
        Me.colEXODEPD_SOURCENO.Name = "colEXODEPD_SOURCENO"
        '
        'colEXODEPD_EXODEPDKEY
        '
        Me.colEXODEPD_EXODEPDKEY.FieldName = "EXODEPD_EXODEPDKEY"
        Me.colEXODEPD_EXODEPDKEY.Name = "colEXODEPD_EXODEPDKEY"
        '
        'colEXODEPD_DESC
        '
        Me.colEXODEPD_DESC.Caption = "Description"
        Me.colEXODEPD_DESC.FieldName = "EXODEPD_DESC"
        Me.colEXODEPD_DESC.Name = "colEXODEPD_DESC"
        Me.colEXODEPD_DESC.Visible = True
        Me.colEXODEPD_DESC.VisibleIndex = 0
        Me.colEXODEPD_DESC.Width = 300
        '
        'colEXODEPD_AMOUNT
        '
        Me.colEXODEPD_AMOUNT.Caption = "Amount"
        Me.colEXODEPD_AMOUNT.ColumnEdit = Me.txtNumberic
        Me.colEXODEPD_AMOUNT.FieldName = "EXODEPD_AMOUNT"
        Me.colEXODEPD_AMOUNT.Name = "colEXODEPD_AMOUNT"
        Me.colEXODEPD_AMOUNT.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "EXODEPD_AMOUNT", "SUM={0:0.##}")})
        Me.colEXODEPD_AMOUNT.Visible = True
        Me.colEXODEPD_AMOUNT.VisibleIndex = 1
        Me.colEXODEPD_AMOUNT.Width = 120
        '
        'txtNumberic
        '
        ...
        'colEXODEPD_NOTE
        '
        Me.colEXODEPD_NOTE.Caption = "Remarks"
        Me.colEXODEPD_NOTE.ColumnEdit = Me.txtNote
        Me.colEXODEPD_NOTE.FieldName = "EXODEPD_NOTE"
        Me.colEXODEPD_NOTE.Name = "colEXODEPD_NOTE"
        Me.colEXODEPD_NOTE.Visible = True
        Me.colEXODEPD_NOTE.VisibleIndex = 3
        Me.colEXODEPD_NOTE.Width = 300
        '
        'txtNote
        '
        ...
        '
        'colEXODEPD_DEDUCTIBLE
        '
        Me.colEXODEPD_DEDUCTIBLE.Caption = "Add Back"
        Me.colEXODEPD_DEDUCTIBLE.ColumnEdit = Me.chkBox
        Me.colEXODEPD_DEDUCTIBLE.FieldName = "EXODEPD_DEDUCTIBLE"
        Me.colEXODEPD_DEDUCTIBLE.Name = "colEXODEPD_DEDUCTIBLE"
        Me.colEXODEPD_DEDUCTIBLE.Visible = True
        Me.colEXODEPD_DEDUCTIBLE.VisibleIndex = 4
        Me.colEXODEPD_DEDUCTIBLE.Width = 100
        '
        'chkBox
        '
        ...
        '
        'colEXODEPD_DEDUCTIBLE_ADD
        '
        Me.colEXODEPD_DEDUCTIBLE_ADD.Caption = "Deduct"
        Me.colEXODEPD_DEDUCTIBLE_ADD.ColumnEdit = Me.chkBox
        Me.colEXODEPD_DEDUCTIBLE_ADD.FieldName = "EXODEPD_DEDUCTIBLE_ADD"
        Me.colEXODEPD_DEDUCTIBLE_ADD.Name = "colEXODEPD_DEDUCTIBLE_ADD"
        Me.colEXODEPD_DEDUCTIBLE_ADD.Visible = True
        Me.colEXODEPD_DEDUCTIBLE_ADD.VisibleIndex = 5
        Me.colEXODEPD_DEDUCTIBLE_ADD.Width = 100
        '
        'colRowIndex1
        '
        ...
        'GridControl1
        '
        Me.GridControl1.DataSource = Me.OTHEREXDEPRECIATIONBindingSource
        Me.GridControl1.Dock = System.Windows.Forms.DockStyle.Fill
        Me.GridControl1.EmbeddedNavigator.Margin = New System.Windows.Forms.Padding(3, 4, 3, 4)
        GridLevelNode1.LevelTemplate = Me.GridView2
        GridLevelNode1.RelationName = "FK_OTHER_EXDEPRECIATION_OTHER_EXDEPRECIATION_DETAIL"
        ...
        Me.GridControl1.Size = New System.Drawing.Size(1119, 474)
        Me.GridControl1.TabIndex = 0
        Me.GridControl1.UseEmbeddedNavigator = True
        Me.GridControl1.ViewCollection.AddRange(New DevExpress.XtraGrid.Views.Base.BaseView() {Me.GridView1, Me.GridView2})
        '
        'OTHEREXDEPRECIATIONBindingSource
        '
        Me.OTHEREXDEPRECIATIONBindingSource.DataMember = "OTHER_EXDEPRECIATION"
        Me.OTHEREXDEPRECIATIONBindingSource.DataSource = Me.DsPNL1
        '
        'DsPNL1
        '
        ...
        'GridView1
        '
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colEXODEP_KEY, Me.colEXODEP_EXODEPKEY, Me.colEXODEP_SOURCENO, Me.colEXODEP_DESC, Me.colEXODEP_AMOUNT, Me.colPecentage, Me.colEXODEP_NOTE, Me.colEXODEP_DEDUCTIBLE, Me.colEXODEP_DEDUCTIBLE_ADD, Me.colEXODEP_DETAIL, Me.colRowIndex, Me.colPecentageAmount})
        ...
        'colEXODEP_KEY
        '
        Me.colEXODEP_KEY.FieldName = "EXODEP_KEY"
        Me.colEXODEP_KEY.Name = "colEXODEP_KEY"
        '
        'colEXODEP_EXODEPKEY
        '
        Me.colEXODEP_EXODEPKEY.FieldName = "EXODEP_EXODEPKEY"
        Me.colEXODEP_EXODEPKEY.Name = "colEXODEP_EXODEPKEY"
        '
        'colEXODEP_SOURCENO
        '
        Me.colEXODEP_SOURCENO.Caption = "Source No"
        Me.colEXODEP_SOURCENO.ColumnEdit = Me.cboSourceNo
        Me.colEXODEP_SOURCENO.FieldName = "EXODEP_SOURCENO"
        Me.colEXODEP_SOURCENO.Name = "colEXODEP_SOURCENO"
        Me.colEXODEP_SOURCENO.Visible = True
        Me.colEXODEP_SOURCENO.VisibleIndex = 0
        Me.colEXODEP_SOURCENO.Width = 80
        '
        'cboSourceNo
        '
        ...
        'colEXODEP_DESC
        '
        Me.colEXODEP_DESC.Caption = "Description"
        Me.colEXODEP_DESC.FieldName = "EXODEP_DESC"
        Me.colEXODEP_DESC.Name = "colEXODEP_DESC"
        Me.colEXODEP_DESC.Visible = True
        Me.colEXODEP_DESC.VisibleIndex = 1
        Me.colEXODEP_DESC.Width = 300
        '
        'colEXODEP_AMOUNT
        '
        Me.colEXODEP_AMOUNT.Caption = "Amount"
        Me.colEXODEP_AMOUNT.ColumnEdit = Me.txtNumberic
        Me.colEXODEP_AMOUNT.FieldName = "EXODEP_AMOUNT"
        Me.colEXODEP_AMOUNT.Name = "colEXODEP_AMOUNT"
        Me.colEXODEP_AMOUNT.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "EXODEP_AMOUNT", "SUM={0:0.##}")})
        Me.colEXODEP_AMOUNT.Visible = True
        Me.colEXODEP_AMOUNT.VisibleIndex = 2
        Me.colEXODEP_AMOUNT.Width = 120
        '
        'colPecentage
        '
        ...
        'colEXODEP_NOTE
        '
        Me.colEXODEP_NOTE.Caption = "Remarks"
        Me.colEXODEP_NOTE.ColumnEdit = Me.txtNote
        Me.colEXODEP_NOTE.FieldName = "EXODEP_NOTE"
        Me.colEXODEP_NOTE.Name = "colEXODEP_NOTE"
        Me.colEXODEP_NOTE.Visible = True
        Me.colEXODEP_NOTE.VisibleIndex = 4
        Me.colEXODEP_NOTE.Width = 300
        '
        'colEXODEP_DEDUCTIBLE
        '
        Me.colEXODEP_DEDUCTIBLE.Caption = "Add Back"
        Me.colEXODEP_DEDUCTIBLE.ColumnEdit = Me.chkBox
        Me.colEXODEP_DEDUCTIBLE.FieldName = "EXODEP_DEDUCTIBLE"
        Me.colEXODEP_DEDUCTIBLE.Name = "colEXODEP_DEDUCTIBLE"
        Me.colEXODEP_DEDUCTIBLE.Visible = True
        Me.colEXODEP_DEDUCTIBLE.VisibleIndex = 5
        Me.colEXODEP_DEDUCTIBLE.Width = 100
        '
        'colEXODEP_DEDUCTIBLE_ADD
        '
        Me.colEXODEP_DEDUCTIBLE_ADD.Caption = "Deduct"
        Me.colEXODEP_DEDUCTIBLE_ADD.ColumnEdit = Me.chkBox
        Me.colEXODEP_DEDUCTIBLE_ADD.FieldName = "EXODEP_DEDUCTIBLE_ADD"
        Me.colEXODEP_DEDUCTIBLE_ADD.Name = "colEXODEP_DEDUCTIBLE_ADD"
        Me.colEXODEP_DEDUCTIBLE_ADD.Visible = True
        Me.colEXODEP_DEDUCTIBLE_ADD.VisibleIndex = 6
        Me.colEXODEP_DEDUCTIBLE_ADD.Width = 100
        '
        'colEXODEP_DETAIL
        '
        Me.colEXODEP_DETAIL.Caption = "Details"
        Me.colEXODEP_DETAIL.FieldName = "EXODEP_DETAIL"
        Me.colEXODEP_DETAIL.Name = "colEXODEP_DETAIL"
        Me.colEXODEP_DETAIL.OptionsColumn.ReadOnly = True
        Me.colEXODEP_DETAIL.OptionsColumn.TabStop = False
        Me.colEXODEP_DETAIL.Visible = True
        Me.colEXODEP_DETAIL.VisibleIndex = 7
        Me.colEXODEP_DETAIL.Width = 100
        '
        'colRowIndex
        '
    ...
    "ues with select child row(s)."
        ...
        Me.barDockControlTop.Size = New System.Drawing.Size(1119, 39)
        '
        ...
        Me.barDockControlRight.Location = New System.Drawing.Point(1119, 39)
        ...
        Me.Name = "ucPNL_p3Depreciation"
        Me.Size = New System.Drawing.Size(1119, 513)
        ...
        CType(Me.OTHEREXDEPRECIATIONBindingSource, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents colEXODEPD_KEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXODEPD_EXODEPKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXODEPD_SOURCENO As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXODEPD_EXODEPDKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXODEPD_DESC As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXODEPD_AMOUNT As DevExpress.XtraGrid.Columns.GridColumn
    ...
    Friend WithEvents colEXODEPD_NOTE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents txtNote As DevExpress.XtraEditors.Repository.RepositoryItemMemoEdit
    Friend WithEvents colEXODEPD_DEDUCTIBLE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents chkBox As DevExpress.XtraEditors.Repository.RepositoryItemCheckEdit
    Friend WithEvents colEXODEPD_DEDUCTIBLE_ADD As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colRowIndex1 As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents GridView1 As DevExpress.XtraGrid.Views.Grid.GridView
    Friend WithEvents colEXODEP_KEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXODEP_EXODEPKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXODEP_SOURCENO As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents cboSourceNo As DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit
    Friend WithEvents colEXODEP_DESC As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXODEP_AMOUNT As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPecentage As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXODEP_NOTE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXODEP_DEDUCTIBLE As DevExpress.XtraGrid.Columns.GridColumn
