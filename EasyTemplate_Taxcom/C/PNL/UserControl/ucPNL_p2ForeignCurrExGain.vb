...
Public Class ucPNL_p2ForeignCurrExGain
    ...
    Public Const MainTable As String = "INCOME_REALFET" 'PLFST_SALES
    Public Const MainTable_Details As String = "INCOME_REALFET_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "IRFET_IRFETKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "IRFETD_IRFETKEY" 'PLFSD_PLFSKEY
    Public Const MainAmount As String = "IRFET_AMOUNT" 'PLFS_AMOUNT
    Public Const MainAmount_Details As String = "IRFETD_AMOUNT" 'PLFSD_AMOUNT
    Public Const MainSourceNo As String = "IRFET_SOURCENO" 'PLFS_SOURCENO
    Public Const MainSourceNo_Details As String = "IRFETD_SOURCENO" 'PLFS_SOURCENO
    Public Const MainDetail As String = "IRFET_DETAIL"  'PLFS_DETAIL
    Public Const MainDetails_Desc As String = "IRFETD_DESC"  'PLFSD_DESC
    Public Const Main_Desc As String = "IRFET_DESC"  'PLFSD_DESC
