...
Public Class ucPNL_p3Salary
    ...
    Public Const MainTable As String = "EXPENSES_SALARY" 'PLFST_SALES
    Public Const MainTable_Details As String = "EXPENSES_SALARY_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "EXS_EXSKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "EXSD_EXSKEY" 'PLFSD_PLFSKEY
    ...
    Public Const Main_Addback As String = "EXS_DEDUCTIBLE"  'PLFSD_DESC
    Public Const MainDetails_Addback As String = "EXSD_DEDUCTIBLE"  'PLFSD_DESC
    Public Const Main_Deduct As String = "EXS_DEDUCTIBLE_ADD"  'PLFSD_DESC
    Public Const MainDetails_Deduct As String = "EXSD_DEDUCTIBLE_ADD"  'PLFSD_DESC
    ...
    Public Sub LoadData(Optional ByRef Errorlog As ClsError = Nothing)
        Try
            ...
            If dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE") IsNot Nothing AndAlso dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE").Rows.Count > 0 AndAlso
                mdlPNL2.GetIncludeInReport(TaxComPNLEnuItem.EXPSALARY, dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE")) Then
