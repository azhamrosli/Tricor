...
Public Class ucPNL_p3Travelling
    ...
    Public Const MainTable As String = "EXPENSES_TRAVEL" 'PLFST_SALES
    Public Const MainTable_Details As String = "EXPENSES_TRAVEL_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "EXT_EXTKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "EXTD_EXTKEY" 'PLFSD_PLFSKEY
    ...
    Public Const Main_Addback As String = "EXT_DEDUCTIBLE"  'PLFSD_DESC
    Public Const MainDetails_Addback As String = "EXTD_DEDUCTIBLE"  'PLFSD_DESC
    Public Const Main_Deduct As String = "EXT_DEDUCTIBLE_ADD"  'PLFSD_DESC
    ...
    Public Sub LoadData(Optional ByRef Errorlog As ClsError = Nothing)
        Try
            ...
            If dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE") IsNot Nothing AndAlso dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE").Rows.Count > 0 AndAlso
                mdlPNL2.GetIncludeInReport(TaxComPNLEnuItem.EXPTRAVEL, dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE")) Then
