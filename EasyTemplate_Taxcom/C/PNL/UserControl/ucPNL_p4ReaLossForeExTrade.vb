...
Public Class ucPNL_p4ReaLossForeExTrade
    ...
    Public Const MainTable As String = "OTHER_EXRLOSSFOREIGNT" 'PLFST_SALES
    Public Const MainTable_Details As String = "OTHER_EXRLOSSFOREIGNT_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "EXORT_EXORTKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "EXORTD_EXORTKEY" 'PLFSD_PLFSKEY
    Public Const MainAmount As String = "EXORT_AMOUNT" 'PLFS_AMOUNT
    Public Const MainAmount_Details As String = "EXORTD_AMOUNT" 'PLFSD_AMOUNT
    Public Const MainSourceNo As String = "EXORT_SOURCENO" 'PLFS_SOURCENO
    Public Const MainSourceNo_Details As String = "EXORTD_SOURCENO" 'PLFS_SOURCENO
    Public Const MainDetail As String = "EXORT_DETAIL"  'PLFS_DETAIL
    Public Const MainDetails_Desc As String = "EXORTD_DESC"  'PLFSD_DESC
    Public Const Main_Desc As String = "EXORT_DESC"  'PLFSD_DESC
    Public Const Main_Addback As String = "EXORT_DEDUCTIBLE"  'PLFSD_DESC
    Public Const MainDetails_Addback As String = "EXORTD_DEDUCTIBLE"  'PLFSD_DESC
    Public Const Main_Deduct As String = "EXORT_DEDUCTIBLE_ADD"  'PLFSD_DESC
    Public Const MainDetails_Deduct As String = "EXORTD_DEDUCTIBLE_ADD"  'PLFSD_DESC
    ...
    Public Sub LoadData(Optional ByRef Errorlog As ClsError = Nothing)
        Try
            ...
            OTHEREXRLOSSFOREIGNTBindingSource.DataSource = DsPNL1.Tables(MainTable)
            ...
            If dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE") IsNot Nothing AndAlso dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE").Rows.Count > 0 AndAlso
                mdlPNL2.GetIncludeInReport(TaxComPNLEnuItem.EXPREALLOSSFETRADE, dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE")) Then
