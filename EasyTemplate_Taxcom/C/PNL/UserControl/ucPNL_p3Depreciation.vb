...
Public Class ucPNL_p3Depreciation
    ...
    Public Const MainTable As String = "OTHER_EXDEPRECIATION" 'PLFST_SALES
    Public Const MainTable_Details As String = "OTHER_EXDEPRECIATION_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "EXODEP_EXODEPKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "EXODEPD_EXODEPKEY" 'PLFSD_PLFSKEY
    ...
    Public Const Main_Addback As String = "EXODEP_DEDUCTIBLE"  'PLFSD_DESC
    Public Const MainDetails_Addback As String = "EXODEPD_DEDUCTIBLE"  'PLFSD_DESC
    Public Const Main_Deduct As String = "EXODEP_DEDUCTIBLE_ADD"  'PLFSD_DESC
    Public Const MainDetails_Deduct As String = "EXODEPD_DEDUCTIBLE_ADD"  'PLFSD_DESC
    ...
    Public Sub LoadData(Optional ByRef Errorlog As ClsError = Nothing)
        Try
            ...
            OTHEREXDEPRECIATIONBindingSource.DataSource = DsPNL1.Tables(MainTable)
            ...
            If dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE") IsNot Nothing AndAlso dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE").Rows.Count > 0 AndAlso
                mdlPNL2.GetIncludeInReport(TaxComPNLEnuItem.EXPDEPRECIATION, dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE")) Then
