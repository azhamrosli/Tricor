...
Partial Class ucPNL_p3COEStock
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ucPNL_p3COEStock))
        ...
        Me.colEXESD_KEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXESD_EXESKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXESD_SOURCENO = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXESD_EXESDKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXESD_DESC = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXESD_AMOUNT = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.txtNumberic = New DevExpress.XtraEditors.Repository.RepositoryItemTextEdit()
        Me.colEXESD_NOTE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.txtNote = New DevExpress.XtraEditors.Repository.RepositoryItemMemoEdit()
        Me.colEXESD_DEDUCTIBLE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.chkBox = New DevExpress.XtraEditors.Repository.RepositoryItemCheckEdit()
        Me.colEXESD_DEDUCTIBLE_ADD = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.EXPENSESEMPLSTOCKBindingSource = New System.Windows.Forms.BindingSource(Me.components)
        Me.DsPNL1 = New EasyTemplate_Taxcom.dsPNL()
        Me.GridView1 = New DevExpress.XtraGrid.Views.Grid.GridView()
        Me.colEXES_KEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXES_EXESKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXES_SOURCENO = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.colEXES_DESC = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXES_AMOUNT = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXES_DEDUCTIBLE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXES_DEDUCTIBLE_ADD = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXES_NOTE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXES_DETAIL = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        CType(Me.EXPENSESEMPLSTOCKBindingSource, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        'GridView2
        '
        Me.GridView2.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colEXESD_KEY, Me.colEXESD_EXESKEY, Me.colEXESD_SOURCENO, Me.colEXESD_EXESDKEY, Me.colEXESD_DESC, Me.colEXESD_AMOUNT, Me.colEXESD_DEDUCTIBLE, Me.colEXESD_DEDUCTIBLE_ADD, Me.colEXESD_NOTE, Me.colRowIndex1, Me.colPecentageAmount1})
        ...
        'colEXESD_KEY
        '
        Me.colEXESD_KEY.FieldName = "EXESD_KEY"
        Me.colEXESD_KEY.Name = "colEXESD_KEY"
        '
        'colEXESD_EXESKEY
        '
        Me.colEXESD_EXESKEY.FieldName = "EXESD_EXESKEY"
        Me.colEXESD_EXESKEY.Name = "colEXESD_EXESKEY"
        '
        'colEXESD_SOURCENO
        '
        Me.colEXESD_SOURCENO.FieldName = "EXESD_SOURCENO"
        Me.colEXESD_SOURCENO.Name = "colEXESD_SOURCENO"
        '
        'colEXESD_EXESDKEY
        '
        Me.colEXESD_EXESDKEY.FieldName = "EXESD_EXESDKEY"
        Me.colEXESD_EXESDKEY.Name = "colEXESD_EXESDKEY"
        '
        'colEXESD_DESC
        '
        Me.colEXESD_DESC.Caption = "Description"
        Me.colEXESD_DESC.FieldName = "EXESD_DESC"
        Me.colEXESD_DESC.Name = "colEXESD_DESC"
        Me.colEXESD_DESC.Visible = True
        Me.colEXESD_DESC.VisibleIndex = 0
        Me.colEXESD_DESC.Width = 300
        '
        'colEXESD_AMOUNT
        '
        Me.colEXESD_AMOUNT.Caption = "Amount"
        Me.colEXESD_AMOUNT.ColumnEdit = Me.txtNumberic
        Me.colEXESD_AMOUNT.FieldName = "EXESD_AMOUNT"
        Me.colEXESD_AMOUNT.Name = "colEXESD_AMOUNT"
        Me.colEXESD_AMOUNT.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "EXESD_AMOUNT", "SUM={0:0.##}")})
        Me.colEXESD_AMOUNT.Visible = True
        Me.colEXESD_AMOUNT.VisibleIndex = 1
        Me.colEXESD_AMOUNT.Width = 120
        '
        'txtNumberic
        '
        ...
        'colEXESD_NOTE
        '
        Me.colEXESD_NOTE.Caption = "Remarks"
        Me.colEXESD_NOTE.ColumnEdit = Me.txtNote
        Me.colEXESD_NOTE.FieldName = "EXESD_NOTE"
        Me.colEXESD_NOTE.Name = "colEXESD_NOTE"
        Me.colEXESD_NOTE.Visible = True
        Me.colEXESD_NOTE.VisibleIndex = 4
        Me.colEXESD_NOTE.Width = 300
        '
        'txtNote
        '
        ...
        'colEXESD_DEDUCTIBLE
        '
        Me.colEXESD_DEDUCTIBLE.Caption = "Add Back"
        Me.colEXESD_DEDUCTIBLE.ColumnEdit = Me.chkBox
        Me.colEXESD_DEDUCTIBLE.FieldName = "EXESD_DEDUCTIBLE"
        Me.colEXESD_DEDUCTIBLE.Name = "colEXESD_DEDUCTIBLE"
        Me.colEXESD_DEDUCTIBLE.Visible = True
        Me.colEXESD_DEDUCTIBLE.VisibleIndex = 2
        Me.colEXESD_DEDUCTIBLE.Width = 100
        '
        'chkBox
        '
        ...
        '
        'colEXESD_DEDUCTIBLE_ADD
        '
        Me.colEXESD_DEDUCTIBLE_ADD.Caption = "Deduct"
        Me.colEXESD_DEDUCTIBLE_ADD.ColumnEdit = Me.chkBox
        Me.colEXESD_DEDUCTIBLE_ADD.FieldName = "EXESD_DEDUCTIBLE_ADD"
        Me.colEXESD_DEDUCTIBLE_ADD.Name = "colEXESD_DEDUCTIBLE_ADD"
        Me.colEXESD_DEDUCTIBLE_ADD.Visible = True
        Me.colEXESD_DEDUCTIBLE_ADD.VisibleIndex = 3
        Me.colEXESD_DEDUCTIBLE_ADD.Width = 100
        '
        'colRowIndex1
        '
        ...
        'GridControl1
        '
        Me.GridControl1.DataSource = Me.EXPENSESEMPLSTOCKBindingSource
        Me.GridControl1.Dock = System.Windows.Forms.DockStyle.Fill
        GridLevelNode1.LevelTemplate = Me.GridView2
        GridLevelNode1.RelationName = "FK_EXPENSES_EMPL_STOCK_EXPENSES_EMPLSTOCK_DETAIL"
        ...
        Me.GridControl1.Size = New System.Drawing.Size(1010, 386)
        Me.GridControl1.TabIndex = 0
        Me.GridControl1.UseEmbeddedNavigator = True
        Me.GridControl1.ViewCollection.AddRange(New DevExpress.XtraGrid.Views.Base.BaseView() {Me.GridView1, Me.GridView2})
        '
        'EXPENSESEMPLSTOCKBindingSource
        '
        Me.EXPENSESEMPLSTOCKBindingSource.DataMember = "EXPENSES_EMPL_STOCK"
        Me.EXPENSESEMPLSTOCKBindingSource.DataSource = Me.DsPNL1
        '
        'DsPNL1
        '
        ...
        'GridView1
        '
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colEXES_KEY, Me.colEXES_EXESKEY, Me.colEXES_SOURCENO, Me.colEXES_DESC, Me.colEXES_AMOUNT, Me.colEXES_DEDUCTIBLE, Me.colEXES_DEDUCTIBLE_ADD, Me.colEXES_NOTE, Me.colEXES_DETAIL, Me.colRowIndex, Me.colPecentageAmount})
        ...
        'colEXES_KEY
        '
        Me.colEXES_KEY.FieldName = "EXES_KEY"
        Me.colEXES_KEY.Name = "colEXES_KEY"
        '
        'colEXES_EXESKEY
        '
        Me.colEXES_EXESKEY.FieldName = "EXES_EXESKEY"
        Me.colEXES_EXESKEY.Name = "colEXES_EXESKEY"
        '
        'colEXES_SOURCENO
        '
        Me.colEXES_SOURCENO.Caption = "Source No"
        Me.colEXES_SOURCENO.ColumnEdit = Me.cboSourceNo
        Me.colEXES_SOURCENO.FieldName = "EXES_SOURCENO"
        Me.colEXES_SOURCENO.Name = "colEXES_SOURCENO"
        Me.colEXES_SOURCENO.Visible = True
        Me.colEXES_SOURCENO.VisibleIndex = 0
        Me.colEXES_SOURCENO.Width = 80
        '
        'cboSourceNo
        '
        ...
        'colEXES_DESC
        '
        Me.colEXES_DESC.Caption = "Description"
        Me.colEXES_DESC.FieldName = "EXES_DESC"
        Me.colEXES_DESC.Name = "colEXES_DESC"
        Me.colEXES_DESC.Visible = True
        Me.colEXES_DESC.VisibleIndex = 1
        Me.colEXES_DESC.Width = 300
        '
        'colEXES_AMOUNT
        '
        Me.colEXES_AMOUNT.Caption = "Amount"
        Me.colEXES_AMOUNT.ColumnEdit = Me.txtNumberic
        Me.colEXES_AMOUNT.FieldName = "EXES_AMOUNT"
        Me.colEXES_AMOUNT.Name = "colEXES_AMOUNT"
        Me.colEXES_AMOUNT.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "EXES_AMOUNT", "SUM={0:0.##}")})
        Me.colEXES_AMOUNT.Visible = True
        Me.colEXES_AMOUNT.VisibleIndex = 2
        Me.colEXES_AMOUNT.Width = 120
        '
        'colEXES_DEDUCTIBLE
        '
        Me.colEXES_DEDUCTIBLE.Caption = "Add Back"
        Me.colEXES_DEDUCTIBLE.ColumnEdit = Me.chkBox
        Me.colEXES_DEDUCTIBLE.FieldName = "EXES_DEDUCTIBLE"
        Me.colEXES_DEDUCTIBLE.Name = "colEXES_DEDUCTIBLE"
        Me.colEXES_DEDUCTIBLE.Visible = True
        Me.colEXES_DEDUCTIBLE.VisibleIndex = 3
        Me.colEXES_DEDUCTIBLE.Width = 100
        '
        'colEXES_DEDUCTIBLE_ADD
        '
        Me.colEXES_DEDUCTIBLE_ADD.Caption = "Deduct"
        Me.colEXES_DEDUCTIBLE_ADD.ColumnEdit = Me.chkBox
        Me.colEXES_DEDUCTIBLE_ADD.FieldName = "EXES_DEDUCTIBLE_ADD"
        Me.colEXES_DEDUCTIBLE_ADD.Name = "colEXES_DEDUCTIBLE_ADD"
        Me.colEXES_DEDUCTIBLE_ADD.Visible = True
        Me.colEXES_DEDUCTIBLE_ADD.VisibleIndex = 4
        Me.colEXES_DEDUCTIBLE_ADD.Width = 100
        '
        'colEXES_NOTE
        '
        Me.colEXES_NOTE.Caption = "Remarks"
        Me.colEXES_NOTE.ColumnEdit = Me.txtNote
        Me.colEXES_NOTE.FieldName = "EXES_NOTE"
        Me.colEXES_NOTE.Name = "colEXES_NOTE"
        Me.colEXES_NOTE.Visible = True
        Me.colEXES_NOTE.VisibleIndex = 5
        Me.colEXES_NOTE.Width = 300
        '
        'colEXES_DETAIL
        '
        Me.colEXES_DETAIL.Caption = "Details"
        Me.colEXES_DETAIL.FieldName = "EXES_DETAIL"
        Me.colEXES_DETAIL.Name = "colEXES_DETAIL"
        Me.colEXES_DETAIL.OptionsColumn.ReadOnly = True
        Me.colEXES_DETAIL.OptionsColumn.TabStop = False
        Me.colEXES_DETAIL.Visible = True
        Me.colEXES_DETAIL.VisibleIndex = 6
        Me.colEXES_DETAIL.Width = 100
        '
        'colRowIndex
        '
        ...
        Me.BarManager1.Items.AddRange(New DevExpress.XtraBars.BarItem() {Me.btnAdd, Me.btnAddChild, Me.btnDelete, Me.chkIncludeInReport, Me.btnMoveUp, Me.btnMoveDown, Me.btnNote})
        ...
        Me.Bar1.LinksPersistInfo.AddRange(New DevExpress.XtraBars.LinkPersistInfo() {New DevExpress.XtraBars.LinkPersistInfo(Me.btnAdd), New DevExpress.XtraBars.LinkPersistInfo(Me.btnAddChild), New DevExpress.XtraBars.LinkPersistInfo(Me.btnDelete), New DevExpress.XtraBars.LinkPersistInfo(Me.chkIncludeInReport), New DevExpress.XtraBars.LinkPersistInfo(Me.btnMoveUp), New DevExpress.XtraBars.LinkPersistInfo(Me.btnMoveDown), New DevExpress.XtraBars.LinkPersistInfo(Me.btnNote)})
        ...
        ToolTipTitleItem4.Text = "Include in Report"
        ToolTipItem4.LeftIndent = 6
        ToolTipItem4.Text = "Include all details item in report."
        SuperToolTip4.Items.Add(ToolTipTitleItem4)
        SuperToolTip4.Items.Add(ToolTipItem4)
        Me.chkIncludeInReport.SuperTip = SuperToolTip4
        '
        ...
        Me.Name = "ucPNL_p3COEStock"
        Me.Size = New System.Drawing.Size(1010, 417)
        ...
        CType(Me.EXPENSESEMPLSTOCKBindingSource, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents colEXESD_KEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXESD_EXESKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXESD_SOURCENO As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXESD_EXESDKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXESD_DESC As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXESD_AMOUNT As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXESD_NOTE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXESD_DEDUCTIBLE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXESD_DEDUCTIBLE_ADD As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colRowIndex1 As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents EXPENSESEMPLSTOCKBindingSource As System.Windows.Forms.BindingSource
    Friend WithEvents colEXES_KEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXES_EXESKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXES_SOURCENO As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXES_DESC As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXES_AMOUNT As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXES_NOTE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXES_DEDUCTIBLE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXES_DEDUCTIBLE_ADD As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXES_DETAIL As DevExpress.XtraGrid.Columns.GridColumn
