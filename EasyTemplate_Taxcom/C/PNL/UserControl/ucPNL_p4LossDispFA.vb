...
Public Class ucPNL_p4LossDispFA
    ...
    Public Const MainTable As String = "OTHER_EXLOSSDISPOSALFA" 'PLFST_SALES
    Public Const MainTable_Details As String = "OTHER_EXLOSSDISPOSALFA_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "EXOLD_EXOLDKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "EXOLDD_EXOLDKEY" 'PLFSD_PLFSKEY
    ...
    Public Const Main_Addback As String = "EXOLD_DEDUCTIBLE"  'PLFSD_DESC
    Public Const MainDetails_Addback As String = "EXOLDD_DEDUCTIBLE"  'PLFSD_DESC
    Public Const Main_Deduct As String = "EXOLD_DEDUCTIBLE_ADD"  'PLFSD_DESC
    Public Const MainDetails_Deduct As String = "EXOLDD_DEDUCTIBLE_ADD"  'PLFSD_DESC
    ...
    Public Sub LoadData(Optional ByRef Errorlog As ClsError = Nothing)
        Try
            ...
            OTHEREXLOSSDISPOSALFABindingSource.DataSource = DsPNL1.Tables(MainTable)
            ...
            If dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE") IsNot Nothing AndAlso dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE").Rows.Count > 0 AndAlso
                mdlPNL2.GetIncludeInReport(TaxComPNLEnuItem.EXPLOSSDISPFA, dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE")) Then
