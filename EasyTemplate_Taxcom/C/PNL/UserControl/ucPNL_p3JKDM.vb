...
Public Class ucPNL_p3JKDM
    ...
    Public Const MainTable As String = "EXPENSES_JKDM" 'PLFST_SALES
    Public Const MainTable_Details As String = "EXPENSES_JKDM_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "EXJK_EXJKKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "EXJKD_EXJKKEY" 'PLFSD_PLFSKEY
    Public Const MainAmount As String = "EXJK_AMOUNT" 'PLFS_AMOUNT
    Public Const MainAmount_Details As String = "EXJKD_AMOUNT" 'PLFSD_AMOUNT
    Public Const MainSourceNo As String = "EXJK_SOURCENO" 'PLFS_SOURCENO
    Public Const MainSourceNo_Details As String = "EXJKD_SOURCENO" 'PLFS_SOURCENO
    Public Const MainDetail As String = "EXJK_DETAIL"  'PLFS_DETAIL
    Public Const MainDetails_Desc As String = "EXJKD_DESC"  'PLFSD_DESC
    Public Const Main_Desc As String = "EXJK_DESC"  'PLFSD_DESC
    Public Const Main_Addback As String = "EXJK_DEDUCTIBLE"  'PLFSD_DESC
    Public Const MainDetails_Addback As String = "EXJKD_DEDUCTIBLE"  'PLFSD_DESC
    Public Const Main_Deduct As String = "EXJK_DEDUCTIBLE_ADD"  'PLFSD_DESC
    Public Const MainDetails_Deduct As String = "EXJKD_DEDUCTIBLE_ADD"  'PLFSD_DESC
    ...
    Public Sub LoadData(Optional ByRef Errorlog As ClsError = Nothing)
        Try
            ...
            EXPENSESJKDMBindingSource.DataSource = DsPNL1.Tables(MainTable)
            ...
            If dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE") IsNot Nothing AndAlso dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE").Rows.Count > 0 AndAlso
                mdlPNL2.GetIncludeInReport(TaxComPNLEnuItem.EXPJKDM, dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE")) Then
