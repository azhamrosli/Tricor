...
Public Class ucPNL_p4Compound
    ...
    Public Const MainTable As String = "OTHER_EXPENALTY" 'PLFST_SALES
    Public Const MainTable_Details As String = "OTHER_EXPENALTY_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "EXOP_EXOPKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "EXOPD_EXOPKEY" 'PLFSD_PLFSKEY
    ...
    Public Const Main_Addback As String = "EXOP_DEDUCTIBLE"  'PLFSD_DESC
    Public Const MainDetails_Addback As String = "EXOPD_DEDUCTIBLE"  'PLFSD_DESC
    Public Const Main_Deduct As String = "EXOP_DEDUCTIBLE_ADD"  'PLFSD_DESC
    Public Const MainDetails_Deduct As String = "EXOPD_DEDUCTIBLE_ADD"  'PLFSD_DESC
    ...
    Public Sub LoadData(Optional ByRef Errorlog As ClsError = Nothing)
        Try
            ...
            OTHEREXPENALTYBindingSource.DataSource = DsPNL1.Tables(MainTable)
            ...
            If dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE") IsNot Nothing AndAlso dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE").Rows.Count > 0 AndAlso
                mdlPNL2.GetIncludeInReport(TaxComPNLEnuItem.EXPCOMPAUNDPENALTY, dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE")) Then
