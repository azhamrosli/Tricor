...
Public Class ucPNL_p4Other
    ...
    Public Const MainTable As String = "OTHER_EXPENSES" 'PLFST_SALES
    Public Const MainTable_Details As String = "OTHER_EXPENSES_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "EXO_EXOKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "EXOD_EXOKEY" 'PLFSD_PLFSKEY
    Public Const MainAmount As String = "EXO_AMOUNT" 'PLFS_AMOUNT
    Public Const MainAmount_Details As String = "EXOD_AMOUNT" 'PLFSD_AMOUNT
    Public Const MainSourceNo As String = "EXO_SOURCENO" 'PLFS_SOURCENO
    Public Const MainSourceNo_Details As String = "EXOD_SOURCENO" 'PLFS_SOURCENO
    Public Const MainDetail As String = "EXO_DETAIL"  'PLFS_DETAIL
    Public Const MainDetails_Desc As String = "EXOD_DESC"  'PLFSD_DESC
    Public Const Main_Desc As String = "EXO_DESC"  'PLFSD_DESC
    Public Const Main_Addback As String = "EXO_DEDUCTIBLE"  'PLFSD_DESC
    Public Const MainDetails_Addback As String = "EXOD_DEDUCTIBLE"  'PLFSD_DESC
    Public Const Main_Deduct As String = "EXO_DEDUCTIBLE_ADD"  'PLFSD_DESC
    Public Const MainDetails_Deduct As String = "EXOD_DEDUCTIBLE_ADD"  'PLFSD_DESC
