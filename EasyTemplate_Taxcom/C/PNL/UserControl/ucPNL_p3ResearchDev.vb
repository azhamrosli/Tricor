...
Public Class ucPNL_p3ResearchDev
    ...
    Public Const MainTable As String = "EXPENSES_RESEARCH" 'PLFST_SALES
    Public Const MainTable_Details As String = "EXPENSES_RESEARCH_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "EXRES_EXRESKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "EXRESD_EXRESKEY" 'PLFSD_PLFSKEY
    Public Const MainAmount As String = "EXRES_AMOUNT" 'PLFS_AMOUNT
    Public Const MainAmount_Details As String = "EXRESD_AMOUNT" 'PLFSD_AMOUNT
    Public Const MainSourceNo As String = "EXRES_SOURCENO" 'PLFS_SOURCENO
    Public Const MainSourceNo_Details As String = "EXRESD_SOURCENO" 'PLFS_SOURCENO
    Public Const MainDetail As String = "EXRES_DETAIL"  'PLFS_DETAIL
    Public Const MainDetails_Desc As String = "EXRESD_DESC"  'PLFSD_DESC
    Public Const Main_Desc As String = "EXRES_DESC"  'PLFSD_DESC
    Public Const Main_Addback As String = "EXRES_DEDUCTIBLE"  'PLFSD_DESC
    Public Const MainDetails_Addback As String = "EXRESD_DEDUCTIBLE"  'PLFSD_DESC
    Public Const Main_Deduct As String = "EXRES_DEDUCTIBLE_ADD"  'PLFSD_DESC
    Public Const MainDetails_Deduct As String = "EXRESD_DEDUCTIBLE_ADD"  'PLFSD_DESC
    ...
    Public Sub LoadData(Optional ByRef Errorlog As ClsError = Nothing)
        Try
            ...
            If dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE") IsNot Nothing AndAlso dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE").Rows.Count > 0 AndAlso
                mdlPNL2.GetIncludeInReport(TaxComPNLEnuItem.EXPRND, dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE")) Then
