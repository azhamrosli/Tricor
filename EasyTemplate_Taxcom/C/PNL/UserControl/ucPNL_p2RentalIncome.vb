    ...
    Private Sub GridView1_InitNewRow(sender As Object, e As InitNewRowEventArgs) Handles GridView1.InitNewRow
        Try
            ...
            If YA IsNot Nothing AndAlso IsNumeric(YA) Then
                GridView1.GetDataRow(e.RowHandle)("RI_DATE") = CDate("01-Jan-" & YA)
                GridView1.GetDataRow(e.RowHandle)("RI_DATE_END") = CDate("31-Dec-" & YA)
            Else
                GridView1.GetDataRow(e.RowHandle)("RI_DATE") = CDate("01-Jan-" & Now.Year.ToString)
                GridView1.GetDataRow(e.RowHandle)("RI_DATE_END") = CDate("31-Dec-" & Now.Year.ToString)
            End If
