...
Public Class ucPNL_p3TechPayNonResis
    ...
    Public Const MainTable As String = "EXPENSES_TECH_FEE" 'PLFST_SALES
    Public Const MainTable_Details As String = "EXPENSES_TECH_FEE_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "EXTF_EXTFKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "EXTFD_EXTFKEY" 'PLFSD_PLFSKEY
    Public Const MainAmount As String = "EXTF_AMOUNT" 'PLFS_AMOUNT
    Public Const MainAmount_Details As String = "EXTFD_AMOUNT" 'PLFSD_AMOUNT
    Public Const MainSourceNo As String = "EXTF_SOURCENO" 'PLFS_SOURCENO
    Public Const MainSourceNo_Details As String = "EXTFD_SOURCENO" 'PLFS_SOURCENO
    Public Const MainDetail As String = "EXTF_DETAIL"  'PLFS_DETAIL
    Public Const MainDetails_Desc As String = "EXTFD_DESC"  'PLFSD_DESC
    Public Const Main_Desc As String = "EXTF_DESC"  'PLFSD_DESC
    Public Const Main_Addback As String = "EXTF_DEDUCTIBLE"  'PLFSD_DESC
    Public Const MainDetails_Addback As String = "EXTFD_DEDUCTIBLE"  'PLFSD_DESC
    Public Const Main_Deduct As String = "EXTF_DEDUCTIBLE_ADD"  'PLFSD_DESC
    Public Const MainDetails_Deduct As String = "EXTFD_DEDUCTIBLE_ADD"  'PLFSD_DESC
    ...
    Public Sub LoadData(Optional ByRef Errorlog As ClsError = Nothing)
        Try
            ...
            EXPENSESTECHFEEBindingSource.DataSource = DsPNL1.Tables(MainTable)
            ...
            If dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE") IsNot Nothing AndAlso dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE").Rows.Count > 0 AndAlso
                mdlPNL2.GetIncludeInReport(TaxComPNLEnuItem.EXPTECHNICAL, dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE")) Then
