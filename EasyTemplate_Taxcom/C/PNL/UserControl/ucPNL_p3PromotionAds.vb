...
Public Class ucPNL_p3PromotionAds
    ...
    Public Const MainTable As String = "EXPENSES_PROMOTE" 'PLFST_SALES
    Public Const MainTable_Details As String = "EXPENSES_PROMOTE_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "EXP_EXPKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "EXPD_EXPKEY" 'PLFSD_PLFSKEY
    ...
    Public Const Main_Addback As String = "EXP_DEDUCTIBLE"  'PLFSD_DESC
    Public Const MainDetails_Addback As String = "EXPD_DEDUCTIBLE"  'PLFSD_DESC
    Public Const Main_Deduct As String = "EXP_DEDUCTIBLE_ADD"  'PLFSD_DESC
    Public Const MainDetails_Deduct As String = "EXPD_DEDUCTIBLE_ADD"  'PLFSD_DESC
    ...
    Public Sub LoadData(Optional ByRef Errorlog As ClsError = Nothing)
        Try
            ...
            EXPENSESPROMOTEBindingSource.DataSource = DsPNL1.Tables(MainTable)
            ...
            If dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE") IsNot Nothing AndAlso dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE").Rows.Count > 0 AndAlso
                mdlPNL2.GetIncludeInReport(TaxComPNLEnuItem.EXPADVERTISEMENT, dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE")) Then
