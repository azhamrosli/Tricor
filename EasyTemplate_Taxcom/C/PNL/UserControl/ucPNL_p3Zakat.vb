...
Public Class ucPNL_p3Zakat
    ...
    Public Const MainTable As String = "OTHER_EXZAKAT" 'PLFST_SALES
    Public Const MainTable_Details As String = "OTHER_EXZAKAT_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "EXOZ_EXOZKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "EXOZD_EXOZKEY" 'PLFSD_PLFSKEY
    ...
    Public Const Main_Addback As String = "EXOZ_DEDUCTIBLE"  'PLFSD_DESC
    Public Const MainDetails_Addback As String = "EXOZD_DEDUCTIBLE"  'PLFSD_DESC
    Public Const Main_Deduct As String = "EXOZ_DEDUCTIBLE_ADD"  'PLFSD_DESC
    Public Const MainDetails_Deduct As String = "EXOZD_DEDUCTIBLE_ADD"  'PLFSD_DESC
    ...
    Public Sub LoadData(Optional ByRef Errorlog As ClsError = Nothing)
        Try
            ...
            OTHEREXZAKATBindingSource.DataSource = DsPNL1.Tables(MainTable)
            ...
            If dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE") IsNot Nothing AndAlso dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE").Rows.Count > 0 AndAlso
                mdlPNL2.GetIncludeInReport(TaxComPNLEnuItem.EXPZAKAT, dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE")) Then
