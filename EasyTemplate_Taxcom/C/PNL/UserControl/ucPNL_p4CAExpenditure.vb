...
Public Class ucPNL_p4CAExpenditure
    ...
    Public Const MainTable As String = "OTHER_EXCAPITALEXP" 'PLFST_SALES
    Public Const MainTable_Details As String = "OTHER_EXCAPITALEXP_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "EXOCE_EXOCEKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "EXOCED_EXOCEKEY" 'PLFSD_PLFSKEY
    Public Const MainAmount As String = "EXOCE_AMOUNT" 'PLFS_AMOUNT
    Public Const MainAmount_Details As String = "EXOCED_AMOUNT" 'PLFSD_AMOUNT
    Public Const MainSourceNo As String = "EXOCE_SOURCENO" 'PLFS_SOURCENO
    Public Const MainSourceNo_Details As String = "EXOCED_SOURCENO" 'PLFS_SOURCENO
    Public Const MainDetail As String = "EXOCE_DETAIL"  'PLFS_DETAIL
    Public Const MainDetails_Desc As String = "EXOCED_DESC"  'PLFSD_DESC
    ...
    Public Sub LoadData(Optional ByRef Errorlog As ClsError = Nothing)
        Try
            ...
            OTHEREXCAPITALEXPBindingSource.DataSource = DsPNL1.Tables(MainTable)
            ...
            If dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE") IsNot Nothing AndAlso dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE").Rows.Count > 0 AndAlso
                mdlPNL2.GetIncludeInReport(TaxComPNLEnuItem.EXPCAPITALEXPENDITURE, dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE")) Then
