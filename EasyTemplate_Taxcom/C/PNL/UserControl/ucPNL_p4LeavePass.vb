...
Public Class ucPNL_p4LeavePass
    ...
    Public Const MainTable As String = "OTHER_EXLEAVEPASSAGE" 'PLFST_SALES
    Public Const MainTable_Details As String = "OTHER_EXLEAVEPASSAGE_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "EXOLP_EXOLPKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "EXOLPD_EXOLPKEY" 'PLFSD_PLFSKEY
    Public Const MainAmount As String = "EXOLP_AMOUNT" 'PLFS_AMOUNT
    Public Const MainAmount_Details As String = "EXOLPD_AMOUNT" 'PLFSD_AMOUNT
    Public Const MainSourceNo As String = "EXOLP_SOURCENO" 'PLFS_SOURCENO
    Public Const MainSourceNo_Details As String = "EXOLPD_SOURCENO" 'PLFS_SOURCENO
    Public Const MainDetail As String = "EXOLP_DETAIL"  'PLFS_DETAIL
    Public Const MainDetails_Desc As String = "EXOLPD_DESC"  'PLFSD_DESC
    Public Const Main_Desc As String = "EXOLP_DESC"  'PLFSD_DESC
    Public Const Main_Addback As String = "EXOLP_DEDUCTIBLE"  'PLFSD_DESC
    Public Const MainDetails_Addback As String = "EXOLPD_DEDUCTIBLE"  'PLFSD_DESC
    Public Const Main_Deduct As String = "EXOLP_DEDUCTIBLE_ADDD"  'PLFSD_DESC
    Public Const MainDetails_Deduct As String = "EXOLPD_DEDUCTIBLE_ADD"  'PLFSD_DESC
    ...
    Public Sub LoadData(Optional ByRef Errorlog As ClsError = Nothing)
        Try
            ...
            If dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE") IsNot Nothing AndAlso dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE").Rows.Count > 0 AndAlso
                mdlPNL2.GetIncludeInReport(TaxComPNLEnuItem.EXPLEAVEPASSAGE, dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE")) Then
