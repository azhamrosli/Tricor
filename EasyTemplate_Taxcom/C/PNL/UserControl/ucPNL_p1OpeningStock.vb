...
Public Class ucPNL_p1OpeningStock
    ...
    Public Const MainSourceNo As String = "PLFOS_SOURCENO" 'PLFS_SOURCENO
    Public Const MainSourceNo_Details As String = "PLFOSD_SOURCENO" 'PLFS_SOURCENO
    Public Const MainDetail As String = "PLFOS_DETAIL"  'PLFS_DETAIL
    Public Const MainDetails_Desc As String = "PLFOSD_DESC"  'PLFSD_DESC
    Public Const Main_Desc As String = "PLFOS_DESC"  'PLFSD_DESC
    ...
    Public Sub LoadData(Optional ByRef Errorlog As ClsError = Nothing)
        Try
            ...
            PLFSTOPENSTOCKBindingSource.DataSource = DsPNL1.Tables(MainTable)
