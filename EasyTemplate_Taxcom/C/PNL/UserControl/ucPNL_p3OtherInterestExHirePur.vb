...
Public Class ucPNL_p3OtherInterestExHirePur
    ...
    Public Const MainTable As String = "EXPENSES_INTEREST" 'PLFST_SALES
    Public Const MainTable_Details As String = "EXPENSES_INTEREST_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "EXI_EXIKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "EXID_EXIKEY" 'PLFSD_PLFSKEY
    ...
    Public Const Main_Addback As String = "EXI_DEDUCTIBLE"  'PLFSD_DESC
    Public Const MainDetails_Addback As String = "EXID_DEDUCTIBLE"  'PLFSD_DESC
    Public Const Main_Deduct As String = "EXI_DEDUCTIBLE_ADD"  'PLFSD_DESC
    Public Const MainDetails_Deduct As String = "EXID_DEDUCTIBLE_ADD"  'PLFSD_DESC
    ...
    Public Sub LoadData(Optional ByRef Errorlog As ClsError = Nothing)
        Try
            ...
            EXPENSESINTERESTBindingSource.DataSource = DsPNL1.Tables(MainTable)
            ...
            If dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE") IsNot Nothing AndAlso dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE").Rows.Count > 0 AndAlso
                mdlPNL2.GetIncludeInReport(TaxComPNLEnuItem.EXPOTHERINTEREST, dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE")) Then
