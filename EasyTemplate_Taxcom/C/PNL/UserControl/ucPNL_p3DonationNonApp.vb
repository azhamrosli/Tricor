...
Public Class ucPNL_p3DonationNonApp
    ...
    Public Const MainTable As String = "OTHER_EXNAPPRDONATION" 'PLFST_SALES
    Public Const MainTable_Details As String = "OTHER_EXNAPPRDONATION_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "EXONAD_EXONADKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "EXONADD_EXONADKEY" 'PLFSD_PLFSKEY
    Public Const MainAmount As String = "EXONAD_AMOUNT" 'PLFS_AMOUNT
    Public Const MainAmount_Details As String = "EXONADD_AMOUNT" 'PLFSD_AMOUNT
    Public Const MainSourceNo As String = "EXONAD_SOURCENO" 'PLFS_SOURCENO
    Public Const MainSourceNo_Details As String = "EXONAD_SOURCENO" 'PLFS_SOURCENO
    Public Const MainDetail As String = "EXONAD_DETAIL"  'PLFS_DETAIL
    Public Const MainDetails_Desc As String = "EXONAD_DESC"  'PLFSD_DESC
    ...
    Public Sub LoadData(Optional ByRef Errorlog As ClsError = Nothing)
        Try
            ...
            OTHEREXNAPPRDONATIONBindingSource.DataSource = DsPNL1.Tables(MainTable)
            ...
            If dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE") IsNot Nothing AndAlso dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE").Rows.Count > 0 AndAlso
                mdlPNL2.GetIncludeInReport(TaxComPNLEnuItem.EXPDONATIONNONAPPR, dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE")) Then
