...
Public Class ucPNL_p4UnreaLossForeEx
    ...
    Public Const MainTable As String = "OTHER_EXURLOSSFOREIGN" 'PLFST_SALES
    Public Const MainTable_Details As String = "OTHER_EXURLOSSFOREIGN_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "EXOUR_EXOURKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "EXOURD_EXOURKEY" 'PLFSD_PLFSKEY
    Public Const MainAmount As String = "EXOUR_AMOUNT" 'PLFS_AMOUNT
    Public Const MainAmount_Details As String = "EXOURD_AMOUNT" 'PLFSD_AMOUNT
    Public Const MainSourceNo As String = "EXOUR_SOURCENO" 'PLFS_SOURCENO
    Public Const MainSourceNo_Details As String = "EXOURD_SOURCENO" 'PLFS_SOURCENO
    Public Const MainDetail As String = "EXOUR_DETAIL"  'PLFS_DETAIL
    Public Const MainDetails_Desc As String = "EXOURD_DESC"  'PLFSD_DESC
    Public Const Main_Desc As String = "EXOUR_DESC"  'PLFSD_DESC
    Public Const Main_Addback As String = "EXOUR_DEDUCTIBLE"  'PLFSD_DESC
    Public Const MainDetails_Addback As String = "EXOURD_DEDUCTIBLE"  'PLFSD_DESC
    Public Const Main_Deduct As String = "EXOUR_DEDUCTIBLE_ADD"  'PLFSD_DESC
    Public Const MainDetails_Deduct As String = "EXOURD_DEDUCTIBLE_ADD"  'PLFSD_DESC
    ...
    Public Sub LoadData(Optional ByRef Errorlog As ClsError = Nothing)
        Try
            ...
            OTHEREXURLOSSFOREIGNBindingSource.DataSource = DsPNL1.Tables(MainTable)
            ...
            If dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE") IsNot Nothing AndAlso dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE").Rows.Count > 0 AndAlso
                mdlPNL2.GetIncludeInReport(TaxComPNLEnuItem.EXPUNREALLOSSFE, dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE")) Then
