...
Public Class ucPNL_p3DonationApp
    ...
    Public Const MainTable As String = "OTHER_EXAPPRDONATION" 'PLFST_SALES
    Public Const MainTable_Details As String = "OTHER_EXAPPRDONATION_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "EXOAD_EXOADKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "EXOADD_EXOADKEY" 'PLFSD_PLFSKEY
    Public Const MainAmount As String = "EXOAD_AMOUNT" 'PLFS_AMOUNT
    Public Const MainAmount_Details As String = "EXOADD_AMOUNT" 'PLFSD_AMOUNT
    Public Const MainSourceNo As String = "EXOAD_SOURCENO" 'PLFS_SOURCENO
    Public Const MainSourceNo_Details As String = "EXOAD_SOURCENO" 'PLFS_SOURCENO
    Public Const MainDetail As String = "EXOAD_DETAIL"  'PLFS_DETAIL
    Public Const MainDetails_Desc As String = "EXOADD_DESC"  'PLFSD_DESC
    ...
    Public Sub LoadData(Optional ByRef Errorlog As ClsError = Nothing)
        Try
            ...
            OTHEREXAPPRDONATIONBindingSource.DataSource = DsPNL1.Tables(MainTable)
            ...
            If dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE") IsNot Nothing AndAlso dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE").Rows.Count > 0 AndAlso
                mdlPNL2.GetIncludeInReport(TaxComPNLEnuItem.EXPDONATIONAPPR, dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE")) Then
