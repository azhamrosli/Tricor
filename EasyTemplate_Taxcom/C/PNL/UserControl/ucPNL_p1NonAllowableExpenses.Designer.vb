...
Partial Class ucPNL_p1NonAllowableExpenses
    ...
    Private Sub InitializeComponent()
        ...
        Me.colEXNAD_KEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXNAD_EXNAKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXNAD_SOURCENO = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXNAD_EXNADKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXNAD_DESC = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXNAD_DEDUCTIBLE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXNAD_AMOUNT = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.colEXNA_EXNAKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXNA_SOURCENO = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.colEXNA_DESC = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXNA_AMOUNT = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXNA_DEDUCTIBLE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.chkBox = New DevExpress.XtraEditors.Repository.RepositoryItemCheckEdit()
        Me.colEXNA_NOTE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXNA_DETAIL = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        'GridView2
        '
        Me.GridView2.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colEXNAD_KEY, Me.colEXNAD_EXNAKEY, Me.colEXNAD_SOURCENO, Me.colEXNAD_EXNADKEY, Me.colEXNAD_DESC, Me.colEXNAD_DEDUCTIBLE, Me.colEXNAD_AMOUNT, Me.colEXNAD_NOTE, Me.colPecentageAmount1})
        ...
        'colEXNAD_KEY
        '
        Me.colEXNAD_KEY.FieldName = "EXNAD_KEY"
        Me.colEXNAD_KEY.Name = "colEXNAD_KEY"
        '
        'colEXNAD_EXNAKEY
        '
        Me.colEXNAD_EXNAKEY.FieldName = "EXNAD_EXNAKEY"
        Me.colEXNAD_EXNAKEY.Name = "colEXNAD_EXNAKEY"
        '
        'colEXNAD_SOURCENO
        '
        Me.colEXNAD_SOURCENO.FieldName = "EXNAD_SOURCENO"
        Me.colEXNAD_SOURCENO.Name = "colEXNAD_SOURCENO"
        '
        'colEXNAD_EXNADKEY
        '
        Me.colEXNAD_EXNADKEY.FieldName = "EXNAD_EXNADKEY"
        Me.colEXNAD_EXNADKEY.Name = "colEXNAD_EXNADKEY"
        '
        'colEXNAD_DESC
        '
        Me.colEXNAD_DESC.Caption = "Description"
        Me.colEXNAD_DESC.FieldName = "EXNAD_DESC"
        Me.colEXNAD_DESC.Name = "colEXNAD_DESC"
        Me.colEXNAD_DESC.Visible = True
        Me.colEXNAD_DESC.VisibleIndex = 0
        Me.colEXNAD_DESC.Width = 300
        '
        'colEXNAD_DEDUCTIBLE
        '
        Me.colEXNAD_DEDUCTIBLE.Caption = "Deductible"
        Me.colEXNAD_DEDUCTIBLE.FieldName = "EXNAD_DEDUCTIBLE"
        Me.colEXNAD_DEDUCTIBLE.Name = "colEXNAD_DEDUCTIBLE"
        Me.colEXNAD_DEDUCTIBLE.Visible = True
        Me.colEXNAD_DEDUCTIBLE.VisibleIndex = 1
        Me.colEXNAD_DEDUCTIBLE.Width = 150
        '
        'colEXNAD_AMOUNT
        '
        Me.colEXNAD_AMOUNT.Caption = "Amount"
        Me.colEXNAD_AMOUNT.ColumnEdit = Me.txtNumberic
        Me.colEXNAD_AMOUNT.FieldName = "EXNAD_AMOUNT"
        Me.colEXNAD_AMOUNT.Name = "colEXNAD_AMOUNT"
        Me.colEXNAD_AMOUNT.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "EXNAD_AMOUNT", "SUM={0:0.##}")})
        Me.colEXNAD_AMOUNT.Visible = True
        Me.colEXNAD_AMOUNT.VisibleIndex = 2
        Me.colEXNAD_AMOUNT.Width = 120
        '
        'txtNumberic
        '
        ...
        'colEXNAD_NOTE
        '
        Me.colEXNAD_NOTE.Caption = "Remarks"
        Me.colEXNAD_NOTE.ColumnEdit = Me.txtNote
        Me.colEXNAD_NOTE.FieldName = "EXNAD_NOTE"
        Me.colEXNAD_NOTE.Name = "colEXNAD_NOTE"
        Me.colEXNAD_NOTE.Visible = True
        Me.colEXNAD_NOTE.VisibleIndex = 3
        Me.colEXNAD_NOTE.Width = 300
        '
        'txtNote
        '
        ...
        'GridControl1
        '
        Me.GridControl1.DataSource = Me.EXPENSESNONALLOWBindingSource
        Me.GridControl1.Dock = System.Windows.Forms.DockStyle.Fill
        GridLevelNode1.LevelTemplate = Me.GridView2
        GridLevelNode1.RelationName = "FK_EXPENSES_NONALLOW_EXPENSES_NONALLOW_DETAIL"
        ...
        Me.GridControl1.Size = New System.Drawing.Size(929, 386)
        ...
        'GridView1
        '
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colEXNA_KEY, Me.colEXNA_EXNAKEY, Me.colEXNA_SOURCENO, Me.colEXNA_DESC, Me.colEXNA_AMOUNT, Me.colEXNA_DEDUCTIBLE, Me.colEXNA_NOTE, Me.colEXNA_DETAIL, Me.colPecentageAmount})
        ...
        'colEXNA_KEY
        '
        Me.colEXNA_KEY.FieldName = "EXNA_KEY"
        Me.colEXNA_KEY.Name = "colEXNA_KEY"
        '
        'colEXNA_EXNAKEY
        '
        Me.colEXNA_EXNAKEY.FieldName = "EXNA_EXNAKEY"
        Me.colEXNA_EXNAKEY.Name = "colEXNA_EXNAKEY"
        '
        'colEXNA_SOURCENO
        '
        Me.colEXNA_SOURCENO.Caption = "Source No"
        Me.colEXNA_SOURCENO.ColumnEdit = Me.cboSourceNo
        Me.colEXNA_SOURCENO.FieldName = "EXNA_SOURCENO"
        Me.colEXNA_SOURCENO.Name = "colEXNA_SOURCENO"
        Me.colEXNA_SOURCENO.Visible = True
        Me.colEXNA_SOURCENO.VisibleIndex = 0
        Me.colEXNA_SOURCENO.Width = 80
        '
        'cboSourceNo
        '
        ...
        'colEXNA_DESC
        '
        Me.colEXNA_DESC.Caption = "Description"
        Me.colEXNA_DESC.FieldName = "EXNA_DESC"
        Me.colEXNA_DESC.Name = "colEXNA_DESC"
        Me.colEXNA_DESC.Visible = True
        Me.colEXNA_DESC.VisibleIndex = 1
        Me.colEXNA_DESC.Width = 300
        '
        'colEXNA_AMOUNT
        '
        Me.colEXNA_AMOUNT.Caption = "Amount"
        Me.colEXNA_AMOUNT.ColumnEdit = Me.txtNumberic
        Me.colEXNA_AMOUNT.FieldName = "EXNA_AMOUNT"
        Me.colEXNA_AMOUNT.Name = "colEXNA_AMOUNT"
        Me.colEXNA_AMOUNT.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "EXNA_AMOUNT", "SUM={0:0.##}")})
        Me.colEXNA_AMOUNT.Visible = True
        Me.colEXNA_AMOUNT.VisibleIndex = 2
        Me.colEXNA_AMOUNT.Width = 150
        '
        'colEXNA_DEDUCTIBLE
        '
        Me.colEXNA_DEDUCTIBLE.Caption = "Deductible"
        Me.colEXNA_DEDUCTIBLE.ColumnEdit = Me.chkBox
        Me.colEXNA_DEDUCTIBLE.FieldName = "EXNA_DEDUCTIBLE"
        Me.colEXNA_DEDUCTIBLE.Name = "colEXNA_DEDUCTIBLE"
        Me.colEXNA_DEDUCTIBLE.Visible = True
        Me.colEXNA_DEDUCTIBLE.VisibleIndex = 3
        Me.colEXNA_DEDUCTIBLE.Width = 150
        '
        'chkBox
        '
        ...
        'colEXNA_NOTE
        '
        Me.colEXNA_NOTE.Caption = "Remarks"
        Me.colEXNA_NOTE.ColumnEdit = Me.txtNote
        Me.colEXNA_NOTE.FieldName = "EXNA_NOTE"
        Me.colEXNA_NOTE.Name = "colEXNA_NOTE"
        Me.colEXNA_NOTE.Visible = True
        Me.colEXNA_NOTE.VisibleIndex = 4
        Me.colEXNA_NOTE.Width = 300
        '
        'colEXNA_DETAIL
        '
        Me.colEXNA_DETAIL.Caption = "Details"
        Me.colEXNA_DETAIL.FieldName = "EXNA_DETAIL"
        Me.colEXNA_DETAIL.Name = "colEXNA_DETAIL"
        Me.colEXNA_DETAIL.OptionsColumn.ReadOnly = True
        Me.colEXNA_DETAIL.OptionsColumn.TabStop = False
        Me.colEXNA_DETAIL.Visible = True
        Me.colEXNA_DETAIL.VisibleIndex = 5
        Me.colEXNA_DETAIL.Width = 150
        '
        'colPecentageAmount
        '
        ...
        Me.barDockControlTop.Size = New System.Drawing.Size(929, 31)
        '
        ...
        Me.barDockControlBottom.Size = New System.Drawing.Size(929, 0)
        '
        'barDockControlLeft
        '
        ...
        Me.barDockControlRight.Location = New System.Drawing.Point(929, 31)
        ...
        Me.Size = New System.Drawing.Size(929, 417)
    ...
    Friend WithEvents colEXNAD_KEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXNAD_EXNAKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXNAD_SOURCENO As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXNAD_EXNADKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXNAD_DESC As DevExpress.XtraGrid.Columns.GridColumn
    ...
    Friend WithEvents colEXNA_DESC As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXNA_AMOUNT As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXNA_DEDUCTIBLE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXNA_NOTE As DevExpress.XtraGrid.Columns.GridColumn
