...
Public Class ucPNL_p4EntStaff
    ...
    Public Const MainTable As String = "OTHER_ENTERTAINSTAFF" 'PLFST_SALES
    Public Const MainTable_Details As String = "OTHER_ENTERTAINSTAFF_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "EXOES_EXOESKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "EXOESD_EXOESKEY" 'PLFSD_PLFSKEY
    Public Const MainAmount As String = "EXOES_AMOUNT" 'PLFS_AMOUNT
    Public Const MainAmount_Details As String = "EXOESD_AMOUNT" 'PLFSD_AMOUNT
    Public Const MainSourceNo As String = "EXOES_SOURCENO" 'PLFS_SOURCENO
    Public Const MainSourceNo_Details As String = "EXOESD_SOURCENO" 'PLFS_SOURCENO
    Public Const MainDetail As String = "EXOES_DETAIL"  'PLFS_DETAIL
    Public Const MainDetails_Desc As String = "EXOESD_DESC"  'PLFSD_DESC
    Public Const Main_Desc As String = "EXOES_DESC"  'PLFSD_DESC
    Public Const Main_Addback As String = "EXOES_DEDUCTIBLE"  'PLFSD_DESC
    Public Const MainDetails_Addback As String = "EXOESD_DEDUCTIBLE"  'PLFSD_DESC
    Public Const Main_Deduct As String = "EXOES_DEDUCTIBLE_ADD"  'PLFSD_DESC
    Public Const MainDetails_Deduct As String = "EXOESD_DEDUCTIBLE_ADD"  'PLFSD_DESC
    ...
    Public Sub LoadData(Optional ByRef Errorlog As ClsError = Nothing)
        Try
            ...
            OTHERENTERTAINSTAFFBindingSource.DataSource = DsPNL1.Tables(MainTable)
            ...
            If dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE") IsNot Nothing AndAlso dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE").Rows.Count > 0 AndAlso
                mdlPNL2.GetIncludeInReport(TaxComPNLEnuItem.EXPENTERTAINSTAFF, dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE")) Then
