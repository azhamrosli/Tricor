...
Public Class ucPNL_p3ProTechManLeganFees
    ...
    Public Const MainTable As String = "EXPENSES_LEGAL" 'PLFST_SALES
    Public Const MainTable_Details As String = "EXPENSES_LEGAL_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "EXL_EXLKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "EXLD_EXLKEY" 'PLFSD_PLFSKEY
    ...
    Public Const Main_Addback As String = "EXL_DEDUCTIBLE"  'PLFSD_DESC
    Public Const MainDetails_Addback As String = "EXLD_DEDUCTIBLE"  'PLFSD_DESC
    Public Const Main_Deduct As String = "EXL_DEDUCTIBLE_ADD"  'PLFSD_DESC
    Public Const MainDetails_Deduct As String = "EXLD_DEDUCTIBLE_ADD"  'PLFSD_DESC
    ...
    Public Sub LoadData(Optional ByRef Errorlog As ClsError = Nothing)
        Try
            ...
            EXPENSESLEGALBindingSource.DataSource = DsPNL1.Tables(MainTable)
            ...
            If dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE") IsNot Nothing AndAlso dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE").Rows.Count > 0 AndAlso
                mdlPNL2.GetIncludeInReport(TaxComPNLEnuItem.EXPLEGAL, dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE")) Then
