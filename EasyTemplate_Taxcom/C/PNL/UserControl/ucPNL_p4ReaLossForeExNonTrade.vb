...
Public Class ucPNL_p4ReaLossForeExNonTrade
    ...
    Public Const MainTable As String = "OTHER_EXRLOSSFOREIGN" 'PLFST_SALES
    Public Const MainTable_Details As String = "OTHER_EXRLOSSFOREIGN_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "EXOR_EXORKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "EXORD_EXORKEY" 'PLFSD_PLFSKEY
    ...
    Public Const Main_Addback As String = "EXOR_DEDUCTIBLE"  'PLFSD_DESC
    Public Const MainDetails_Addback As String = "EXORD_DEDUCTIBLE"  'PLFSD_DESC
    Public Const Main_Deduct As String = "EXOR_DEDUCTIBLE_ADD"  'PLFSD_DESC
    Public Const MainDetails_Deduct As String = "EXORD_DEDUCTIBLE_ADD"  'PLFSD_DESC
    ...
    Public Sub LoadData(Optional ByRef Errorlog As ClsError = Nothing)
        Try
            ...
            OTHEREXRLOSSFOREIGNBindingSource.DataSource = DsPNL1.Tables(MainTable)
            ...
            If dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE") IsNot Nothing AndAlso dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE").Rows.Count > 0 AndAlso
                mdlPNL2.GetIncludeInReport(TaxComPNLEnuItem.EXPREALLOSSFENONTRADE, dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE")) Then
