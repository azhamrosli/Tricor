...
Partial Class ucPNL_p4ReaLossForeExTrade
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ucPNL_p4ReaLossForeExTrade))
        ...
        Me.colEXORTD_KEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXORTD_EXORTKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXORTD_SOURCENO = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXORTD_EXORTDKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXORTD_DESC = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXORTD_AMOUNT = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.colEXORTD_NOTE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.txtNote = New DevExpress.XtraEditors.Repository.RepositoryItemMemoEdit()
        Me.colEXORTD_DEDUCTIBLE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.chkBox = New DevExpress.XtraEditors.Repository.RepositoryItemCheckEdit()
        Me.colEXORTD_DEDUCTIBLE_ADD = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.OTHEREXRLOSSFOREIGNTBindingSource = New System.Windows.Forms.BindingSource(Me.components)
        Me.DsPNL1 = New EasyTemplate_Taxcom.dsPNL()
        Me.GridView1 = New DevExpress.XtraGrid.Views.Grid.GridView()
        Me.colEXORT_KEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXORT_EXORTKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXORT_SOURCENO = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.colEXORT_DESC = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXORT_AMOUNT = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXORT_DEDUCTIBLE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXORT_DEDUCTIBLE_ADD = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPecentage = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXORT_NOTE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXORT_DETAIL = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        CType(Me.OTHEREXRLOSSFOREIGNTBindingSource, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        'GridView2
        '
        Me.GridView2.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colEXORTD_KEY, Me.colEXORTD_EXORTKEY, Me.colEXORTD_SOURCENO, Me.colEXORTD_EXORTDKEY, Me.colEXORTD_DESC, Me.colEXORTD_AMOUNT, Me.colEXORTD_DEDUCTIBLE, Me.colEXORTD_DEDUCTIBLE_ADD, Me.colPecentage1, Me.colEXORTD_NOTE, Me.colRowIndex1, Me.colPecentageAmount1})
        ...
        'colEXORTD_KEY
        '
        Me.colEXORTD_KEY.FieldName = "EXORTD_KEY"
        Me.colEXORTD_KEY.Name = "colEXORTD_KEY"
        '
        'colEXORTD_EXORTKEY
        '
        Me.colEXORTD_EXORTKEY.FieldName = "EXORTD_EXORTKEY"
        Me.colEXORTD_EXORTKEY.Name = "colEXORTD_EXORTKEY"
        '
        'colEXORTD_SOURCENO
        '
        Me.colEXORTD_SOURCENO.FieldName = "EXORTD_SOURCENO"
        Me.colEXORTD_SOURCENO.Name = "colEXORTD_SOURCENO"
        '
        'colEXORTD_EXORTDKEY
        '
        Me.colEXORTD_EXORTDKEY.FieldName = "EXORTD_EXORTDKEY"
        Me.colEXORTD_EXORTDKEY.Name = "colEXORTD_EXORTDKEY"
        '
        'colEXORTD_DESC
        '
        Me.colEXORTD_DESC.Caption = "Description"
        Me.colEXORTD_DESC.FieldName = "EXORTD_DESC"
        Me.colEXORTD_DESC.Name = "colEXORTD_DESC"
        Me.colEXORTD_DESC.Visible = True
        Me.colEXORTD_DESC.VisibleIndex = 0
        Me.colEXORTD_DESC.Width = 300
        '
        'colEXORTD_AMOUNT
        '
        Me.colEXORTD_AMOUNT.Caption = "Amount"
        Me.colEXORTD_AMOUNT.ColumnEdit = Me.txtNumberic
        Me.colEXORTD_AMOUNT.FieldName = "EXORTD_AMOUNT"
        Me.colEXORTD_AMOUNT.Name = "colEXORTD_AMOUNT"
        Me.colEXORTD_AMOUNT.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "EXORTD_AMOUNT", "SUM={0:0.##}")})
        Me.colEXORTD_AMOUNT.Visible = True
        Me.colEXORTD_AMOUNT.VisibleIndex = 1
        Me.colEXORTD_AMOUNT.Width = 120
        '
        'txtNumberic
        '
        ...
        'colEXORTD_NOTE
        '
        Me.colEXORTD_NOTE.Caption = "Remarks"
        Me.colEXORTD_NOTE.ColumnEdit = Me.txtNote
        Me.colEXORTD_NOTE.FieldName = "EXORTD_NOTE"
        Me.colEXORTD_NOTE.Name = "colEXORTD_NOTE"
        Me.colEXORTD_NOTE.Visible = True
        Me.colEXORTD_NOTE.VisibleIndex = 5
        Me.colEXORTD_NOTE.Width = 300
        '
        'txtNote
        '
        ...
        '
        'colEXORTD_DEDUCTIBLE
        '
        Me.colEXORTD_DEDUCTIBLE.Caption = "Add Back"
        Me.colEXORTD_DEDUCTIBLE.ColumnEdit = Me.chkBox
        Me.colEXORTD_DEDUCTIBLE.FieldName = "EXORTD_DEDUCTIBLE"
        Me.colEXORTD_DEDUCTIBLE.Name = "colEXORTD_DEDUCTIBLE"
        Me.colEXORTD_DEDUCTIBLE.Visible = True
        Me.colEXORTD_DEDUCTIBLE.VisibleIndex = 2
        Me.colEXORTD_DEDUCTIBLE.Width = 100
        '
        'chkBox
        '
        ...
        '
        'colEXORTD_DEDUCTIBLE_ADD
        '
        Me.colEXORTD_DEDUCTIBLE_ADD.Caption = "Deduct"
        Me.colEXORTD_DEDUCTIBLE_ADD.ColumnEdit = Me.chkBox
        Me.colEXORTD_DEDUCTIBLE_ADD.FieldName = "EXORTD_DEDUCTIBLE_ADD"
        Me.colEXORTD_DEDUCTIBLE_ADD.Name = "colEXORTD_DEDUCTIBLE_ADD"
        Me.colEXORTD_DEDUCTIBLE_ADD.Visible = True
        Me.colEXORTD_DEDUCTIBLE_ADD.VisibleIndex = 3
        Me.colEXORTD_DEDUCTIBLE_ADD.Width = 100
        '
        'colRowIndex1
        '
        ...
        'GridControl1
        '
        Me.GridControl1.DataSource = Me.OTHEREXRLOSSFOREIGNTBindingSource
        Me.GridControl1.Dock = System.Windows.Forms.DockStyle.Fill
        GridLevelNode1.LevelTemplate = Me.GridView2
        GridLevelNode1.RelationName = "FK_OTHER_EXRLOSSFOREIGNT_OTHER_EXRLOSSFOREIGNT_DETAIL"
        ...
        Me.GridControl1.Size = New System.Drawing.Size(1082, 386)
        ...
        'GridView1
        '
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colEXORT_KEY, Me.colEXORT_EXORTKEY, Me.colEXORT_SOURCENO, Me.colEXORT_DESC, Me.colEXORT_AMOUNT, Me.colEXORT_DEDUCTIBLE, Me.colEXORT_DEDUCTIBLE_ADD, Me.colPecentage, Me.colEXORT_NOTE, Me.colEXORT_DETAIL, Me.colRowIndex, Me.colPecentageAmount})
        ...
        'colEXORT_KEY
        '
        Me.colEXORT_KEY.FieldName = "EXORT_KEY"
        Me.colEXORT_KEY.Name = "colEXORT_KEY"
        '
        'colEXORT_EXORTKEY
        '
        Me.colEXORT_EXORTKEY.FieldName = "EXORT_EXORTKEY"
        Me.colEXORT_EXORTKEY.Name = "colEXORT_EXORTKEY"
        '
        'colEXORT_SOURCENO
        '
        Me.colEXORT_SOURCENO.Caption = "Source No"
        Me.colEXORT_SOURCENO.ColumnEdit = Me.cboSourceNo
        Me.colEXORT_SOURCENO.FieldName = "EXORT_SOURCENO"
        Me.colEXORT_SOURCENO.Name = "colEXORT_SOURCENO"
        Me.colEXORT_SOURCENO.Visible = True
        Me.colEXORT_SOURCENO.VisibleIndex = 0
        Me.colEXORT_SOURCENO.Width = 80
        '
        'cboSourceNo
        '
        ...
        'colEXORT_DESC
        '
        Me.colEXORT_DESC.Caption = "Description"
        Me.colEXORT_DESC.FieldName = "EXORT_DESC"
        Me.colEXORT_DESC.Name = "colEXORT_DESC"
        Me.colEXORT_DESC.Visible = True
        Me.colEXORT_DESC.VisibleIndex = 1
        Me.colEXORT_DESC.Width = 300
        '
        'colEXORT_AMOUNT
        '
        Me.colEXORT_AMOUNT.Caption = "Amount"
        Me.colEXORT_AMOUNT.ColumnEdit = Me.txtNumberic
        Me.colEXORT_AMOUNT.FieldName = "EXORT_AMOUNT"
        Me.colEXORT_AMOUNT.Name = "colEXORT_AMOUNT"
        Me.colEXORT_AMOUNT.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "EXORT_AMOUNT", "SUM={0:0.##}")})
        Me.colEXORT_AMOUNT.Visible = True
        Me.colEXORT_AMOUNT.VisibleIndex = 2
        Me.colEXORT_AMOUNT.Width = 120
        '
        'colEXORT_DEDUCTIBLE
        '
        Me.colEXORT_DEDUCTIBLE.Caption = "Add Back"
        Me.colEXORT_DEDUCTIBLE.ColumnEdit = Me.chkBox
        Me.colEXORT_DEDUCTIBLE.FieldName = "EXORT_DEDUCTIBLE"
        Me.colEXORT_DEDUCTIBLE.Name = "colEXORT_DEDUCTIBLE"
        Me.colEXORT_DEDUCTIBLE.Visible = True
        Me.colEXORT_DEDUCTIBLE.VisibleIndex = 3
        Me.colEXORT_DEDUCTIBLE.Width = 100
        '
        'colEXORT_DEDUCTIBLE_ADD
        '
        Me.colEXORT_DEDUCTIBLE_ADD.Caption = "Deduct"
        Me.colEXORT_DEDUCTIBLE_ADD.ColumnEdit = Me.chkBox
        Me.colEXORT_DEDUCTIBLE_ADD.FieldName = "EXORT_DEDUCTIBLE_ADD"
        Me.colEXORT_DEDUCTIBLE_ADD.Name = "colEXORT_DEDUCTIBLE_ADD"
        Me.colEXORT_DEDUCTIBLE_ADD.Visible = True
        Me.colEXORT_DEDUCTIBLE_ADD.VisibleIndex = 4
        Me.colEXORT_DEDUCTIBLE_ADD.Width = 100
        '
        'colPecentage
        '
        ...
        'colEXORT_NOTE
        '
        Me.colEXORT_NOTE.Caption = "Remarks"
        Me.colEXORT_NOTE.ColumnEdit = Me.txtNote
        Me.colEXORT_NOTE.FieldName = "EXORT_NOTE"
        Me.colEXORT_NOTE.Name = "colEXORT_NOTE"
        Me.colEXORT_NOTE.Visible = True
        Me.colEXORT_NOTE.VisibleIndex = 6
        Me.colEXORT_NOTE.Width = 300
        '
        'colEXORT_DETAIL
        '
        Me.colEXORT_DETAIL.Caption = "Details"
        Me.colEXORT_DETAIL.FieldName = "EXORT_DETAIL"
        Me.colEXORT_DETAIL.Name = "colEXORT_DETAIL"
        Me.colEXORT_DETAIL.OptionsColumn.ReadOnly = True
        Me.colEXORT_DETAIL.OptionsColumn.TabStop = False
        Me.colEXORT_DETAIL.Visible = True
        Me.colEXORT_DETAIL.VisibleIndex = 7
        Me.colEXORT_DETAIL.Width = 100
        '
        'colRowIndex
        '
        ...
        Me.barDockControlTop.Size = New System.Drawing.Size(1082, 31)
        '
        ...
        Me.barDockControlRight.Location = New System.Drawing.Point(1082, 31)
        ...
        Me.Name = "ucPNL_p4ReaLossForeExTrade"
        Me.Size = New System.Drawing.Size(1082, 417)
        ...
        CType(Me.OTHEREXRLOSSFOREIGNTBindingSource, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents OTHEREXRLOSSFOREIGNTBindingSource As System.Windows.Forms.BindingSource
    Friend WithEvents colEXORTD_KEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXORTD_EXORTKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXORTD_SOURCENO As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXORTD_EXORTDKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXORTD_DESC As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXORTD_AMOUNT As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPecentage1 As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXORTD_NOTE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXORTD_DEDUCTIBLE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXORTD_DEDUCTIBLE_ADD As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colRowIndex1 As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXORT_KEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXORT_EXORTKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXORT_SOURCENO As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXORT_DESC As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXORT_AMOUNT As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPecentage As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXORT_NOTE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXORT_DEDUCTIBLE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXORT_DEDUCTIBLE_ADD As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXORT_DETAIL As DevExpress.XtraGrid.Columns.GridColumn
