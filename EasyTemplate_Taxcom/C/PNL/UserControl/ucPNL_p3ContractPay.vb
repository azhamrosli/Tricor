...
Public Class ucPNL_p3ContractPay
    ...
    Public Const MainTable As String = "EXPENSES_CONTRACT" 'PLFST_SALES
    Public Const MainTable_Details As String = "EXPENSES_CONTRACT_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "EXC_EXCKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "EXCD_EXCKEY" 'PLFSD_PLFSKEY
    ...
    Public Const Main_Addback As String = "EXC_DEDUCTIBLE"  'PLFSD_DESC
    Public Const MainDetails_Addback As String = "EXCD_DEDUCTIBLE"  'PLFSD_DESC
    Public Const Main_Deduct As String = "EXC_DEDUCTIBLE_ADD"  'PLFSD_DESC
    Public Const MainDetails_Deduct As String = "EXCD_DEDUCTIBLE_ADD"  'PLFSD_DESC
    ...
    Public Sub LoadData(Optional ByRef Errorlog As ClsError = Nothing)
        Try
            ...
            EXPENSESCONTRACTBindingSource.DataSource = DsPNL1.Tables(MainTable)
            ...
            If dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE") IsNot Nothing AndAlso dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE").Rows.Count > 0 AndAlso
                mdlPNL2.GetIncludeInReport(TaxComPNLEnuItem.EXPCONTRACTPAY, dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE")) Then
