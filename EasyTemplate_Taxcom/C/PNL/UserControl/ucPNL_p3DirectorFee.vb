...
Public Class ucPNL_p3DirectorFee
    ...
    Public Const MainTable As String = "EXPENSES_DIRECTORS_FEE" 'PLFST_SALES
    Public Const MainTable_Details As String = "EXPENSES_DIRECTORS_FEE_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "EXDF_EXDFKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "EXDFD_EXDFKEY" 'PLFSD_PLFSKEY
    Public Const MainAmount As String = "EXDF_AMOUNT" 'PLFS_AMOUNT
    Public Const MainAmount_Details As String = "EXDFD_AMOUNT" 'PLFSD_AMOUNT
    Public Const MainSourceNo As String = "EXDF_SOURCENO" 'PLFS_SOURCENO
    Public Const MainSourceNo_Details As String = "EXDFD_SOURCENO" 'PLFS_SOURCENO
    Public Const MainDetail As String = "EXDF_DETAIL"  'PLFS_DETAIL
    Public Const MainDetails_Desc As String = "EXDFD_DESC"  'PLFSD_DESC
    Public Const Main_Desc As String = "EXDF_DESC"  'PLFSD_DESC
    Public Const Main_Addback As String = "EXDF_DEDUCTIBLE"  'PLFSD_DESC
    Public Const MainDetails_Addback As String = "EXDFD_DEDUCTIBLE"  'PLFSD_DESC
    Public Const Main_Deduct As String = "EXDF_DEDUCTIBLE_ADD"  'PLFSD_DESC
    Public Const MainDetails_Deduct As String = "EXDFD_DEDUCTIBLE_ADD"  'PLFSD_DESC
    ...
    Public Sub LoadData(Optional ByRef Errorlog As ClsError = Nothing)
        Try
            ...
            EXPENSESDIRECTORSFEEBindingSource.DataSource = DsPNL1.Tables(MainTable)
            ...
            If dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE") IsNot Nothing AndAlso dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE").Rows.Count > 0 AndAlso
                mdlPNL2.GetIncludeInReport(TaxComPNLEnuItem.EXPDIRECTORFEE, dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE")) Then
