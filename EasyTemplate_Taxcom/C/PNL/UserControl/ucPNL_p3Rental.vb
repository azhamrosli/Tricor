...
Public Class ucPNL_p3Rental
    ...
    Public Const MainTable As String = "EXPENSES_RENTAL" 'PLFST_SALES
    Public Const MainTable_Details As String = "EXPENSES_RENTAL_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "EXRENT_EXRENTKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "EXRENTD_EXRENTKEY" 'PLFSD_PLFSKEY
    ...
    Public Const Main_Addback As String = "EXRENT_DEDUCTIBLE"  'PLFSD_DESC
    Public Const MainDetails_Addback As String = "EXRENTD_DEDUCTIBLE"  'PLFSD_DESC
    Public Const Main_Deduct As String = "EXRENT_DEDUCTIBLE_ADD"  'PLFSD_DESC
    Public Const MainDetails_Deduct As String = "EXRENTD_DEDUCTIBLE_ADD"  'PLFSD_DESC
    ...
    Public Sub LoadData(Optional ByRef Errorlog As ClsError = Nothing)
        Try
            ...
            EXPENSESRENTALBindingSource.DataSource = DsPNL1.Tables(MainTable)
            ...
            If dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE") IsNot Nothing AndAlso dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE").Rows.Count > 0 AndAlso
                mdlPNL2.GetIncludeInReport(TaxComPNLEnuItem.EXPRENTAL, dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE")) Then
