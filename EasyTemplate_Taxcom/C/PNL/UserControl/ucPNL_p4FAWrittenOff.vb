...
Public Class ucPNL_p4FAWrittenOff
    ...
    Public Const MainTable As String = "OTHER_EXFAWRITTENOFF" 'PLFST_SALES
    Public Const MainTable_Details As String = "OTHER_EXFAWRITTENOFF_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "EXOWO_EXOWOKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "EXOWOD_EXOWOKEY" 'PLFSD_PLFSKEY
    Public Const MainAmount As String = "EXOWO_AMOUNT" 'PLFS_AMOUNT
    Public Const MainAmount_Details As String = "EXOWOD_AMOUNT" 'PLFSD_AMOUNT
    Public Const MainSourceNo As String = "EXOWO_SOURCENO" 'PLFS_SOURCENO
    Public Const MainSourceNo_Details As String = "EXOWOD_SOURCENO" 'PLFS_SOURCENO
    Public Const MainDetail As String = "EXOWO_DETAIL"  'PLFS_DETAIL
    Public Const MainDetails_Desc As String = "EXOWOD_DESC"  'PLFSD_DESC
    Public Const Main_Desc As String = "EXOWO_DESC"  'PLFSD_DESC
    Public Const Main_Addback As String = "EXOWO_DEDUCTIBLE"  'PLFSD_DESC
    Public Const MainDetails_Addback As String = "EXOWOD_DEDUCTIBLE"  'PLFSD_DESC
    Public Const Main_Deduct As String = "EXOWO_DEDUCTIBLE_ADD"  'PLFSD_DESC
    Public Const MainDetails_Deduct As String = "EXOWOD_DEDUCTIBLE_ADD"  'PLFSD_DESC
    ...
    Public Sub LoadData(Optional ByRef Errorlog As ClsError = Nothing)
        Try
            ...
            OTHEREXFAWRITTENOFFBindingSource.DataSource = DsPNL1.Tables(MainTable)
            ...
            If dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE") IsNot Nothing AndAlso dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE").Rows.Count > 0 AndAlso
                mdlPNL2.GetIncludeInReport(TaxComPNLEnuItem.EXPFAWRITTENOFF, dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE")) Then
