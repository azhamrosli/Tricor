...
Public Class ucPNL_p4InitSub
    ...
    Public Const MainTable As String = "OTHER_EXINITIALSUB" 'PLFST_SALES
    Public Const MainTable_Details As String = "OTHER_EXINITIALSUB_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "EXOIS_EXOISKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "EXOISD_EXOISKEY" 'PLFSD_PLFSKEY
    ...
    Public Const Main_Addback As String = "EXOIS_DEDUCTIBLE"  'PLFSD_DESC
    Public Const MainDetails_Addback As String = "EXOISD_DEDUCTIBLE"  'PLFSD_DESC
    Public Const Main_Deduct As String = "EXOIS_DEDUCTIBLE_ADD"  'PLFSD_DESC
    Public Const MainDetails_Deduct As String = "EXOISD_DEDUCTIBLE_ADD"  'PLFSD_DESC
    ...
    Public Sub LoadData(Optional ByRef Errorlog As ClsError = Nothing)
        Try
            ...
            OTHEREXINITIALSUBBindingSource.DataSource = DsPNL1.Tables(MainTable)
            ...
            If dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE") IsNot Nothing AndAlso dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE").Rows.Count > 0 AndAlso
                mdlPNL2.GetIncludeInReport(TaxComPNLEnuItem.EXPINITIALSUBSCRIPT, dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE")) Then
