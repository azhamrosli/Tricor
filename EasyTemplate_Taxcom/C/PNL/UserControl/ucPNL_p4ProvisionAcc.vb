...
Public Class ucPNL_p4ProvisionAcc
    ...
    Public Const MainTable As String = "OTHER_EXPROVISIONACC" 'PLFST_SALES
    Public Const MainTable_Details As String = "OTHER_EXPROVISIONACC_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "EXOPA_EXOPAKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "EXOPAD_EXOPAKEY" 'PLFSD_PLFSKEY
    Public Const MainAmount As String = "EXOPA_AMOUNT" 'PLFS_AMOUNT
    Public Const MainAmount_Details As String = "EXOPAD_AMOUNT" 'PLFSD_AMOUNT
    Public Const MainSourceNo As String = "EXOPA_SOURCENO" 'PLFS_SOURCENO
    Public Const MainSourceNo_Details As String = "EXOPAD_SOURCENO" 'PLFS_SOURCENO
    Public Const MainDetail As String = "EXOPA_DETAIL"  'PLFS_DETAIL
    Public Const MainDetails_Desc As String = "EXOPAD_DESC"  'PLFSD_DESC
    Public Const Main_Desc As String = "EXOPA_DESC"  'PLFSD_DESC
    Public Const Main_Addback As String = "EXOPA_DEDUCTIBLE"  'PLFSD_DESC
    Public Const MainDetails_Addback As String = "EXOPAD_DEDUCTIBLE"  'PLFSD_DESC
    Public Const Main_Deduct As String = "EXOPA_DEDUCTIBLE_ADD"  'PLFSD_DESC
    Public Const MainDetails_Deduct As String = "EXOPAD_DEDUCTIBLE_ADD"  'PLFSD_DESC
    ...
    Public Sub LoadData(Optional ByRef Errorlog As ClsError = Nothing)
        Try
            ...
            OTHEREXPROVISIONACCBindingSource.DataSource = DsPNL1.Tables(MainTable)
            ...
            If dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE") IsNot Nothing AndAlso dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE").Rows.Count > 0 AndAlso
                mdlPNL2.GetIncludeInReport(TaxComPNLEnuItem.EXPPROVISION, dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE")) Then
