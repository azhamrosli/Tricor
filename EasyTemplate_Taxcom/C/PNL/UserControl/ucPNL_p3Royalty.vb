...
Public Class ucPNL_p3Royalty
    ...
    Public Const MainTable As String = "EXPENSES_ROYALTY" 'PLFST_SALES
    Public Const MainTable_Details As String = "EXPENSES_ROYALTY_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "EXRO_EXROKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "EXROD_EXROKEY" 'PLFSD_PLFSKEY
    Public Const MainAmount As String = "EXRO_AMOUNT" 'PLFS_AMOUNT
    Public Const MainAmount_Details As String = "EXROD_AMOUNT" 'PLFSD_AMOUNT
    Public Const MainSourceNo As String = "EXRO_SOURCENO" 'PLFS_SOURCENO
    Public Const MainSourceNo_Details As String = "EXROD_SOURCENO" 'PLFS_SOURCENO
    ...
    Public Const Main_Deduct As String = "EXRO_DEDUCTIBLE_ADD"  'PLFSD_DESC
    Public Const MainDetails_Deduct As String = "EXROD_DEDUCTIBLE_ADD"  'PLFSD_DESC
    ...
    Public Sub LoadData(Optional ByRef Errorlog As ClsError = Nothing)
        Try
            ...
            EXPENSESROYALTYBindingSource.DataSource = DsPNL1.Tables(MainTable)
            ...
            If dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE") IsNot Nothing AndAlso dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE").Rows.Count > 0 AndAlso
                mdlPNL2.GetIncludeInReport(TaxComPNLEnuItem.EXPROYALTY, dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE")) Then
