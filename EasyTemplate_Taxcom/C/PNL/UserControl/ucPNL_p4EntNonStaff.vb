...
Public Class ucPNL_p4EntNonStaff
    ...
    Public Const MainTable As String = "OTHER_ENTERTAINNSTAFF" 'PLFST_SALES
    Public Const MainTable_Details As String = "OTHER_ENTERTAINNSTAFF_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "EXOENS_EXOENSKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "EXOENSD_EXOENSKEY" 'PLFSD_PLFSKEY
    Public Const MainAmount As String = "EXOENS_AMOUNT" 'PLFS_AMOUNT
    Public Const MainAmount_Details As String = "EXOENSD_AMOUNT" 'PLFSD_AMOUNT
    Public Const MainSourceNo As String = "EXOENS_SOURCENO" 'PLFS_SOURCENO
    Public Const MainSourceNo_Details As String = "EXOENSD_SOURCENO" 'PLFS_SOURCENO
    Public Const MainDetail As String = "EXOENS_DETAIL"  'PLFS_DETAIL
    Public Const MainDetails_Desc As String = "EXOENSD_DESC"  'PLFSD_DESC
    Public Const Main_Desc As String = "EXOENS_DESC"  'PLFSD_DESC
    Public Const Main_Addback As String = "EXOENS_DEDUCTIBLE"  'PLFSD_DESC
    Public Const MainDetails_Addback As String = "EXOENSD_DEDUCTIBLE"  'PLFSD_DESC
    Public Const Main_Deduct As String = "EXOENS_DEDUCTIBLE_ADD"  'PLFSD_DESC
    Public Const MainDetails_Deduct As String = "EXOENSD_DEDUCTIBLE_ADD"  'PLFSD_DESC
    ...
    Public Sub LoadData(Optional ByRef Errorlog As ClsError = Nothing)
        Try
            ...
            OTHERENTERTAINNSTAFFBindingSource.DataSource = DsPNL1.Tables(MainTable)
            ...
            If dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE") IsNot Nothing AndAlso dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE").Rows.Count > 0 AndAlso
                mdlPNL2.GetIncludeInReport(TaxComPNLEnuItem.EXPENTERTAINNONSTAFF, dsDataSet.Tables("PROFIT_LOSS_ACCOUNT_REPORT_EXCLUDE")) Then
    ...
    Private Sub GridView1_InitNewRow(sender As Object, e As InitNewRowEventArgs) Handles GridView1.InitNewRow
        Try
            ...
            GridView1.GetDataRow(e.RowHandle)(MainColumn_Percentage) = 100
        Catch ex As Exception
            Dim st As New StackTrace(True)
             st = New StackTrace(ex, True)
