...
Partial Class ucPNL_p1Sales
    ...
    Private Sub InitializeComponent()
        ...
        Me.colPLFSD_SOURCENO = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFSD_PLFSDKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFSD_DESC = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFSD_AMOUNT = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.colPLFS_PLFSKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFS_SOURCENO = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.colPLFS_DESC = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFS_AMOUNT = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFS_NOTE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFS_DETAIL = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        'GridView2
        '
        Me.GridView2.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colPLFSD_KEY, Me.colPLFSD_PLFSKEY, Me.colPLFSD_SOURCENO, Me.colPLFSD_PLFSDKEY, Me.colPLFSD_DESC, Me.colPLFSD_AMOUNT, Me.colPLFSD_NOTE})
        ...
        'colPLFSD_KEY
        '
        Me.colPLFSD_KEY.FieldName = "PLFSD_KEY"
        Me.colPLFSD_KEY.Name = "colPLFSD_KEY"
        '
        'colPLFSD_PLFSKEY
        '
        Me.colPLFSD_PLFSKEY.FieldName = "PLFSD_PLFSKEY"
        Me.colPLFSD_PLFSKEY.Name = "colPLFSD_PLFSKEY"
        '
        'colPLFSD_SOURCENO
        '
        Me.colPLFSD_SOURCENO.Caption = "Source No"
        Me.colPLFSD_SOURCENO.FieldName = "PLFSD_SOURCENO"
        Me.colPLFSD_SOURCENO.Name = "colPLFSD_SOURCENO"
        Me.colPLFSD_SOURCENO.OptionsColumn.ReadOnly = True
        Me.colPLFSD_SOURCENO.Width = 100
        '
        'colPLFSD_PLFSDKEY
        '
        Me.colPLFSD_PLFSDKEY.FieldName = "PLFSD_PLFSDKEY"
        Me.colPLFSD_PLFSDKEY.Name = "colPLFSD_PLFSDKEY"
        '
        'colPLFSD_DESC
        '
        Me.colPLFSD_DESC.Caption = "Description"
        Me.colPLFSD_DESC.FieldName = "PLFSD_DESC"
        Me.colPLFSD_DESC.Name = "colPLFSD_DESC"
        Me.colPLFSD_DESC.Visible = True
        Me.colPLFSD_DESC.VisibleIndex = 0
        Me.colPLFSD_DESC.Width = 300
        '
        'colPLFSD_AMOUNT
        '
        Me.colPLFSD_AMOUNT.Caption = "Amount"
        Me.colPLFSD_AMOUNT.ColumnEdit = Me.txtNumberic
        Me.colPLFSD_AMOUNT.FieldName = "PLFSD_AMOUNT"
        Me.colPLFSD_AMOUNT.Name = "colPLFSD_AMOUNT"
        Me.colPLFSD_AMOUNT.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "PLFSD_AMOUNT", "SUM={0:0.##}")})
        Me.colPLFSD_AMOUNT.Visible = True
        Me.colPLFSD_AMOUNT.VisibleIndex = 1
        Me.colPLFSD_AMOUNT.Width = 120
        '
        'txtNumberic
        '
        ...
        'colPLFSD_NOTE
        '
        Me.colPLFSD_NOTE.Caption = "Remarks"
        Me.colPLFSD_NOTE.ColumnEdit = Me.txtNote
        Me.colPLFSD_NOTE.FieldName = "PLFSD_NOTE"
        Me.colPLFSD_NOTE.Name = "colPLFSD_NOTE"
        Me.colPLFSD_NOTE.OptionsEditForm.RowSpan = 5
        Me.colPLFSD_NOTE.Visible = True
        Me.colPLFSD_NOTE.VisibleIndex = 2
        Me.colPLFSD_NOTE.Width = 300
        '
        'txtNote
        '
        ...
        'GridView1
        '
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colPLFS_KEY, Me.colPLFS_PLFSKEY, Me.colPLFS_SOURCENO, Me.colPLFS_DESC, Me.colPLFS_AMOUNT, Me.colPLFS_NOTE, Me.colPLFS_DETAIL})
        ...
        'colPLFS_KEY
        '
        Me.colPLFS_KEY.FieldName = "PLFS_KEY"
        Me.colPLFS_KEY.Name = "colPLFS_KEY"
        '
        'colPLFS_PLFSKEY
        '
        Me.colPLFS_PLFSKEY.FieldName = "PLFS_PLFSKEY"
        Me.colPLFS_PLFSKEY.Name = "colPLFS_PLFSKEY"
        '
        'colPLFS_SOURCENO
        '
        Me.colPLFS_SOURCENO.Caption = "Source No"
        Me.colPLFS_SOURCENO.ColumnEdit = Me.cboSourceNo
        Me.colPLFS_SOURCENO.FieldName = "PLFS_SOURCENO"
        Me.colPLFS_SOURCENO.Name = "colPLFS_SOURCENO"
        Me.colPLFS_SOURCENO.Visible = True
        Me.colPLFS_SOURCENO.VisibleIndex = 0
        Me.colPLFS_SOURCENO.Width = 80
        '
        'cboSourceNo
        '
        ...
        'colPLFS_DESC
        '
        Me.colPLFS_DESC.Caption = "Description"
        Me.colPLFS_DESC.FieldName = "PLFS_DESC"
        Me.colPLFS_DESC.Name = "colPLFS_DESC"
        Me.colPLFS_DESC.Visible = True
        Me.colPLFS_DESC.VisibleIndex = 1
        Me.colPLFS_DESC.Width = 300
        '
        'colPLFS_AMOUNT
        '
        Me.colPLFS_AMOUNT.Caption = "Amount"
        ...
        'colPLFS_NOTE
        '
        Me.colPLFS_NOTE.Caption = "Remarks"
    ...
    Friend WithEvents colPLFSD_KEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFSD_PLFSKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFSD_SOURCENO As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFSD_PLFSDKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFSD_DESC As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFSD_AMOUNT As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents txtNumberic As DevExpress.XtraEditors.Repository.RepositoryItemTextEdit
    Friend WithEvents colPLFSD_NOTE As DevExpress.XtraGrid.Columns.GridColumn
