...
Public Class ucPNL_p2UnreaGainForeEx
    ...
    Public Const MainTable As String = "INCOME_NTUREALFET" 'PLFST_SALES
    Public Const MainTable_Details As String = "INCOME_NTUREALFET_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "NTIUT_NTIUTKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "NTIUTD_NTIUTKEY" 'PLFSD_PLFSKEY
    ...
    Public Sub LoadData(Optional ByRef Errorlog As ClsError = Nothing)
        Try
            ...
            INCOMENTUREALFETBindingSource.DataSource = DsPNL1.Tables(MainTable)
