...
Partial Class ucPNL_p2ForeignCurrExGain
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ucPNL_p2ForeignCurrExGain))
        ...
        Me.colIRFETD_KEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colIRFETD_IRFETKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colIRFETD_IRFETDKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colIRFETD_DESC = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colIRFETD_AMOUNT = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.txtNumberic = New DevExpress.XtraEditors.Repository.RepositoryItemTextEdit()
        Me.colIRFETD_NOTE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.txtNote = New DevExpress.XtraEditors.Repository.RepositoryItemMemoEdit()
        Me.colIRFETD_SOURCENO = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.GridControl1 = New DevExpress.XtraGrid.GridControl()
        Me.INCOMEREALFETBindingSource = New System.Windows.Forms.BindingSource(Me.components)
        Me.DsPNL1 = New EasyTemplate_Taxcom.dsPNL()
        Me.GridView1 = New DevExpress.XtraGrid.Views.Grid.GridView()
        Me.colIRFET_KEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colIRFET_IRFETKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colIRFET_SOURCENO = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.colIRFET_DESC = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colIRFET_AMOUNT = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colIRFET_NOTE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colIRFET_DETAIL = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        CType(Me.INCOMEREALFETBindingSource, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        'GridView2
        '
        Me.GridView2.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colIRFETD_KEY, Me.colIRFETD_IRFETKEY, Me.colIRFETD_IRFETDKEY, Me.colIRFETD_DESC, Me.colIRFETD_AMOUNT, Me.colIRFETD_NOTE, Me.colIRFETD_SOURCENO})
        ...
        'colIRFETD_KEY
        '
        Me.colIRFETD_KEY.FieldName = "IRFETD_KEY"
        Me.colIRFETD_KEY.Name = "colIRFETD_KEY"
        '
        'colIRFETD_IRFETKEY
        '
        Me.colIRFETD_IRFETKEY.FieldName = "IRFETD_IRFETKEY"
        Me.colIRFETD_IRFETKEY.Name = "colIRFETD_IRFETKEY"
        '
        'colIRFETD_IRFETDKEY
        '
        Me.colIRFETD_IRFETDKEY.FieldName = "IRFETD_IRFETDKEY"
        Me.colIRFETD_IRFETDKEY.Name = "colIRFETD_IRFETDKEY"
        '
        'colIRFETD_DESC
        '
        Me.colIRFETD_DESC.Caption = "Description"
        Me.colIRFETD_DESC.FieldName = "IRFETD_DESC"
        Me.colIRFETD_DESC.Name = "colIRFETD_DESC"
        Me.colIRFETD_DESC.Visible = True
        Me.colIRFETD_DESC.VisibleIndex = 0
        Me.colIRFETD_DESC.Width = 300
        '
        'colIRFETD_AMOUNT
        '
        Me.colIRFETD_AMOUNT.Caption = "Amount"
        Me.colIRFETD_AMOUNT.ColumnEdit = Me.txtNumberic
        Me.colIRFETD_AMOUNT.FieldName = "IRFETD_AMOUNT"
        Me.colIRFETD_AMOUNT.Name = "colIRFETD_AMOUNT"
        Me.colIRFETD_AMOUNT.Visible = True
        Me.colIRFETD_AMOUNT.VisibleIndex = 1
        Me.colIRFETD_AMOUNT.Width = 120
        '
        'txtNumberic
        '
        ...
        'colIRFETD_NOTE
        '
        Me.colIRFETD_NOTE.Caption = "Remarks"
        Me.colIRFETD_NOTE.ColumnEdit = Me.txtNote
        Me.colIRFETD_NOTE.FieldName = "IRFETD_NOTE"
        Me.colIRFETD_NOTE.Name = "colIRFETD_NOTE"
        Me.colIRFETD_NOTE.Visible = True
        Me.colIRFETD_NOTE.VisibleIndex = 2
        Me.colIRFETD_NOTE.Width = 300
        '
        'txtNote
        '
        ...
        'colIRFETD_SOURCENO
        '
        Me.colIRFETD_SOURCENO.FieldName = "IRFETD_SOURCENO"
        Me.colIRFETD_SOURCENO.Name = "colIRFETD_SOURCENO"
        '
        'GridControl1
        '
        Me.GridControl1.DataSource = Me.INCOMEREALFETBindingSource
        Me.GridControl1.Dock = System.Windows.Forms.DockStyle.Fill
        Me.GridControl1.EmbeddedNavigator.Margin = New System.Windows.Forms.Padding(3, 4, 3, 4)
        GridLevelNode1.LevelTemplate = Me.GridView2
        GridLevelNode1.RelationName = "FK_INCOME_REALFET_INCOME_REALFET_DETAIL"
        ...
        Me.GridControl1.Size = New System.Drawing.Size(1077, 474)
        Me.GridControl1.TabIndex = 0
        Me.GridControl1.UseEmbeddedNavigator = True
        Me.GridControl1.ViewCollection.AddRange(New DevExpress.XtraGrid.Views.Base.BaseView() {Me.GridView1, Me.GridView2})
        '
        'INCOMEREALFETBindingSource
        '
        Me.INCOMEREALFETBindingSource.DataMember = "INCOME_REALFET"
        Me.INCOMEREALFETBindingSource.DataSource = Me.DsPNL1
        '
        'DsPNL1
        '
        ...
        'GridView1
        '
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colIRFET_KEY, Me.colIRFET_IRFETKEY, Me.colIRFET_SOURCENO, Me.colIRFET_DESC, Me.colIRFET_AMOUNT, Me.colIRFET_NOTE, Me.colIRFET_DETAIL})
        ...
        'colIRFET_KEY
        '
        Me.colIRFET_KEY.FieldName = "IRFET_KEY"
        Me.colIRFET_KEY.Name = "colIRFET_KEY"
        '
        'colIRFET_IRFETKEY
        '
        Me.colIRFET_IRFETKEY.FieldName = "IRFET_IRFETKEY"
        Me.colIRFET_IRFETKEY.Name = "colIRFET_IRFETKEY"
        '
        'colIRFET_SOURCENO
        '
        Me.colIRFET_SOURCENO.Caption = "Source No"
        Me.colIRFET_SOURCENO.ColumnEdit = Me.cboSourceNo
        Me.colIRFET_SOURCENO.FieldName = "IRFET_SOURCENO"
        Me.colIRFET_SOURCENO.Name = "colIRFET_SOURCENO"
        Me.colIRFET_SOURCENO.Visible = True
        Me.colIRFET_SOURCENO.VisibleIndex = 0
        Me.colIRFET_SOURCENO.Width = 80
        '
        'cboSourceNo
        '
        ...
        'colIRFET_DESC
        '
        Me.colIRFET_DESC.Caption = "Description"
        Me.colIRFET_DESC.FieldName = "IRFET_DESC"
        Me.colIRFET_DESC.Name = "colIRFET_DESC"
        Me.colIRFET_DESC.Visible = True
        Me.colIRFET_DESC.VisibleIndex = 1
        Me.colIRFET_DESC.Width = 300
        '
        'colIRFET_AMOUNT
        '
        Me.colIRFET_AMOUNT.Caption = "Amount"
        Me.colIRFET_AMOUNT.ColumnEdit = Me.txtNumberic
        Me.colIRFET_AMOUNT.FieldName = "IRFET_AMOUNT"
        Me.colIRFET_AMOUNT.Name = "colIRFET_AMOUNT"
        Me.colIRFET_AMOUNT.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "IRFET_AMOUNT", "SUM={0:0.##}")})
        Me.colIRFET_AMOUNT.Visible = True
        Me.colIRFET_AMOUNT.VisibleIndex = 2
        Me.colIRFET_AMOUNT.Width = 150
        '
        'colIRFET_NOTE
        '
        Me.colIRFET_NOTE.Caption = "Remarks"
        Me.colIRFET_NOTE.ColumnEdit = Me.txtNote
        Me.colIRFET_NOTE.FieldName = "IRFET_NOTE"
        Me.colIRFET_NOTE.Name = "colIRFET_NOTE"
        Me.colIRFET_NOTE.Visible = True
        Me.colIRFET_NOTE.VisibleIndex = 3
        Me.colIRFET_NOTE.Width = 300
        '
        'colIRFET_DETAIL
        '
        Me.colIRFET_DETAIL.Caption = "Details"
        Me.colIRFET_DETAIL.FieldName = "IRFET_DETAIL"
        Me.colIRFET_DETAIL.Name = "colIRFET_DETAIL"
        Me.colIRFET_DETAIL.OptionsColumn.ReadOnly = True
        Me.colIRFET_DETAIL.OptionsColumn.TabStop = False
        Me.colIRFET_DETAIL.Visible = True
        Me.colIRFET_DETAIL.VisibleIndex = 4
        Me.colIRFET_DETAIL.Width = 150
        '
        'BarManager1
        '
    ...
    " continues with select delete row(s)."
        ...
        Me.barDockControlTop.Size = New System.Drawing.Size(1077, 39)
        '
        ...
        Me.barDockControlRight.Location = New System.Drawing.Point(1077, 39)
        ...
        Me.Name = "ucPNL_p2ForeignCurrExGain"
        Me.Size = New System.Drawing.Size(1077, 513)
        CType(Me.GridView2, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.txtNumberic, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.txtNote, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.GridControl1, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.INCOMEREALFETBindingSource, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents colIRFETD_KEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colIRFETD_IRFETKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colIRFETD_IRFETDKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colIRFETD_DESC As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colIRFETD_AMOUNT As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colIRFETD_NOTE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colIRFETD_SOURCENO As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents INCOMEREALFETBindingSource As System.Windows.Forms.BindingSource
    Friend WithEvents colIRFET_KEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colIRFET_IRFETKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colIRFET_SOURCENO As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colIRFET_DESC As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colIRFET_AMOUNT As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colIRFET_NOTE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colIRFET_DETAIL As DevExpress.XtraGrid.Columns.GridColumn
