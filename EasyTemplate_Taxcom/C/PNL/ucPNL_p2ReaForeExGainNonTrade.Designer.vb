...
Partial Class ucPNL_p2ReaForeExGainNonTrade
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ucPNL_p2ReaForeExGainNonTrade))
        ...
        Me.colNTIRFECTD_KEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNTIRFECTD_NTIRFECTKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNTIRFECTD_NTIRFECTDKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNTIRFECTD_DESC = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNTIRFECTD_AMOUNT = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.txtNumberic = New DevExpress.XtraEditors.Repository.RepositoryItemTextEdit()
        Me.colNTIRFECTD_NOTE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.txtNote = New DevExpress.XtraEditors.Repository.RepositoryItemMemoEdit()
        Me.colNTIRFECTD_SOURCENO = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.GridControl1 = New DevExpress.XtraGrid.GridControl()
        Me.INCOMENTREALFEBindingSource = New System.Windows.Forms.BindingSource(Me.components)
        Me.DsPNL1 = New EasyTemplate_Taxcom.dsPNL()
        Me.GridView1 = New DevExpress.XtraGrid.Views.Grid.GridView()
        Me.colNTIRFECT_KEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNTIRFECT_NTIRFECTKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNTIRFECT_SOURCENO = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.colNTIRFECT_DESC = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNTIRFECT_AMOUNT = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNTIRFECT_NOTE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNTIRFECT_DETAIL = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        CType(Me.INCOMENTREALFEBindingSource, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        'GridView2
        '
        Me.GridView2.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colNTIRFECTD_KEY, Me.colNTIRFECTD_NTIRFECTKEY, Me.colNTIRFECTD_NTIRFECTDKEY, Me.colNTIRFECTD_DESC, Me.colNTIRFECTD_AMOUNT, Me.colNTIRFECTD_NOTE, Me.colNTIRFECTD_SOURCENO})
        ...
        'colNTIRFECTD_KEY
        '
        Me.colNTIRFECTD_KEY.FieldName = "NTIRFECTD_KEY"
        Me.colNTIRFECTD_KEY.Name = "colNTIRFECTD_KEY"
        '
        'colNTIRFECTD_NTIRFECTKEY
        '
        Me.colNTIRFECTD_NTIRFECTKEY.FieldName = "NTIRFECTD_NTIRFECTKEY"
        Me.colNTIRFECTD_NTIRFECTKEY.Name = "colNTIRFECTD_NTIRFECTKEY"
        '
        'colNTIRFECTD_NTIRFECTDKEY
        '
        Me.colNTIRFECTD_NTIRFECTDKEY.FieldName = "NTIRFECTD_NTIRFECTDKEY"
        Me.colNTIRFECTD_NTIRFECTDKEY.Name = "colNTIRFECTD_NTIRFECTDKEY"
        '
        'colNTIRFECTD_DESC
        '
        Me.colNTIRFECTD_DESC.Caption = "Description"
        Me.colNTIRFECTD_DESC.FieldName = "NTIRFECTD_DESC"
        Me.colNTIRFECTD_DESC.Name = "colNTIRFECTD_DESC"
        Me.colNTIRFECTD_DESC.Visible = True
        Me.colNTIRFECTD_DESC.VisibleIndex = 0
        Me.colNTIRFECTD_DESC.Width = 300
        '
        'colNTIRFECTD_AMOUNT
        '
        Me.colNTIRFECTD_AMOUNT.Caption = "Amount"
        Me.colNTIRFECTD_AMOUNT.ColumnEdit = Me.txtNumberic
        Me.colNTIRFECTD_AMOUNT.FieldName = "NTIRFECTD_AMOUNT"
        Me.colNTIRFECTD_AMOUNT.Name = "colNTIRFECTD_AMOUNT"
        Me.colNTIRFECTD_AMOUNT.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "NTIRFECTD_AMOUNT", "SUM={0:0.##}")})
        Me.colNTIRFECTD_AMOUNT.Visible = True
        Me.colNTIRFECTD_AMOUNT.VisibleIndex = 1
        Me.colNTIRFECTD_AMOUNT.Width = 120
        '
        'txtNumberic
        '
        ...
        'colNTIRFECTD_NOTE
        '
        Me.colNTIRFECTD_NOTE.Caption = "Remarks"
        Me.colNTIRFECTD_NOTE.ColumnEdit = Me.txtNote
        Me.colNTIRFECTD_NOTE.FieldName = "NTIRFECTD_NOTE"
        Me.colNTIRFECTD_NOTE.Name = "colNTIRFECTD_NOTE"
        Me.colNTIRFECTD_NOTE.Visible = True
        Me.colNTIRFECTD_NOTE.VisibleIndex = 2
        Me.colNTIRFECTD_NOTE.Width = 300
        '
        'txtNote
        '
        ...
        '
        'colNTIRFECTD_SOURCENO
        '
        Me.colNTIRFECTD_SOURCENO.FieldName = "NTIRFECTD_SOURCENO"
        Me.colNTIRFECTD_SOURCENO.Name = "colNTIRFECTD_SOURCENO"
        '
        'GridControl1
        '
        Me.GridControl1.DataSource = Me.INCOMENTREALFEBindingSource
        Me.GridControl1.Dock = System.Windows.Forms.DockStyle.Fill
        Me.GridControl1.EmbeddedNavigator.Margin = New System.Windows.Forms.Padding(3, 4, 3, 4)
        GridLevelNode1.LevelTemplate = Me.GridView2
        GridLevelNode1.RelationName = "FK_INCOME_NTREALFE_INCOME_NTREALFE_DETAIL"
        ...
        Me.GridControl1.Size = New System.Drawing.Size(1036, 474)
        Me.GridControl1.TabIndex = 0
        Me.GridControl1.UseEmbeddedNavigator = True
        Me.GridControl1.ViewCollection.AddRange(New DevExpress.XtraGrid.Views.Base.BaseView() {Me.GridView1, Me.GridView2})
        '
        'INCOMENTREALFEBindingSource
        '
        Me.INCOMENTREALFEBindingSource.DataMember = "INCOME_NTREALFE"
        Me.INCOMENTREALFEBindingSource.DataSource = Me.DsPNL1
        '
        'DsPNL1
        '
        ...
        'GridView1
        '
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colNTIRFECT_KEY, Me.colNTIRFECT_NTIRFECTKEY, Me.colNTIRFECT_SOURCENO, Me.colNTIRFECT_DESC, Me.colNTIRFECT_AMOUNT, Me.colNTIRFECT_NOTE, Me.colNTIRFECT_DETAIL})
        ...
        'colNTIRFECT_KEY
        '
        Me.colNTIRFECT_KEY.FieldName = "NTIRFECT_KEY"
        Me.colNTIRFECT_KEY.Name = "colNTIRFECT_KEY"
        '
        'colNTIRFECT_NTIRFECTKEY
        '
        Me.colNTIRFECT_NTIRFECTKEY.FieldName = "NTIRFECT_NTIRFECTKEY"
        Me.colNTIRFECT_NTIRFECTKEY.Name = "colNTIRFECT_NTIRFECTKEY"
        '
        'colNTIRFECT_SOURCENO
        '
        Me.colNTIRFECT_SOURCENO.Caption = "Source No"
        Me.colNTIRFECT_SOURCENO.ColumnEdit = Me.cboSourceNo
        Me.colNTIRFECT_SOURCENO.FieldName = "NTIRFECT_SOURCENO"
        Me.colNTIRFECT_SOURCENO.Name = "colNTIRFECT_SOURCENO"
        Me.colNTIRFECT_SOURCENO.Visible = True
        Me.colNTIRFECT_SOURCENO.VisibleIndex = 0
        Me.colNTIRFECT_SOURCENO.Width = 80
        '
        'cboSourceNo
        '
        ...
        'colNTIRFECT_DESC
        '
        Me.colNTIRFECT_DESC.Caption = "Description"
        Me.colNTIRFECT_DESC.FieldName = "NTIRFECT_DESC"
        Me.colNTIRFECT_DESC.Name = "colNTIRFECT_DESC"
        Me.colNTIRFECT_DESC.Visible = True
        Me.colNTIRFECT_DESC.VisibleIndex = 1
        Me.colNTIRFECT_DESC.Width = 300
        '
        'colNTIRFECT_AMOUNT
        '
        Me.colNTIRFECT_AMOUNT.Caption = "Amount"
        Me.colNTIRFECT_AMOUNT.ColumnEdit = Me.txtNumberic
        Me.colNTIRFECT_AMOUNT.FieldName = "NTIRFECT_AMOUNT"
        Me.colNTIRFECT_AMOUNT.Name = "colNTIRFECT_AMOUNT"
        Me.colNTIRFECT_AMOUNT.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "NTIRFECT_AMOUNT", "SUM={0:0.##}")})
        Me.colNTIRFECT_AMOUNT.Visible = True
        Me.colNTIRFECT_AMOUNT.VisibleIndex = 2
        Me.colNTIRFECT_AMOUNT.Width = 150
        '
        'colNTIRFECT_NOTE
        '
        Me.colNTIRFECT_NOTE.Caption = "Remarks"
        Me.colNTIRFECT_NOTE.ColumnEdit = Me.txtNote
        Me.colNTIRFECT_NOTE.FieldName = "NTIRFECT_NOTE"
        Me.colNTIRFECT_NOTE.Name = "colNTIRFECT_NOTE"
        Me.colNTIRFECT_NOTE.Visible = True
        Me.colNTIRFECT_NOTE.VisibleIndex = 3
        Me.colNTIRFECT_NOTE.Width = 300
        '
        'colNTIRFECT_DETAIL
        '
        Me.colNTIRFECT_DETAIL.Caption = "Details"
        Me.colNTIRFECT_DETAIL.FieldName = "NTIRFECT_DETAIL"
        Me.colNTIRFECT_DETAIL.Name = "colNTIRFECT_DETAIL"
        Me.colNTIRFECT_DETAIL.OptionsColumn.ReadOnly = True
        Me.colNTIRFECT_DETAIL.OptionsColumn.TabStop = False
        Me.colNTIRFECT_DETAIL.Visible = True
        Me.colNTIRFECT_DETAIL.VisibleIndex = 4
        Me.colNTIRFECT_DETAIL.Width = 150
        '
        'BarManager1
        '
    ...
    " continues with select delete row(s)."
        ...
        Me.barDockControlTop.Size = New System.Drawing.Size(1036, 39)
        '
        ...
        Me.barDockControlRight.Location = New System.Drawing.Point(1036, 39)
        ...
        Me.Name = "ucPNL_p2ReaForeExGainNonTrade"
        Me.Size = New System.Drawing.Size(1036, 513)
        CType(Me.GridView2, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.txtNumberic, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.txtNote, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.GridControl1, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.INCOMENTREALFEBindingSource, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents colNTIRFECTD_KEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNTIRFECTD_NTIRFECTKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNTIRFECTD_NTIRFECTDKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNTIRFECTD_DESC As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNTIRFECTD_AMOUNT As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNTIRFECTD_NOTE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNTIRFECTD_SOURCENO As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents INCOMENTREALFEBindingSource As System.Windows.Forms.BindingSource
    Friend WithEvents colNTIRFECT_KEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNTIRFECT_NTIRFECTKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNTIRFECT_SOURCENO As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNTIRFECT_DESC As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNTIRFECT_AMOUNT As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNTIRFECT_NOTE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNTIRFECT_DETAIL As DevExpress.XtraGrid.Columns.GridColumn
