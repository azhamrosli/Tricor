...
Partial Class ucPNL_p3InterestResPurS33_Yearly
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ucPNL_p3InterestResPurS33_Yearly))
        ...
        Me.REFINTERESTRESTRICDETAILBindingSource = New System.Windows.Forms.BindingSource(Me.components)
        Me.GridView1 = New DevExpress.XtraGrid.Views.Grid.GridView()
        Me.colRIRD_KEY1 = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colRIR_REF_NUM1 = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colRIRD_SOURCENO1 = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colRIRD_DESC1 = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colRIRD_MONTH1 = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colRIRD_TYPE1 = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.cboType = New DevExpress.XtraEditors.Repository.RepositoryItemComboBox()
        Me.colRIRD_AMOUNT1 = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.txtNumberic = New DevExpress.XtraEditors.Repository.RepositoryItemTextEdit()
        Me.colRIRD_TYPE_INCOME1 = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.cboTypeIncome = New DevExpress.XtraEditors.Repository.RepositoryItemComboBox()
        Me.colRIRD_NOTE1 = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        CType(Me.REFINTERESTRESTRICDETAILBindingSource, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        ToolTipItem1.Text = "Save new record Ctrl + R"
        ...
        '
        'REFINTERESTRESTRICDETAILBindingSource
        '
        Me.REFINTERESTRESTRICDETAILBindingSource.DataMember = "REF_INTEREST_RESTRIC_DETAIL"
        Me.REFINTERESTRESTRICDETAILBindingSource.DataSource = Me.DsPNL1
        '
        'GridView1
        '
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colRIRD_KEY1, Me.colRIR_REF_NUM1, Me.colRIRD_SOURCENO1, Me.colRIRD_DESC1, Me.colRIRD_MONTH1, Me.colRIRD_TYPE1, Me.colRIRD_AMOUNT1, Me.colRIRD_TYPE_INCOME1, Me.colRIRD_NOTE1})
        ...
        'colRIRD_KEY1
        '
        Me.colRIRD_KEY1.FieldName = "RIRD_KEY"
        Me.colRIRD_KEY1.Name = "colRIRD_KEY1"
        '
        'colRIR_REF_NUM1
        '
        Me.colRIR_REF_NUM1.FieldName = "RIR_REF_NUM"
        Me.colRIR_REF_NUM1.Name = "colRIR_REF_NUM1"
        '
        'colRIRD_SOURCENO1
        '
        Me.colRIRD_SOURCENO1.FieldName = "RIRD_SOURCENO"
        Me.colRIRD_SOURCENO1.Name = "colRIRD_SOURCENO1"
        '
        'colRIRD_DESC1
        '
        Me.colRIRD_DESC1.Caption = "Description"
        Me.colRIRD_DESC1.FieldName = "RIRD_DESC"
        Me.colRIRD_DESC1.Name = "colRIRD_DESC1"
        Me.colRIRD_DESC1.Visible = True
        Me.colRIRD_DESC1.VisibleIndex = 0
        Me.colRIRD_DESC1.Width = 300
        '
        'colRIRD_MONTH1
        '
        Me.colRIRD_MONTH1.FieldName = "RIRD_MONTH"
        Me.colRIRD_MONTH1.Name = "colRIRD_MONTH1"
        '
        'colRIRD_TYPE1
        '
        Me.colRIRD_TYPE1.Caption = "Type"
        Me.colRIRD_TYPE1.ColumnEdit = Me.cboType
        Me.colRIRD_TYPE1.FieldName = "RIRD_TYPE"
        Me.colRIRD_TYPE1.Name = "colRIRD_TYPE1"
        Me.colRIRD_TYPE1.Visible = True
        Me.colRIRD_TYPE1.VisibleIndex = 1
        Me.colRIRD_TYPE1.Width = 120
        '
        'cboType
        '
        ...
        'colRIRD_AMOUNT1
        '
        Me.colRIRD_AMOUNT1.Caption = "Amount"
        Me.colRIRD_AMOUNT1.ColumnEdit = Me.txtNumberic
        Me.colRIRD_AMOUNT1.FieldName = "RIRD_AMOUNT"
        Me.colRIRD_AMOUNT1.Name = "colRIRD_AMOUNT1"
        Me.colRIRD_AMOUNT1.Visible = True
        Me.colRIRD_AMOUNT1.VisibleIndex = 2
        Me.colRIRD_AMOUNT1.Width = 120
        '
        'txtNumberic
        '
        ...
        '
        'colRIRD_TYPE_INCOME1
        '
        Me.colRIRD_TYPE_INCOME1.Caption = "Type of Income"
        Me.colRIRD_TYPE_INCOME1.ColumnEdit = Me.cboTypeIncome
        Me.colRIRD_TYPE_INCOME1.FieldName = "RIRD_TYPE_INCOME"
        Me.colRIRD_TYPE_INCOME1.Name = "colRIRD_TYPE_INCOME1"
        Me.colRIRD_TYPE_INCOME1.Visible = True
        Me.colRIRD_TYPE_INCOME1.VisibleIndex = 3
        Me.colRIRD_TYPE_INCOME1.Width = 150
        '
        'cboTypeIncome
        '
        ...
        'colRIRD_NOTE1
        '
        Me.colRIRD_NOTE1.Caption = "Remarks"
        Me.colRIRD_NOTE1.ColumnEdit = Me.txtNote
        Me.colRIRD_NOTE1.FieldName = "RIRD_NOTE"
        Me.colRIRD_NOTE1.Name = "colRIRD_NOTE1"
        Me.colRIRD_NOTE1.Visible = True
        Me.colRIRD_NOTE1.VisibleIndex = 4
        Me.colRIRD_NOTE1.Width = 300
        '
        'txtNote
        '
        ...
        CType(Me.REFINTERESTRESTRICDETAILBindingSource, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents REFINTERESTRESTRICDETAILBindingSource As System.Windows.Forms.BindingSource
    Friend WithEvents colRIRD_KEY1 As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colRIR_REF_NUM1 As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colRIRD_SOURCENO1 As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colRIRD_DESC1 As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colRIRD_MONTH1 As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colRIRD_TYPE1 As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colRIRD_AMOUNT1 As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colRIRD_TYPE_INCOME1 As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colRIRD_NOTE1 As DevExpress.XtraGrid.Columns.GridColumn
