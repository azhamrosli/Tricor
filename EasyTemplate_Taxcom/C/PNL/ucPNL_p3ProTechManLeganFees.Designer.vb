...
Partial Class ucPNL_p3ProTechManLeganFees
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ucPNL_p3ProTechManLeganFees))
        ...
        Me.colEXLD_KEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXLD_EXLKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXLD_SOURCENO = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXLD_EXLDKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXLD_DESC = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXLD_AMOUNT = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.txtNumberic = New DevExpress.XtraEditors.Repository.RepositoryItemTextEdit()
        Me.colEXLD_NOTE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.txtNote = New DevExpress.XtraEditors.Repository.RepositoryItemMemoEdit()
        Me.colEXLD_DEDUCTIBLE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.chkBox = New DevExpress.XtraEditors.Repository.RepositoryItemCheckEdit()
        Me.colEXLD_DEDUCTIBLE_ADD = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.EXPENSESLEGALBindingSource = New System.Windows.Forms.BindingSource(Me.components)
        Me.DsPNL1 = New EasyTemplate_Taxcom.dsPNL()
        Me.GridView1 = New DevExpress.XtraGrid.Views.Grid.GridView()
        Me.colEXL_KEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXL_EXLKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXL_SOURCENO = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.colEXL_DESC = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXL_AMOUNT = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXL_NOTE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXL_DEDUCTIBLE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXL_DEDUCTIBLE_ADD = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXL_DETAIL = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        CType(Me.EXPENSESLEGALBindingSource, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        'GridView2
        '
        Me.GridView2.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colEXLD_KEY, Me.colEXLD_EXLKEY, Me.colEXLD_SOURCENO, Me.colEXLD_EXLDKEY, Me.colEXLD_DESC, Me.colEXLD_AMOUNT, Me.colEXLD_NOTE, Me.colEXLD_DEDUCTIBLE, Me.colEXLD_DEDUCTIBLE_ADD, Me.colRowIndex1, Me.colPecentageAmount1})
        ...
        'colEXLD_KEY
        '
        Me.colEXLD_KEY.FieldName = "EXLD_KEY"
        Me.colEXLD_KEY.Name = "colEXLD_KEY"
        '
        'colEXLD_EXLKEY
        '
        Me.colEXLD_EXLKEY.FieldName = "EXLD_EXLKEY"
        Me.colEXLD_EXLKEY.Name = "colEXLD_EXLKEY"
        '
        'colEXLD_SOURCENO
        '
        Me.colEXLD_SOURCENO.FieldName = "EXLD_SOURCENO"
        Me.colEXLD_SOURCENO.Name = "colEXLD_SOURCENO"
        '
        'colEXLD_EXLDKEY
        '
        Me.colEXLD_EXLDKEY.FieldName = "EXLD_EXLDKEY"
        Me.colEXLD_EXLDKEY.Name = "colEXLD_EXLDKEY"
        '
        'colEXLD_DESC
        '
        Me.colEXLD_DESC.Caption = "Description"
        Me.colEXLD_DESC.FieldName = "EXLD_DESC"
        Me.colEXLD_DESC.Name = "colEXLD_DESC"
        Me.colEXLD_DESC.Visible = True
        Me.colEXLD_DESC.VisibleIndex = 0
        Me.colEXLD_DESC.Width = 300
        '
        'colEXLD_AMOUNT
        '
        Me.colEXLD_AMOUNT.Caption = "Amount"
        Me.colEXLD_AMOUNT.ColumnEdit = Me.txtNumberic
        Me.colEXLD_AMOUNT.FieldName = "EXLD_AMOUNT"
        Me.colEXLD_AMOUNT.Name = "colEXLD_AMOUNT"
        Me.colEXLD_AMOUNT.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "EXLD_AMOUNT", "SUM={0:0.##}")})
        Me.colEXLD_AMOUNT.Visible = True
        Me.colEXLD_AMOUNT.VisibleIndex = 1
        Me.colEXLD_AMOUNT.Width = 120
        '
        'txtNumberic
        '
        ...
        'colEXLD_NOTE
        '
        Me.colEXLD_NOTE.Caption = "Remarks"
        Me.colEXLD_NOTE.ColumnEdit = Me.txtNote
        Me.colEXLD_NOTE.FieldName = "EXLD_NOTE"
        Me.colEXLD_NOTE.Name = "colEXLD_NOTE"
        Me.colEXLD_NOTE.Visible = True
        Me.colEXLD_NOTE.VisibleIndex = 2
        Me.colEXLD_NOTE.Width = 300
        '
        'txtNote
        '
        ...
        'colEXLD_DEDUCTIBLE
        '
        Me.colEXLD_DEDUCTIBLE.Caption = "Add Back"
        Me.colEXLD_DEDUCTIBLE.ColumnEdit = Me.chkBox
        Me.colEXLD_DEDUCTIBLE.FieldName = "EXLD_DEDUCTIBLE"
        Me.colEXLD_DEDUCTIBLE.Name = "colEXLD_DEDUCTIBLE"
        Me.colEXLD_DEDUCTIBLE.Visible = True
        Me.colEXLD_DEDUCTIBLE.VisibleIndex = 3
        Me.colEXLD_DEDUCTIBLE.Width = 100
        '
        'chkBox
        '
        ...
        '
        'colEXLD_DEDUCTIBLE_ADD
        '
        Me.colEXLD_DEDUCTIBLE_ADD.Caption = "Deduct"
        Me.colEXLD_DEDUCTIBLE_ADD.ColumnEdit = Me.chkBox
        Me.colEXLD_DEDUCTIBLE_ADD.FieldName = "EXLD_DEDUCTIBLE_ADD"
        Me.colEXLD_DEDUCTIBLE_ADD.Name = "colEXLD_DEDUCTIBLE_ADD"
        Me.colEXLD_DEDUCTIBLE_ADD.Visible = True
        Me.colEXLD_DEDUCTIBLE_ADD.VisibleIndex = 4
        Me.colEXLD_DEDUCTIBLE_ADD.Width = 100
        '
        'colRowIndex1
        '
        ...
        'GridControl1
        '
        Me.GridControl1.DataSource = Me.EXPENSESLEGALBindingSource
        Me.GridControl1.Dock = System.Windows.Forms.DockStyle.Fill
        GridLevelNode1.LevelTemplate = Me.GridView2
        GridLevelNode1.RelationName = "FK_EXPENSES_LEGAL_EXPENSES_LEGAL_DETAIL"
        ...
        Me.GridControl1.Size = New System.Drawing.Size(1001, 386)
        Me.GridControl1.TabIndex = 0
        Me.GridControl1.UseEmbeddedNavigator = True
        Me.GridControl1.ViewCollection.AddRange(New DevExpress.XtraGrid.Views.Base.BaseView() {Me.GridView1, Me.GridView2})
        '
        'EXPENSESLEGALBindingSource
        '
        Me.EXPENSESLEGALBindingSource.DataMember = "EXPENSES_LEGAL"
        Me.EXPENSESLEGALBindingSource.DataSource = Me.DsPNL1
        '
        'DsPNL1
        '
        ...
        'GridView1
        '
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colEXL_KEY, Me.colEXL_EXLKEY, Me.colEXL_SOURCENO, Me.colEXL_DESC, Me.colEXL_AMOUNT, Me.colEXL_NOTE, Me.colEXL_DEDUCTIBLE, Me.colEXL_DEDUCTIBLE_ADD, Me.colEXL_DETAIL, Me.colRowIndex, Me.colPecentageAmount})
        ...
        'colEXL_KEY
        '
        Me.colEXL_KEY.FieldName = "EXL_KEY"
        Me.colEXL_KEY.Name = "colEXL_KEY"
        '
        'colEXL_EXLKEY
        '
        Me.colEXL_EXLKEY.FieldName = "EXL_EXLKEY"
        Me.colEXL_EXLKEY.Name = "colEXL_EXLKEY"
        '
        'colEXL_SOURCENO
        '
        Me.colEXL_SOURCENO.Caption = "Source No"
        Me.colEXL_SOURCENO.ColumnEdit = Me.cboSourceNo
        Me.colEXL_SOURCENO.FieldName = "EXL_SOURCENO"
        Me.colEXL_SOURCENO.Name = "colEXL_SOURCENO"
        Me.colEXL_SOURCENO.Visible = True
        Me.colEXL_SOURCENO.VisibleIndex = 0
        Me.colEXL_SOURCENO.Width = 80
        '
        'cboSourceNo
        '
        ...
        'colEXL_DESC
        '
        Me.colEXL_DESC.Caption = "Description"
        Me.colEXL_DESC.FieldName = "EXL_DESC"
        Me.colEXL_DESC.Name = "colEXL_DESC"
        Me.colEXL_DESC.Visible = True
        Me.colEXL_DESC.VisibleIndex = 1
        Me.colEXL_DESC.Width = 300
        '
        'colEXL_AMOUNT
        '
        Me.colEXL_AMOUNT.Caption = "Amount"
        Me.colEXL_AMOUNT.ColumnEdit = Me.txtNumberic
        Me.colEXL_AMOUNT.FieldName = "EXL_AMOUNT"
        Me.colEXL_AMOUNT.Name = "colEXL_AMOUNT"
        Me.colEXL_AMOUNT.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "EXL_AMOUNT", "SUM={0:0.##}")})
        Me.colEXL_AMOUNT.Visible = True
        Me.colEXL_AMOUNT.VisibleIndex = 2
        Me.colEXL_AMOUNT.Width = 120
        '
        'colEXL_NOTE
        '
        Me.colEXL_NOTE.Caption = "Remarks"
        Me.colEXL_NOTE.ColumnEdit = Me.txtNote
        Me.colEXL_NOTE.FieldName = "EXL_NOTE"
        Me.colEXL_NOTE.Name = "colEXL_NOTE"
        Me.colEXL_NOTE.Visible = True
        Me.colEXL_NOTE.VisibleIndex = 3
        Me.colEXL_NOTE.Width = 300
        '
        'colEXL_DEDUCTIBLE
        '
        Me.colEXL_DEDUCTIBLE.Caption = "Add Back"
        Me.colEXL_DEDUCTIBLE.ColumnEdit = Me.chkBox
        Me.colEXL_DEDUCTIBLE.FieldName = "EXL_DEDUCTIBLE"
        Me.colEXL_DEDUCTIBLE.Name = "colEXL_DEDUCTIBLE"
        Me.colEXL_DEDUCTIBLE.Visible = True
        Me.colEXL_DEDUCTIBLE.VisibleIndex = 4
        Me.colEXL_DEDUCTIBLE.Width = 100
        '
        'colEXL_DEDUCTIBLE_ADD
        '
        Me.colEXL_DEDUCTIBLE_ADD.Caption = "Deduct"
        Me.colEXL_DEDUCTIBLE_ADD.ColumnEdit = Me.chkBox
        Me.colEXL_DEDUCTIBLE_ADD.FieldName = "EXL_DEDUCTIBLE_ADD"
        Me.colEXL_DEDUCTIBLE_ADD.Name = "colEXL_DEDUCTIBLE_ADD"
        Me.colEXL_DEDUCTIBLE_ADD.Visible = True
        Me.colEXL_DEDUCTIBLE_ADD.VisibleIndex = 5
        Me.colEXL_DEDUCTIBLE_ADD.Width = 100
        '
        'colEXL_DETAIL
        '
        Me.colEXL_DETAIL.Caption = "Details"
        Me.colEXL_DETAIL.FieldName = "EXL_DETAIL"
        Me.colEXL_DETAIL.Name = "colEXL_DETAIL"
        Me.colEXL_DETAIL.OptionsColumn.ReadOnly = True
        Me.colEXL_DETAIL.OptionsColumn.TabStop = False
        Me.colEXL_DETAIL.Visible = True
        Me.colEXL_DETAIL.VisibleIndex = 6
        Me.colEXL_DETAIL.Width = 100
        '
        'colRowIndex
        '
    ...
    " continues with select detail row(s)."
        ...
        Me.barDockControlTop.Size = New System.Drawing.Size(1001, 31)
        '
        ...
        Me.barDockControlRight.Location = New System.Drawing.Point(1001, 31)
        ...
        Me.Name = "ucPNL_p3ProTechManLeganFees"
        Me.Size = New System.Drawing.Size(1001, 417)
        ...
        CType(Me.EXPENSESLEGALBindingSource, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents EXPENSESLEGALBindingSource As System.Windows.Forms.BindingSource
    Friend WithEvents colEXLD_KEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXLD_EXLKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXLD_SOURCENO As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXLD_EXLDKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXLD_DESC As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXLD_AMOUNT As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXLD_NOTE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXLD_DEDUCTIBLE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXLD_DEDUCTIBLE_ADD As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colRowIndex1 As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXL_KEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXL_EXLKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXL_SOURCENO As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXL_DESC As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXL_AMOUNT As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXL_NOTE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXL_DEDUCTIBLE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXL_DEDUCTIBLE_ADD As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXL_DETAIL As DevExpress.XtraGrid.Columns.GridColumn
