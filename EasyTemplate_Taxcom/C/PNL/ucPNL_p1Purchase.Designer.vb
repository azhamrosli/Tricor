...
Partial Class ucPNL_p1Purchase
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ucPNL_p1Purchase))
        ...
        Me.colPLFPURD_KEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFPURD_PLFPURKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFPURD_SOURCENO = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFPURD_PLFPURDKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFPURD_DESC = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFPURD_AMOUNT = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.txtNumberic = New DevExpress.XtraEditors.Repository.RepositoryItemTextEdit()
        Me.colPLFPURD_NOTE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.txtNote = New DevExpress.XtraEditors.Repository.RepositoryItemMemoEdit()
        Me.colPLFPURD_DEDUCTIBLE = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.PLFSTPURCHASEBindingSource = New System.Windows.Forms.BindingSource(Me.components)
        Me.DsPNL1 = New EasyTemplate_Taxcom.dsPNL()
        Me.GridView1 = New DevExpress.XtraGrid.Views.Grid.GridView()
        Me.colPLFPUR_KEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFPUR_PLFPURKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFPUR_SOURCENO = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.colPLFPUR_DESC = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFPUR_AMOUNT = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFPUR_NOTE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFPUR_DETAIL = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFPUR_DEDUCTIBLE = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        CType(Me.PLFSTPURCHASEBindingSource, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        'GridView2
        '
        Me.GridView2.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colPLFPURD_KEY, Me.colPLFPURD_PLFPURKEY, Me.colPLFPURD_SOURCENO, Me.colPLFPURD_PLFPURDKEY, Me.colPLFPURD_DESC, Me.colPLFPURD_AMOUNT, Me.colPLFPURD_NOTE, Me.colPLFPURD_DEDUCTIBLE, Me.colPecentageAmount1})
        ...
        'colPLFPURD_KEY
        '
        Me.colPLFPURD_KEY.FieldName = "PLFPURD_KEY"
        Me.colPLFPURD_KEY.Name = "colPLFPURD_KEY"
        '
        'colPLFPURD_PLFPURKEY
        '
        Me.colPLFPURD_PLFPURKEY.FieldName = "PLFPURD_PLFPURKEY"
        Me.colPLFPURD_PLFPURKEY.Name = "colPLFPURD_PLFPURKEY"
        '
        'colPLFPURD_SOURCENO
        '
        Me.colPLFPURD_SOURCENO.FieldName = "PLFPURD_SOURCENO"
        Me.colPLFPURD_SOURCENO.Name = "colPLFPURD_SOURCENO"
        '
        'colPLFPURD_PLFPURDKEY
        '
        Me.colPLFPURD_PLFPURDKEY.FieldName = "PLFPURD_PLFPURDKEY"
        Me.colPLFPURD_PLFPURDKEY.Name = "colPLFPURD_PLFPURDKEY"
        '
        'colPLFPURD_DESC
        '
        Me.colPLFPURD_DESC.Caption = "Description"
        Me.colPLFPURD_DESC.FieldName = "PLFPURD_DESC"
        Me.colPLFPURD_DESC.Name = "colPLFPURD_DESC"
        Me.colPLFPURD_DESC.Visible = True
        Me.colPLFPURD_DESC.VisibleIndex = 0
        Me.colPLFPURD_DESC.Width = 300
        '
        'colPLFPURD_AMOUNT
        '
        Me.colPLFPURD_AMOUNT.Caption = "Amount"
        Me.colPLFPURD_AMOUNT.ColumnEdit = Me.txtNumberic
        Me.colPLFPURD_AMOUNT.FieldName = "PLFPURD_AMOUNT"
        Me.colPLFPURD_AMOUNT.Name = "colPLFPURD_AMOUNT"
        Me.colPLFPURD_AMOUNT.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "PLFPURD_AMOUNT", "SUM={0:0.##}")})
        Me.colPLFPURD_AMOUNT.Visible = True
        Me.colPLFPURD_AMOUNT.VisibleIndex = 1
        Me.colPLFPURD_AMOUNT.Width = 150
        '
        'txtNumberic
        '
        ...
        'colPLFPURD_NOTE
        '
        Me.colPLFPURD_NOTE.Caption = "Remarks"
        Me.colPLFPURD_NOTE.ColumnEdit = Me.txtNote
        Me.colPLFPURD_NOTE.FieldName = "PLFPURD_NOTE"
        Me.colPLFPURD_NOTE.Name = "colPLFPURD_NOTE"
        Me.colPLFPURD_NOTE.Visible = True
        Me.colPLFPURD_NOTE.VisibleIndex = 3
        Me.colPLFPURD_NOTE.Width = 300
        '
        'txtNote
        '
        ...
        '
        'colPLFPURD_DEDUCTIBLE
        '
        Me.colPLFPURD_DEDUCTIBLE.Caption = "Deductible"
        Me.colPLFPURD_DEDUCTIBLE.ColumnEdit = Me.chkBox
        Me.colPLFPURD_DEDUCTIBLE.FieldName = "PLFPURD_DEDUCTIBLE"
        Me.colPLFPURD_DEDUCTIBLE.Name = "colPLFPURD_DEDUCTIBLE"
        Me.colPLFPURD_DEDUCTIBLE.Visible = True
        Me.colPLFPURD_DEDUCTIBLE.VisibleIndex = 2
        Me.colPLFPURD_DEDUCTIBLE.Width = 150
        '
        'chkBox
        '
        ...
        'GridControl1
        '
        Me.GridControl1.DataSource = Me.PLFSTPURCHASEBindingSource
        Me.GridControl1.Dock = System.Windows.Forms.DockStyle.Fill
        Me.GridControl1.EmbeddedNavigator.Margin = New System.Windows.Forms.Padding(3, 4, 3, 4)
        GridLevelNode1.LevelTemplate = Me.GridView2
        GridLevelNode1.RelationName = "FK_PLFST_PURCHASE_PLFST_PURCHASE_DETAIL"
        ...
        Me.GridControl1.Size = New System.Drawing.Size(1233, 474)
        Me.GridControl1.TabIndex = 0
        Me.GridControl1.UseEmbeddedNavigator = True
        Me.GridControl1.ViewCollection.AddRange(New DevExpress.XtraGrid.Views.Base.BaseView() {Me.GridView1, Me.GridView2})
        '
        'PLFSTPURCHASEBindingSource
        '
        Me.PLFSTPURCHASEBindingSource.DataMember = "PLFST_PURCHASE"
        Me.PLFSTPURCHASEBindingSource.DataSource = Me.DsPNL1
        '
        'DsPNL1
        '
        ...
        'GridView1
        '
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colPLFPUR_KEY, Me.colPLFPUR_PLFPURKEY, Me.colPLFPUR_SOURCENO, Me.colPLFPUR_DESC, Me.colPLFPUR_AMOUNT, Me.colPLFPUR_NOTE, Me.colPLFPUR_DETAIL, Me.colPLFPUR_DEDUCTIBLE, Me.colPecentageAmount})
        ...
        'colPLFPUR_KEY
        '
        Me.colPLFPUR_KEY.FieldName = "PLFPUR_KEY"
        Me.colPLFPUR_KEY.Name = "colPLFPUR_KEY"
        '
        'colPLFPUR_PLFPURKEY
        '
        Me.colPLFPUR_PLFPURKEY.FieldName = "PLFPUR_PLFPURKEY"
        Me.colPLFPUR_PLFPURKEY.Name = "colPLFPUR_PLFPURKEY"
        '
        'colPLFPUR_SOURCENO
        '
        Me.colPLFPUR_SOURCENO.Caption = "Source No"
        Me.colPLFPUR_SOURCENO.ColumnEdit = Me.cboSourceNo
        Me.colPLFPUR_SOURCENO.FieldName = "PLFPUR_SOURCENO"
        Me.colPLFPUR_SOURCENO.Name = "colPLFPUR_SOURCENO"
        Me.colPLFPUR_SOURCENO.Visible = True
        Me.colPLFPUR_SOURCENO.VisibleIndex = 0
        Me.colPLFPUR_SOURCENO.Width = 80
        '
        'cboSourceNo
        '
        ...
        'colPLFPUR_DESC
        '
        Me.colPLFPUR_DESC.Caption = "Description"
        Me.colPLFPUR_DESC.FieldName = "PLFPUR_DESC"
        Me.colPLFPUR_DESC.Name = "colPLFPUR_DESC"
        Me.colPLFPUR_DESC.Visible = True
        Me.colPLFPUR_DESC.VisibleIndex = 1
        Me.colPLFPUR_DESC.Width = 300
        '
        'colPLFPUR_AMOUNT
        '
        Me.colPLFPUR_AMOUNT.Caption = "Amount"
        Me.colPLFPUR_AMOUNT.ColumnEdit = Me.txtNumberic
        Me.colPLFPUR_AMOUNT.FieldName = "PLFPUR_AMOUNT"
        Me.colPLFPUR_AMOUNT.Name = "colPLFPUR_AMOUNT"
        Me.colPLFPUR_AMOUNT.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "PLFPUR_AMOUNT", "SUM={0:0.##}")})
        Me.colPLFPUR_AMOUNT.Visible = True
        Me.colPLFPUR_AMOUNT.VisibleIndex = 2
        Me.colPLFPUR_AMOUNT.Width = 150
        '
        'colPLFPUR_NOTE
        '
        Me.colPLFPUR_NOTE.Caption = "Remarks"
        Me.colPLFPUR_NOTE.ColumnEdit = Me.txtNote
        Me.colPLFPUR_NOTE.FieldName = "PLFPUR_NOTE"
        Me.colPLFPUR_NOTE.Name = "colPLFPUR_NOTE"
        Me.colPLFPUR_NOTE.Visible = True
        Me.colPLFPUR_NOTE.VisibleIndex = 3
        Me.colPLFPUR_NOTE.Width = 300
        '
        'colPLFPUR_DETAIL
        '
        Me.colPLFPUR_DETAIL.Caption = "Details"
        Me.colPLFPUR_DETAIL.FieldName = "PLFPUR_DETAIL"
        Me.colPLFPUR_DETAIL.Name = "colPLFPUR_DETAIL"
        Me.colPLFPUR_DETAIL.OptionsColumn.ReadOnly = True
        Me.colPLFPUR_DETAIL.OptionsColumn.TabStop = False
        Me.colPLFPUR_DETAIL.Visible = True
        Me.colPLFPUR_DETAIL.VisibleIndex = 5
        Me.colPLFPUR_DETAIL.Width = 100
        '
        'colPLFPUR_DEDUCTIBLE
        '
        Me.colPLFPUR_DEDUCTIBLE.Caption = "Deductible"
        Me.colPLFPUR_DEDUCTIBLE.ColumnEdit = Me.chkBox
        Me.colPLFPUR_DEDUCTIBLE.FieldName = "PLFPUR_DEDUCTIBLE"
        Me.colPLFPUR_DEDUCTIBLE.Name = "colPLFPUR_DEDUCTIBLE"
        Me.colPLFPUR_DEDUCTIBLE.Visible = True
        Me.colPLFPUR_DEDUCTIBLE.VisibleIndex = 4
        Me.colPLFPUR_DEDUCTIBLE.Width = 150
        '
        'colPecentageAmount
        '
        ...
        Me.BarManager1.Items.AddRange(New DevExpress.XtraBars.BarItem() {Me.btnAdd, Me.btnAddChild, Me.btnDelete, Me.btnDeleteChild, Me.btnExpand, Me.btnMoveUp, Me.btnMoveDown, Me.btnNote})
        ...
        Me.Bar1.LinksPersistInfo.AddRange(New DevExpress.XtraBars.LinkPersistInfo() {New DevExpress.XtraBars.LinkPersistInfo(Me.btnAdd), New DevExpress.XtraBars.LinkPersistInfo(Me.btnAddChild), New DevExpress.XtraBars.LinkPersistInfo(Me.btnDelete), New DevExpress.XtraBars.LinkPersistInfo(Me.btnDeleteChild), New DevExpress.XtraBars.LinkPersistInfo(Me.btnExpand), New DevExpress.XtraBars.LinkPersistInfo(Me.btnMoveUp), New DevExpress.XtraBars.LinkPersistInfo(Me.btnMoveDown), New DevExpress.XtraBars.LinkPersistInfo(Me.btnNote)})
    ...
    " continues with select delete row(s)."
        ...
        Me.barDockControlTop.Size = New System.Drawing.Size(1233, 39)
        '
        ...
        Me.barDockControlBottom.Size = New System.Drawing.Size(1233, 0)
        '
        'barDockControlLeft
        '
        ...
        Me.barDockControlRight.Location = New System.Drawing.Point(1233, 39)
        ...
        Me.Name = "ucPNL_p1Purchase"
        Me.Size = New System.Drawing.Size(1233, 513)
        ...
        CType(Me.PLFSTPURCHASEBindingSource, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents colPLFPUR_KEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFPUR_PLFPURKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFPUR_SOURCENO As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFPUR_DESC As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFPUR_AMOUNT As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFPUR_NOTE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFPUR_DETAIL As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFPUR_DEDUCTIBLE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFPURD_KEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFPURD_PLFPURKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFPURD_SOURCENO As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFPURD_PLFPURDKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFPURD_DESC As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFPURD_AMOUNT As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFPURD_NOTE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFPURD_DEDUCTIBLE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents chkBox As DevExpress.XtraEditors.Repository.RepositoryItemCheckEdit
    Friend WithEvents PLFSTPURCHASEBindingSource As System.Windows.Forms.BindingSource
