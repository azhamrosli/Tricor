...
Partial Class ucPNL_p1CloseStock
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ucPNL_p1CloseStock))
        ...
        Me.colPLFCSD_KEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFCSD_PLFCSKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFCSD_SOURCENO = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFCSD_PLFCSDKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFCSD_DESC = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFCSD_AMOUNT = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFCSD_NOTE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.GridControl1 = New DevExpress.XtraGrid.GridControl()
        Me.PLFSTCLOSESTOCKBindingSource = New System.Windows.Forms.BindingSource(Me.components)
        Me.DsPNL1 = New EasyTemplate_Taxcom.dsPNL()
        Me.GridView1 = New DevExpress.XtraGrid.Views.Grid.GridView()
        Me.colPLFCS_KEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFCS_PLFCSKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFCS_SOURCENO = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.colPLFCS_DESC = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFCS_AMOUNT = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.txtNumberic = New DevExpress.XtraEditors.Repository.RepositoryItemTextEdit()
        Me.colPLFCS_NOTE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.txtNote = New DevExpress.XtraEditors.Repository.RepositoryItemMemoEdit()
        Me.colPLFCS_DETAIL = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        CType(Me.PLFSTCLOSESTOCKBindingSource, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        'GridView2
        '
        Me.GridView2.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colPLFCSD_KEY, Me.colPLFCSD_PLFCSKEY, Me.colPLFCSD_SOURCENO, Me.colPLFCSD_PLFCSDKEY, Me.colPLFCSD_DESC, Me.colPLFCSD_AMOUNT, Me.colPLFCSD_NOTE})
        ...
        'colPLFCSD_KEY
        '
        Me.colPLFCSD_KEY.FieldName = "PLFCSD_KEY"
        Me.colPLFCSD_KEY.Name = "colPLFCSD_KEY"
        '
        'colPLFCSD_PLFCSKEY
        '
        Me.colPLFCSD_PLFCSKEY.FieldName = "PLFCSD_PLFCSKEY"
        Me.colPLFCSD_PLFCSKEY.Name = "colPLFCSD_PLFCSKEY"
        '
        'colPLFCSD_SOURCENO
        '
        Me.colPLFCSD_SOURCENO.FieldName = "PLFCSD_SOURCENO"
        Me.colPLFCSD_SOURCENO.Name = "colPLFCSD_SOURCENO"
        '
        'colPLFCSD_PLFCSDKEY
        '
        Me.colPLFCSD_PLFCSDKEY.FieldName = "PLFCSD_PLFCSDKEY"
        Me.colPLFCSD_PLFCSDKEY.Name = "colPLFCSD_PLFCSDKEY"
        '
        'colPLFCSD_DESC
        '
        Me.colPLFCSD_DESC.Caption = "Description"
        Me.colPLFCSD_DESC.FieldName = "PLFCSD_DESC"
        Me.colPLFCSD_DESC.Name = "colPLFCSD_DESC"
        Me.colPLFCSD_DESC.Visible = True
        Me.colPLFCSD_DESC.VisibleIndex = 0
        Me.colPLFCSD_DESC.Width = 300
        '
        'colPLFCSD_AMOUNT
        '
        Me.colPLFCSD_AMOUNT.Caption = "Amount"
        Me.colPLFCSD_AMOUNT.FieldName = "PLFCSD_AMOUNT"
        Me.colPLFCSD_AMOUNT.Name = "colPLFCSD_AMOUNT"
        Me.colPLFCSD_AMOUNT.Visible = True
        Me.colPLFCSD_AMOUNT.VisibleIndex = 1
        Me.colPLFCSD_AMOUNT.Width = 120
        '
        'colPLFCSD_NOTE
        '
        Me.colPLFCSD_NOTE.Caption = "Remarks"
        Me.colPLFCSD_NOTE.FieldName = "PLFCSD_NOTE"
        Me.colPLFCSD_NOTE.Name = "colPLFCSD_NOTE"
        Me.colPLFCSD_NOTE.Visible = True
        Me.colPLFCSD_NOTE.VisibleIndex = 2
        Me.colPLFCSD_NOTE.Width = 300
        '
        'GridControl1
        '
        Me.GridControl1.DataSource = Me.PLFSTCLOSESTOCKBindingSource
        Me.GridControl1.Dock = System.Windows.Forms.DockStyle.Fill
        Me.GridControl1.EmbeddedNavigator.Margin = New System.Windows.Forms.Padding(3, 4, 3, 4)
        GridLevelNode1.LevelTemplate = Me.GridView2
        GridLevelNode1.RelationName = "FK_PLFST_CLOSESTOCK_PLFST_CLOSESTOCK_DETAIL"
        ...
        Me.GridControl1.Size = New System.Drawing.Size(1164, 474)
        Me.GridControl1.TabIndex = 0
        Me.GridControl1.UseEmbeddedNavigator = True
        Me.GridControl1.ViewCollection.AddRange(New DevExpress.XtraGrid.Views.Base.BaseView() {Me.GridView1, Me.GridView2})
        '
        'PLFSTCLOSESTOCKBindingSource
        '
        Me.PLFSTCLOSESTOCKBindingSource.DataMember = "PLFST_CLOSESTOCK"
        Me.PLFSTCLOSESTOCKBindingSource.DataSource = Me.DsPNL1
        '
        'DsPNL1
        '
        ...
        'GridView1
        '
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colPLFCS_KEY, Me.colPLFCS_PLFCSKEY, Me.colPLFCS_SOURCENO, Me.colPLFCS_DESC, Me.colPLFCS_AMOUNT, Me.colPLFCS_NOTE, Me.colPLFCS_DETAIL})
        ...
        'colPLFCS_KEY
        '
        Me.colPLFCS_KEY.FieldName = "PLFCS_KEY"
        Me.colPLFCS_KEY.Name = "colPLFCS_KEY"
        '
        'colPLFCS_PLFCSKEY
        '
        Me.colPLFCS_PLFCSKEY.FieldName = "PLFCS_PLFCSKEY"
        Me.colPLFCS_PLFCSKEY.Name = "colPLFCS_PLFCSKEY"
        '
        'colPLFCS_SOURCENO
        '
        Me.colPLFCS_SOURCENO.Caption = "Source No"
        Me.colPLFCS_SOURCENO.ColumnEdit = Me.cboSourceNo
        Me.colPLFCS_SOURCENO.FieldName = "PLFCS_SOURCENO"
        Me.colPLFCS_SOURCENO.Name = "colPLFCS_SOURCENO"
        Me.colPLFCS_SOURCENO.Visible = True
        Me.colPLFCS_SOURCENO.VisibleIndex = 0
        Me.colPLFCS_SOURCENO.Width = 80
        '
        'cboSourceNo
        '
        ...
        'colPLFCS_DESC
        '
        Me.colPLFCS_DESC.Caption = "Description"
        Me.colPLFCS_DESC.FieldName = "PLFCS_DESC"
        Me.colPLFCS_DESC.Name = "colPLFCS_DESC"
        Me.colPLFCS_DESC.Visible = True
        Me.colPLFCS_DESC.VisibleIndex = 1
        Me.colPLFCS_DESC.Width = 300
        '
        'colPLFCS_AMOUNT
        '
        Me.colPLFCS_AMOUNT.Caption = "Amount"
        Me.colPLFCS_AMOUNT.ColumnEdit = Me.txtNumberic
        Me.colPLFCS_AMOUNT.FieldName = "PLFCS_AMOUNT"
        Me.colPLFCS_AMOUNT.Name = "colPLFCS_AMOUNT"
        Me.colPLFCS_AMOUNT.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "PLFCS_AMOUNT", "SUM={0:0.##}")})
        Me.colPLFCS_AMOUNT.Visible = True
        Me.colPLFCS_AMOUNT.VisibleIndex = 2
        Me.colPLFCS_AMOUNT.Width = 150
        '
        'txtNumberic
        '
        ...
        'colPLFCS_NOTE
        '
        Me.colPLFCS_NOTE.Caption = "Remarks"
        Me.colPLFCS_NOTE.ColumnEdit = Me.txtNote
        Me.colPLFCS_NOTE.FieldName = "PLFCS_NOTE"
        Me.colPLFCS_NOTE.Name = "colPLFCS_NOTE"
        Me.colPLFCS_NOTE.Visible = True
        Me.colPLFCS_NOTE.VisibleIndex = 3
        Me.colPLFCS_NOTE.Width = 300
        '
        'txtNote
        '
        ...
        'colPLFCS_DETAIL
        '
        Me.colPLFCS_DETAIL.Caption = "Details"
        Me.colPLFCS_DETAIL.FieldName = "PLFCS_DETAIL"
        Me.colPLFCS_DETAIL.Name = "colPLFCS_DETAIL"
        Me.colPLFCS_DETAIL.OptionsColumn.ReadOnly = True
        Me.colPLFCS_DETAIL.OptionsColumn.TabStop = False
        Me.colPLFCS_DETAIL.Visible = True
        Me.colPLFCS_DETAIL.VisibleIndex = 4
        Me.colPLFCS_DETAIL.Width = 150
        '
        'BarManager1
        '
    ...
    " continues with select delete row(s)."
        ...
        Me.barDockControlTop.Size = New System.Drawing.Size(1164, 39)
        '
        ...
        Me.barDockControlRight.Location = New System.Drawing.Point(1164, 39)
        ...
        Me.Name = "ucPNL_p1CloseStock"
        Me.Size = New System.Drawing.Size(1164, 513)
        CType(Me.GridView2, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.GridControl1, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.PLFSTCLOSESTOCKBindingSource, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents colPLFCSD_KEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFCSD_PLFCSKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFCSD_SOURCENO As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFCSD_PLFCSDKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFCSD_DESC As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFCSD_AMOUNT As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFCSD_NOTE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFCS_KEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFCS_PLFCSKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFCS_SOURCENO As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFCS_DESC As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFCS_AMOUNT As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFCS_NOTE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFCS_DETAIL As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents PLFSTCLOSESTOCKBindingSource As System.Windows.Forms.BindingSource
