...
Partial Class ucPNL_p2InterestIncome
    ...
    Private Sub InitializeComponent()
        ...
        Me.colNOBIID_KEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNOBIID_NOBIIKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNOBIID_NOBIIDKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNOBIID_DESC = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNOBIID_AMOUNT = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.txtNumberic = New DevExpress.XtraEditors.Repository.RepositoryItemTextEdit()
        Me.colNOBIID_NOTE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.txtNote = New DevExpress.XtraEditors.Repository.RepositoryItemMemoEdit()
        Me.colNOBIID_SOURCENO = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.GridControl1 = New DevExpress.XtraGrid.GridControl()
        Me.INCOMENBINTERESTBindingSource = New System.Windows.Forms.BindingSource(Me.components)
        Me.DsPNL1 = New EasyTemplate_Taxcom.dsPNL()
        Me.GridView1 = New DevExpress.XtraGrid.Views.Grid.GridView()
        Me.colNOBII_KEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNOBII_NOBIIKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNOBII_SOURCENO = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.colNOBII_DESC = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNOBII_AMOUNT = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNOBII_NOTE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colNOBII_DETAIL = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        CType(Me.INCOMENBINTERESTBindingSource, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        'GridView2
        '
        Me.GridView2.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colNOBIID_KEY, Me.colNOBIID_NOBIIKEY, Me.colNOBIID_NOBIIDKEY, Me.colNOBIID_DESC, Me.colNOBIID_AMOUNT, Me.colNOBIID_NOTE, Me.colNOBIID_SOURCENO})
        ...
        'colNOBIID_KEY
        '
        Me.colNOBIID_KEY.FieldName = "NOBIID_KEY"
        Me.colNOBIID_KEY.Name = "colNOBIID_KEY"
        '
        'colNOBIID_NOBIIKEY
        '
        Me.colNOBIID_NOBIIKEY.FieldName = "NOBIID_NOBIIKEY"
        Me.colNOBIID_NOBIIKEY.Name = "colNOBIID_NOBIIKEY"
        '
        'colNOBIID_NOBIIDKEY
        '
        Me.colNOBIID_NOBIIDKEY.FieldName = "NOBIID_NOBIIDKEY"
        Me.colNOBIID_NOBIIDKEY.Name = "colNOBIID_NOBIIDKEY"
        '
        'colNOBIID_DESC
        '
        Me.colNOBIID_DESC.Caption = "Description"
        Me.colNOBIID_DESC.FieldName = "NOBIID_DESC"
        Me.colNOBIID_DESC.Name = "colNOBIID_DESC"
        Me.colNOBIID_DESC.Visible = True
        Me.colNOBIID_DESC.VisibleIndex = 0
        Me.colNOBIID_DESC.Width = 300
        '
        'colNOBIID_AMOUNT
        '
        Me.colNOBIID_AMOUNT.Caption = "Amount"
        Me.colNOBIID_AMOUNT.ColumnEdit = Me.txtNumberic
        Me.colNOBIID_AMOUNT.FieldName = "NOBIID_AMOUNT"
        Me.colNOBIID_AMOUNT.Name = "colNOBIID_AMOUNT"
        Me.colNOBIID_AMOUNT.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "NOBIID_AMOUNT", "SUM={0:0.##}")})
        Me.colNOBIID_AMOUNT.Visible = True
        Me.colNOBIID_AMOUNT.VisibleIndex = 1
        Me.colNOBIID_AMOUNT.Width = 120
        '
        'txtNumberic
        '
        ...
        'colNOBIID_NOTE
        '
        Me.colNOBIID_NOTE.Caption = "Remarks"
        Me.colNOBIID_NOTE.ColumnEdit = Me.txtNote
        Me.colNOBIID_NOTE.FieldName = "NOBIID_NOTE"
        Me.colNOBIID_NOTE.Name = "colNOBIID_NOTE"
        Me.colNOBIID_NOTE.Visible = True
        Me.colNOBIID_NOTE.VisibleIndex = 2
        Me.colNOBIID_NOTE.Width = 150
        '
        'txtNote
        '
        ...
        'colNOBIID_SOURCENO
        '
        Me.colNOBIID_SOURCENO.FieldName = "NOBIID_SOURCENO"
        Me.colNOBIID_SOURCENO.Name = "colNOBIID_SOURCENO"
        '
        'GridControl1
        '
        Me.GridControl1.DataSource = Me.INCOMENBINTERESTBindingSource
        Me.GridControl1.Dock = System.Windows.Forms.DockStyle.Fill
        Me.GridControl1.EmbeddedNavigator.Margin = New System.Windows.Forms.Padding(3, 4, 3, 4)
        GridLevelNode1.LevelTemplate = Me.GridView2
        GridLevelNode1.RelationName = "FK_INCOME_NBINTEREST_INCOME_NBINTEREST_DETAIL"
        ...
        '
        'INCOMENBINTERESTBindingSource
        '
        Me.INCOMENBINTERESTBindingSource.DataMember = "INCOME_NBINTEREST"
        Me.INCOMENBINTERESTBindingSource.DataSource = Me.DsPNL1
        '
        'DsPNL1
        '
        ...
        'GridView1
        '
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colNOBII_KEY, Me.colNOBII_NOBIIKEY, Me.colNOBII_SOURCENO, Me.colNOBII_DESC, Me.colNOBII_AMOUNT, Me.colNOBII_NOTE, Me.colNOBII_DETAIL})
        ...
        'colNOBII_KEY
        '
        Me.colNOBII_KEY.FieldName = "NOBII_KEY"
        Me.colNOBII_KEY.Name = "colNOBII_KEY"
        '
        'colNOBII_NOBIIKEY
        '
        Me.colNOBII_NOBIIKEY.FieldName = "NOBII_NOBIIKEY"
        Me.colNOBII_NOBIIKEY.Name = "colNOBII_NOBIIKEY"
        '
        'colNOBII_SOURCENO
        '
        Me.colNOBII_SOURCENO.Caption = "Source No"
        Me.colNOBII_SOURCENO.ColumnEdit = Me.cboSourceNo
        Me.colNOBII_SOURCENO.FieldName = "NOBII_SOURCENO"
        Me.colNOBII_SOURCENO.Name = "colNOBII_SOURCENO"
        Me.colNOBII_SOURCENO.Visible = True
        Me.colNOBII_SOURCENO.VisibleIndex = 0
        Me.colNOBII_SOURCENO.Width = 80
        '
        'cboSourceNo
        '
        ...
        'colNOBII_DESC
        '
        Me.colNOBII_DESC.Caption = "Description"
        Me.colNOBII_DESC.FieldName = "NOBII_DESC"
        Me.colNOBII_DESC.Name = "colNOBII_DESC"
        Me.colNOBII_DESC.Visible = True
        Me.colNOBII_DESC.VisibleIndex = 1
        Me.colNOBII_DESC.Width = 300
        '
        'colNOBII_AMOUNT
        '
        Me.colNOBII_AMOUNT.Caption = "Amount"
        Me.colNOBII_AMOUNT.ColumnEdit = Me.txtNumberic
        Me.colNOBII_AMOUNT.FieldName = "NOBII_AMOUNT"
        Me.colNOBII_AMOUNT.Name = "colNOBII_AMOUNT"
        Me.colNOBII_AMOUNT.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "NOBII_AMOUNT", "SUM={0:0.##}")})
        Me.colNOBII_AMOUNT.Visible = True
        Me.colNOBII_AMOUNT.VisibleIndex = 2
        Me.colNOBII_AMOUNT.Width = 150
        '
        'colNOBII_NOTE
        '
        Me.colNOBII_NOTE.Caption = "Remakrs"
        Me.colNOBII_NOTE.ColumnEdit = Me.txtNote
        Me.colNOBII_NOTE.FieldName = "NOBII_NOTE"
        Me.colNOBII_NOTE.Name = "colNOBII_NOTE"
        Me.colNOBII_NOTE.Visible = True
        Me.colNOBII_NOTE.VisibleIndex = 3
        Me.colNOBII_NOTE.Width = 300
        '
        'colNOBII_DETAIL
        '
        Me.colNOBII_DETAIL.Caption = "Details"
        Me.colNOBII_DETAIL.FieldName = "NOBII_DETAIL"
        Me.colNOBII_DETAIL.Name = "colNOBII_DETAIL"
        Me.colNOBII_DETAIL.OptionsColumn.ReadOnly = True
        Me.colNOBII_DETAIL.OptionsColumn.TabStop = False
        Me.colNOBII_DETAIL.Visible = True
        Me.colNOBII_DETAIL.VisibleIndex = 4
        Me.colNOBII_DETAIL.Width = 150
        '
        'BarManager1
        '
    ...
    " continues with select delete row(s)."
        ...
        CType(Me.INCOMENBINTERESTBindingSource, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents colNOBIID_KEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNOBIID_NOBIIKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNOBIID_NOBIIDKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNOBIID_DESC As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNOBIID_AMOUNT As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNOBIID_NOTE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNOBIID_SOURCENO As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents INCOMENBINTERESTBindingSource As System.Windows.Forms.BindingSource
    Friend WithEvents colNOBII_KEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNOBII_NOBIIKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNOBII_SOURCENO As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNOBII_DESC As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNOBII_AMOUNT As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNOBII_NOTE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colNOBII_DETAIL As DevExpress.XtraGrid.Columns.GridColumn
