...
Partial Class ucPNL_p1Depreciation
    ...
    Private Sub InitializeComponent()
        ...
        Me.colEXDEPD_KEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXDEPD_EXDEPKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXDEPD_SOURCENO = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXDEPD_EXDEPDKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXDEPD_DESC = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXDEPD_AMOUNT = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.txtNumberic = New DevExpress.XtraEditors.Repository.RepositoryItemTextEdit()
        Me.colEXDEPD_DEDUCTIBLE = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.colEXDEP_EXDEPKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXDEP_SOURCENO = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.colEXDEP_DESC = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXDEP_AMOUNT = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXDEP_DEDUCTIBLE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXDEP_NOTE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXDEP_DETAIL = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        'GridView2
        '
        Me.GridView2.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colEXDEPD_KEY, Me.colEXDEPD_EXDEPKEY, Me.colEXDEPD_SOURCENO, Me.colEXDEPD_EXDEPDKEY, Me.colEXDEPD_DESC, Me.colEXDEPD_AMOUNT, Me.colEXDEPD_DEDUCTIBLE, Me.colEXDEPD_NOTE, Me.colPecentageAmount1})
        ...
        'colEXDEPD_KEY
        '
        Me.colEXDEPD_KEY.FieldName = "EXDEPD_KEY"
        Me.colEXDEPD_KEY.Name = "colEXDEPD_KEY"
        '
        'colEXDEPD_EXDEPKEY
        '
        Me.colEXDEPD_EXDEPKEY.FieldName = "EXDEPD_EXDEPKEY"
        Me.colEXDEPD_EXDEPKEY.Name = "colEXDEPD_EXDEPKEY"
        '
        'colEXDEPD_SOURCENO
        '
        Me.colEXDEPD_SOURCENO.FieldName = "EXDEPD_SOURCENO"
        Me.colEXDEPD_SOURCENO.Name = "colEXDEPD_SOURCENO"
        '
        'colEXDEPD_EXDEPDKEY
        '
        Me.colEXDEPD_EXDEPDKEY.FieldName = "EXDEPD_EXDEPDKEY"
        Me.colEXDEPD_EXDEPDKEY.Name = "colEXDEPD_EXDEPDKEY"
        '
        'colEXDEPD_DESC
        '
        Me.colEXDEPD_DESC.Caption = "Description"
        Me.colEXDEPD_DESC.FieldName = "EXDEPD_DESC"
        Me.colEXDEPD_DESC.Name = "colEXDEPD_DESC"
        Me.colEXDEPD_DESC.Visible = True
        Me.colEXDEPD_DESC.VisibleIndex = 0
        Me.colEXDEPD_DESC.Width = 300
        '
        'colEXDEPD_AMOUNT
        '
        Me.colEXDEPD_AMOUNT.Caption = "Amount"
        Me.colEXDEPD_AMOUNT.ColumnEdit = Me.txtNumberic
        Me.colEXDEPD_AMOUNT.FieldName = "EXDEPD_AMOUNT"
        Me.colEXDEPD_AMOUNT.Name = "colEXDEPD_AMOUNT"
        Me.colEXDEPD_AMOUNT.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "EXDEPD_AMOUNT", "SUM={0:0.##}")})
        Me.colEXDEPD_AMOUNT.Visible = True
        Me.colEXDEPD_AMOUNT.VisibleIndex = 1
        Me.colEXDEPD_AMOUNT.Width = 120
        '
        'txtNumberic
        '
        ...
        '
        'colEXDEPD_DEDUCTIBLE
        '
        Me.colEXDEPD_DEDUCTIBLE.Caption = "Deductible"
        Me.colEXDEPD_DEDUCTIBLE.ColumnEdit = Me.chkBox
        Me.colEXDEPD_DEDUCTIBLE.FieldName = "EXDEPD_DEDUCTIBLE"
        Me.colEXDEPD_DEDUCTIBLE.Name = "colEXDEPD_DEDUCTIBLE"
        Me.colEXDEPD_DEDUCTIBLE.Visible = True
        Me.colEXDEPD_DEDUCTIBLE.VisibleIndex = 2
        Me.colEXDEPD_DEDUCTIBLE.Width = 120
        '
        'chkBox
        '
        ...
        'colEXDEPD_NOTE
        '
        Me.colEXDEPD_NOTE.Caption = "Remarks"
        Me.colEXDEPD_NOTE.ColumnEdit = Me.txtNote
        Me.colEXDEPD_NOTE.FieldName = "EXDEPD_NOTE"
        Me.colEXDEPD_NOTE.Name = "colEXDEPD_NOTE"
        Me.colEXDEPD_NOTE.Visible = True
        Me.colEXDEPD_NOTE.VisibleIndex = 3
        Me.colEXDEPD_NOTE.Width = 300
        '
        'txtNote
        '
        ...
        'GridControl1
        '
        Me.GridControl1.DataSource = Me.EXPENSESDEPRECIATIONBindingSource
        Me.GridControl1.Dock = System.Windows.Forms.DockStyle.Fill
        Me.GridControl1.EmbeddedNavigator.Margin = New System.Windows.Forms.Padding(3, 4, 3, 4)
        GridLevelNode1.LevelTemplate = Me.GridView2
        GridLevelNode1.RelationName = "FK_EXPENSES_DEPRECIATION_EXPENSES_DEPRECIATION_DETAIL"
        ...
        Me.GridControl1.Size = New System.Drawing.Size(1190, 474)
        ...
        'GridView1
        '
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colEXDEP_KEY, Me.colEXDEP_EXDEPKEY, Me.colEXDEP_SOURCENO, Me.colEXDEP_DESC, Me.colEXDEP_AMOUNT, Me.colEXDEP_DEDUCTIBLE, Me.colEXDEP_NOTE, Me.colEXDEP_DETAIL, Me.colPecentageAmount})
        ...
        'colEXDEP_KEY
        '
        Me.colEXDEP_KEY.FieldName = "EXDEP_KEY"
        Me.colEXDEP_KEY.Name = "colEXDEP_KEY"
        '
        'colEXDEP_EXDEPKEY
        '
        Me.colEXDEP_EXDEPKEY.FieldName = "EXDEP_EXDEPKEY"
        Me.colEXDEP_EXDEPKEY.Name = "colEXDEP_EXDEPKEY"
        '
        'colEXDEP_SOURCENO
        '
        Me.colEXDEP_SOURCENO.Caption = "Source No"
        Me.colEXDEP_SOURCENO.ColumnEdit = Me.cboSourceNo
        Me.colEXDEP_SOURCENO.FieldName = "EXDEP_SOURCENO"
        Me.colEXDEP_SOURCENO.Name = "colEXDEP_SOURCENO"
        Me.colEXDEP_SOURCENO.Visible = True
        Me.colEXDEP_SOURCENO.VisibleIndex = 0
        Me.colEXDEP_SOURCENO.Width = 80
        '
        'cboSourceNo
        '
        ...
        'colEXDEP_DESC
        '
        Me.colEXDEP_DESC.Caption = "Description"
        Me.colEXDEP_DESC.FieldName = "EXDEP_DESC"
        Me.colEXDEP_DESC.Name = "colEXDEP_DESC"
        Me.colEXDEP_DESC.Visible = True
        Me.colEXDEP_DESC.VisibleIndex = 1
        Me.colEXDEP_DESC.Width = 300
        '
        'colEXDEP_AMOUNT
        '
        Me.colEXDEP_AMOUNT.Caption = "Amount"
        Me.colEXDEP_AMOUNT.ColumnEdit = Me.txtNumberic
        Me.colEXDEP_AMOUNT.FieldName = "EXDEP_AMOUNT"
        Me.colEXDEP_AMOUNT.Name = "colEXDEP_AMOUNT"
        Me.colEXDEP_AMOUNT.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "EXDEP_AMOUNT", "SUM={0:0.##}")})
        Me.colEXDEP_AMOUNT.Visible = True
        Me.colEXDEP_AMOUNT.VisibleIndex = 2
        Me.colEXDEP_AMOUNT.Width = 150
        '
        'colEXDEP_DEDUCTIBLE
        '
        Me.colEXDEP_DEDUCTIBLE.Caption = "Deductible"
        Me.colEXDEP_DEDUCTIBLE.ColumnEdit = Me.chkBox
        Me.colEXDEP_DEDUCTIBLE.FieldName = "EXDEP_DEDUCTIBLE"
        Me.colEXDEP_DEDUCTIBLE.Name = "colEXDEP_DEDUCTIBLE"
        Me.colEXDEP_DEDUCTIBLE.Visible = True
        Me.colEXDEP_DEDUCTIBLE.VisibleIndex = 3
        Me.colEXDEP_DEDUCTIBLE.Width = 150
        '
        'colEXDEP_NOTE
        '
        Me.colEXDEP_NOTE.Caption = "Remarks"
        Me.colEXDEP_NOTE.ColumnEdit = Me.txtNote
        Me.colEXDEP_NOTE.FieldName = "EXDEP_NOTE"
        Me.colEXDEP_NOTE.Name = "colEXDEP_NOTE"
        Me.colEXDEP_NOTE.Visible = True
        Me.colEXDEP_NOTE.VisibleIndex = 4
        Me.colEXDEP_NOTE.Width = 300
        '
        'colEXDEP_DETAIL
        '
        Me.colEXDEP_DETAIL.Caption = "Details"
        Me.colEXDEP_DETAIL.FieldName = "EXDEP_DETAIL"
        Me.colEXDEP_DETAIL.Name = "colEXDEP_DETAIL"
        Me.colEXDEP_DETAIL.OptionsColumn.ReadOnly = True
        Me.colEXDEP_DETAIL.OptionsColumn.TabStop = False
        Me.colEXDEP_DETAIL.Visible = True
        Me.colEXDEP_DETAIL.VisibleIndex = 5
        Me.colEXDEP_DETAIL.Width = 150
        '
        'colPecentageAmount
        '
    ...
    " continues with select delete row(s)."
        ...
        Me.barDockControlTop.Size = New System.Drawing.Size(1190, 39)
        '
        ...
        Me.barDockControlRight.Location = New System.Drawing.Point(1190, 39)
        ...
        Me.Size = New System.Drawing.Size(1190, 513)
    ...
    Friend WithEvents colEXDEPD_KEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXDEPD_EXDEPKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXDEPD_SOURCENO As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXDEPD_EXDEPDKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXDEPD_DESC As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXDEPD_AMOUNT As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXDEPD_DEDUCTIBLE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXDEPD_NOTE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXDEP_KEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXDEP_EXDEPKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXDEP_SOURCENO As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXDEP_DESC As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXDEP_AMOUNT As DevExpress.XtraGrid.Columns.GridColumn
