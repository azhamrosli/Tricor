...
#Region "DATABASE"
    ...
    Public Function Load_Note(ByVal Parent_KEY As Integer, ByVal KeyName As String, ByVal IsParent As Boolean, ByVal DataID As Integer, _
        ...
        Try
            ...
            Dim SQLcmd As SqlCommand
            Dim StrSQL As String = "SELECT * FROM PROFIT_LOSS_ACCOUNT_NOTE WHERE Parent_KEY=@Parent_KEY AND KeyName=@KeyName AND DataID=@DataID AND DataID=@DataID AND Data_SubID=@Data_SubID"
            SQLcmd = New SqlCommand With {
                .CommandText = StrSQL
            }
