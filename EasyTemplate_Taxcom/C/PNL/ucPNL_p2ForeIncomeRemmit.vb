...
Public Class ucPNL_p2ForeIncomeRemmit
    ...
    Public Const MainTable As String = "INCOME_NTFOREIGNINCREM" 'PLFST_SALES
    Public Const MainTable_Details As String = "INCOME_NTFOREIGNINCREM_DETAIL" 'PLFST_SALES_DETAIL
    Public Const MainKey As String = "NTIFIR_NTIFIRKEY" ' PLFS_KEY
    Public Const MainKey_Details As String = "NTIFIRD_NTIFIRKEY" 'PLFSD_PLFSKEY
    Public Const MainAmount As String = "NTIFIR_AMOUNT" 'PLFS_AMOUNT
    Public Const MainAmount_Details As String = "NTIFIRD_AMOUNT" 'PLFSD_AMOUNT
    Public Const MainSourceNo As String = "NTIFIR_SOURCENO" 'PLFS_SOURCENO
    Public Const MainSourceNo_Details As String = "NTIFIRD_SOURCENO" 'PLFS_SOURCENO
    Public Const MainDetail As String = "NTIFIR_DETAIL"  'PLFS_DETAIL
    Public Const MainDetails_Desc As String = "NTIFIRD_DESC"  'PLFSD_DESC
    Public Const Main_Desc As String = "NTIFIR_DESC"  'PLFSD_DESC
    ...
    Public Sub LoadData(Optional ByRef Errorlog As clsError = Nothing)
        Try
            ...
            INCOMENTFOREIGNINCREMBindingSource.DataSource = DsPNL1.Tables(MainTable)
