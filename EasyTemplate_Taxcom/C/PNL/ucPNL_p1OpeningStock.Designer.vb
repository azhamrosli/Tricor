...
Partial Class ucPNL_p1OpeningStock
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ucPNL_p1OpeningStock))
        ...
        Me.colPLFOSD_KEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFOSD_PLFOSKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFOSD_SOURCENO = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFOSD_PLFOSDKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFOSD_DESC = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFOSD_AMOUNT = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.colPLFOS_PLFOSKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFOS_SOURCENO = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.colPLFOS_DESC = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFOS_AMOUNT = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFOS_NOTE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colPLFOS_DETAIL = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        'GridView2
        '
        Me.GridView2.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colPLFOSD_KEY, Me.colPLFOSD_PLFOSKEY, Me.colPLFOSD_SOURCENO, Me.colPLFOSD_PLFOSDKEY, Me.colPLFOSD_DESC, Me.colPLFOSD_AMOUNT, Me.colPLFOSD_NOTE})
        ...
        'colPLFOSD_KEY
        '
        Me.colPLFOSD_KEY.FieldName = "PLFOSD_KEY"
        Me.colPLFOSD_KEY.Name = "colPLFOSD_KEY"
        '
        'colPLFOSD_PLFOSKEY
        '
        Me.colPLFOSD_PLFOSKEY.FieldName = "PLFOSD_PLFOSKEY"
        Me.colPLFOSD_PLFOSKEY.Name = "colPLFOSD_PLFOSKEY"
        '
        'colPLFOSD_SOURCENO
        '
        Me.colPLFOSD_SOURCENO.Caption = "Source No"
        Me.colPLFOSD_SOURCENO.FieldName = "PLFOSD_SOURCENO"
        Me.colPLFOSD_SOURCENO.Name = "colPLFOSD_SOURCENO"
        '
        'colPLFOSD_PLFOSDKEY
        '
        Me.colPLFOSD_PLFOSDKEY.FieldName = "PLFOSD_PLFOSDKEY"
        Me.colPLFOSD_PLFOSDKEY.Name = "colPLFOSD_PLFOSDKEY"
        '
        'colPLFOSD_DESC
        '
        Me.colPLFOSD_DESC.Caption = "Description"
        Me.colPLFOSD_DESC.FieldName = "PLFOSD_DESC"
        Me.colPLFOSD_DESC.Name = "colPLFOSD_DESC"
        Me.colPLFOSD_DESC.Visible = True
        Me.colPLFOSD_DESC.VisibleIndex = 0
        Me.colPLFOSD_DESC.Width = 300
        '
        'colPLFOSD_AMOUNT
        '
        Me.colPLFOSD_AMOUNT.Caption = "Amount"
        Me.colPLFOSD_AMOUNT.ColumnEdit = Me.txtNumberic
        Me.colPLFOSD_AMOUNT.FieldName = "PLFOSD_AMOUNT"
        Me.colPLFOSD_AMOUNT.Name = "colPLFOSD_AMOUNT"
        Me.colPLFOSD_AMOUNT.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "PLFOSD_AMOUNT", "SUM={0:0.##}")})
        Me.colPLFOSD_AMOUNT.Visible = True
        Me.colPLFOSD_AMOUNT.VisibleIndex = 1
        Me.colPLFOSD_AMOUNT.Width = 120
        '
        'txtNumberic
        '
        ...
        'colPLFOSD_NOTE
        '
        Me.colPLFOSD_NOTE.Caption = "Remarks"
        Me.colPLFOSD_NOTE.ColumnEdit = Me.txtNote
        Me.colPLFOSD_NOTE.FieldName = "PLFOSD_NOTE"
        Me.colPLFOSD_NOTE.Name = "colPLFOSD_NOTE"
        Me.colPLFOSD_NOTE.Visible = True
        Me.colPLFOSD_NOTE.VisibleIndex = 2
        Me.colPLFOSD_NOTE.Width = 300
        '
        'txtNote
        '
        ...
        'GridControl1
        '
        Me.GridControl1.DataSource = Me.PLFSTOPENSTOCKBindingSource
        Me.GridControl1.Dock = System.Windows.Forms.DockStyle.Fill
        Me.GridControl1.EmbeddedNavigator.Margin = New System.Windows.Forms.Padding(3, 4, 3, 4)
        GridLevelNode1.LevelTemplate = Me.GridView2
        GridLevelNode1.RelationName = "FK_PLFST_OPENSTOCK_PLFST_OPENSTOCK_DETAIL"
        ...
        Me.GridControl1.Size = New System.Drawing.Size(1270, 474)
        ...
        'GridView1
        '
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colPLFOS_KEY, Me.colPLFOS_PLFOSKEY, Me.colPLFOS_SOURCENO, Me.colPLFOS_DESC, Me.colPLFOS_AMOUNT, Me.colPLFOS_NOTE, Me.colPLFOS_DETAIL})
        ...
        'colPLFOS_KEY
        '
        Me.colPLFOS_KEY.FieldName = "PLFOS_KEY"
        Me.colPLFOS_KEY.Name = "colPLFOS_KEY"
        '
        'colPLFOS_PLFOSKEY
        '
        Me.colPLFOS_PLFOSKEY.FieldName = "PLFOS_PLFOSKEY"
        Me.colPLFOS_PLFOSKEY.Name = "colPLFOS_PLFOSKEY"
        '
        'colPLFOS_SOURCENO
        '
        Me.colPLFOS_SOURCENO.Caption = "Source No"
        Me.colPLFOS_SOURCENO.ColumnEdit = Me.cboSourceNo
        Me.colPLFOS_SOURCENO.FieldName = "PLFOS_SOURCENO"
        Me.colPLFOS_SOURCENO.Name = "colPLFOS_SOURCENO"
        Me.colPLFOS_SOURCENO.Visible = True
        Me.colPLFOS_SOURCENO.VisibleIndex = 0
        Me.colPLFOS_SOURCENO.Width = 80
        '
        'cboSourceNo
        '
        ...
        'colPLFOS_DESC
        '
        Me.colPLFOS_DESC.Caption = "Description"
        Me.colPLFOS_DESC.FieldName = "PLFOS_DESC"
        Me.colPLFOS_DESC.Name = "colPLFOS_DESC"
        Me.colPLFOS_DESC.Visible = True
        Me.colPLFOS_DESC.VisibleIndex = 1
        Me.colPLFOS_DESC.Width = 300
        '
        'colPLFOS_AMOUNT
        '
        Me.colPLFOS_AMOUNT.Caption = "Amount"
        Me.colPLFOS_AMOUNT.ColumnEdit = Me.txtNumberic
        Me.colPLFOS_AMOUNT.FieldName = "PLFOS_AMOUNT"
        Me.colPLFOS_AMOUNT.Name = "colPLFOS_AMOUNT"
        Me.colPLFOS_AMOUNT.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "PLFOS_AMOUNT", "SUM={0:0.##}")})
        Me.colPLFOS_AMOUNT.Visible = True
        Me.colPLFOS_AMOUNT.VisibleIndex = 2
        Me.colPLFOS_AMOUNT.Width = 150
        '
        'colPLFOS_NOTE
        '
        Me.colPLFOS_NOTE.Caption = "Remarks"
        Me.colPLFOS_NOTE.ColumnEdit = Me.txtNote
        Me.colPLFOS_NOTE.FieldName = "PLFOS_NOTE"
        Me.colPLFOS_NOTE.Name = "colPLFOS_NOTE"
        Me.colPLFOS_NOTE.Visible = True
        Me.colPLFOS_NOTE.VisibleIndex = 3
        Me.colPLFOS_NOTE.Width = 300
        '
        'colPLFOS_DETAIL
        '
        Me.colPLFOS_DETAIL.Caption = "Details"
        Me.colPLFOS_DETAIL.FieldName = "PLFOS_DETAIL"
        Me.colPLFOS_DETAIL.Name = "colPLFOS_DETAIL"
        Me.colPLFOS_DETAIL.OptionsColumn.ReadOnly = True
        Me.colPLFOS_DETAIL.OptionsColumn.TabStop = False
        Me.colPLFOS_DETAIL.Visible = True
        Me.colPLFOS_DETAIL.VisibleIndex = 4
        Me.colPLFOS_DETAIL.Width = 150
        '
        'BarManager1
        '
    ...
    " continues with select delete row(s)."
        ...
        Me.barDockControlTop.Size = New System.Drawing.Size(1270, 39)
        '
        ...
        Me.barDockControlBottom.Size = New System.Drawing.Size(1270, 0)
        '
        'barDockControlLeft
        '
        ...
        Me.barDockControlRight.Location = New System.Drawing.Point(1270, 39)
        ...
        Me.Name = "ucPNL_p1OpeningStock"
        Me.Size = New System.Drawing.Size(1270, 513)
    ...
    Friend WithEvents colPLFOSD_KEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFOSD_PLFOSKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFOSD_SOURCENO As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFOSD_PLFOSDKEY As DevExpress.XtraGrid.Columns.GridColumn
    ...
    Friend WithEvents colPLFOS_DESC As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFOS_AMOUNT As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colPLFOS_NOTE As DevExpress.XtraGrid.Columns.GridColumn
