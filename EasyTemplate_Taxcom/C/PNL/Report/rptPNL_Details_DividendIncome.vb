Public Class rptPNL_Details_DividendIncome
    Dim errorLog As ClsError = Nothing
    Private Sub lblTaxDeduct_BeforePrint(sender As Object, e As Printing.PrintEventArgs) Handles lblTaxDeduct.BeforePrint
        Try
            If lblTaxDeduct.Text.ToUpper = "SINGLE TIER" Then
                lblTaxDeduct.Text = "Single - Tier"
            End If
