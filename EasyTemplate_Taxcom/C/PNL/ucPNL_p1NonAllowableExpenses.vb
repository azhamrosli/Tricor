...
Public Class ucPNL_p1NonAllowableExpenses
    ...
    Public Const MainSourceNo As String = "EXNA_SOURCENO" 'PLFS_SOURCENO
    Public Const MainSourceNo_Details As String = "EXNAD_SOURCENO" 'PLFS_SOURCENO
    Public Const MainDetail As String = "EXNA_DETAIL"  'PLFS_DETAIL
    Public Const MainDetails_Desc As String = "EXNAD_DESC"  'PLFSD_DESC
    Public Const Main_Desc As String = "EXNA_DESC"  'PLFSD_DESC
    Public Const Main_Addback As String = "EXNA_DEDUCTIBLE"  'PLFSD_DESC
    Public Const MainDetails_Addback As String = "EXNAD_DEDUCTIBLE"  'PLFSD_DESC
