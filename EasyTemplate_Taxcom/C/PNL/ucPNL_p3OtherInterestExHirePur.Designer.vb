...
Partial Class ucPNL_p3OtherInterestExHirePur
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ucPNL_p3OtherInterestExHirePur))
        ...
        Me.colEXID_KEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXID_EXIKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXID_SOURCENO = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXID_EXIDKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXID_DESC = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXID_AMOUNT = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.txtNumberic = New DevExpress.XtraEditors.Repository.RepositoryItemTextEdit()
        Me.colEXID_DEDUCTIBLE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.chkBox = New DevExpress.XtraEditors.Repository.RepositoryItemCheckEdit()
        Me.colEXID_DEDUCTIBLE_ADD = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXID_NOTE = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.EXPENSESINTERESTBindingSource = New System.Windows.Forms.BindingSource(Me.components)
        Me.DsPNL1 = New EasyTemplate_Taxcom.dsPNL()
        Me.GridView1 = New DevExpress.XtraGrid.Views.Grid.GridView()
        Me.colEXI_KEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXI_EXIKEY = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXI_SOURCENO = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.colEXI_DESC = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXI_AMOUNT = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXI_NOTE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXI_DEDUCTIBLE = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXI_DEDUCTIBLE_ADD = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colEXI_DETAIL = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        CType(Me.EXPENSESINTERESTBindingSource, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        'GridView2
        '
        Me.GridView2.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colEXID_KEY, Me.colEXID_EXIKEY, Me.colEXID_SOURCENO, Me.colEXID_EXIDKEY, Me.colEXID_DESC, Me.colEXID_AMOUNT, Me.colEXID_DEDUCTIBLE, Me.colEXID_DEDUCTIBLE_ADD, Me.colEXID_NOTE, Me.colRowIndex1, Me.colPecentageAmount1})
        ...
        'colEXID_KEY
        '
        Me.colEXID_KEY.FieldName = "EXID_KEY"
        Me.colEXID_KEY.Name = "colEXID_KEY"
        '
        'colEXID_EXIKEY
        '
        Me.colEXID_EXIKEY.FieldName = "EXID_EXIKEY"
        Me.colEXID_EXIKEY.Name = "colEXID_EXIKEY"
        '
        'colEXID_SOURCENO
        '
        Me.colEXID_SOURCENO.FieldName = "EXID_SOURCENO"
        Me.colEXID_SOURCENO.Name = "colEXID_SOURCENO"
        '
        'colEXID_EXIDKEY
        '
        Me.colEXID_EXIDKEY.FieldName = "EXID_EXIDKEY"
        Me.colEXID_EXIDKEY.Name = "colEXID_EXIDKEY"
        '
        'colEXID_DESC
        '
        Me.colEXID_DESC.Caption = "Description"
        Me.colEXID_DESC.FieldName = "EXID_DESC"
        Me.colEXID_DESC.Name = "colEXID_DESC"
        Me.colEXID_DESC.Visible = True
        Me.colEXID_DESC.VisibleIndex = 0
        Me.colEXID_DESC.Width = 300
        '
        'colEXID_AMOUNT
        '
        Me.colEXID_AMOUNT.Caption = "Amount"
        Me.colEXID_AMOUNT.ColumnEdit = Me.txtNumberic
        Me.colEXID_AMOUNT.FieldName = "EXID_AMOUNT"
        Me.colEXID_AMOUNT.Name = "colEXID_AMOUNT"
        Me.colEXID_AMOUNT.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "EXID_AMOUNT", "SUM={0:0.##}")})
        Me.colEXID_AMOUNT.Visible = True
        Me.colEXID_AMOUNT.VisibleIndex = 1
        Me.colEXID_AMOUNT.Width = 120
        '
        'txtNumberic
        '
        ...
        'colEXID_DEDUCTIBLE
        '
        Me.colEXID_DEDUCTIBLE.Caption = "Add Back"
        Me.colEXID_DEDUCTIBLE.ColumnEdit = Me.chkBox
        Me.colEXID_DEDUCTIBLE.FieldName = "EXID_DEDUCTIBLE"
        Me.colEXID_DEDUCTIBLE.Name = "colEXID_DEDUCTIBLE"
        Me.colEXID_DEDUCTIBLE.Visible = True
        Me.colEXID_DEDUCTIBLE.VisibleIndex = 2
        Me.colEXID_DEDUCTIBLE.Width = 100
        '
        'chkBox
        '
        ...
        '
        'colEXID_DEDUCTIBLE_ADD
        '
        Me.colEXID_DEDUCTIBLE_ADD.Caption = "Deduct"
        Me.colEXID_DEDUCTIBLE_ADD.ColumnEdit = Me.chkBox
        Me.colEXID_DEDUCTIBLE_ADD.FieldName = "EXID_DEDUCTIBLE_ADD"
        Me.colEXID_DEDUCTIBLE_ADD.Name = "colEXID_DEDUCTIBLE_ADD"
        Me.colEXID_DEDUCTIBLE_ADD.Visible = True
        Me.colEXID_DEDUCTIBLE_ADD.VisibleIndex = 3
        Me.colEXID_DEDUCTIBLE_ADD.Width = 100
        '
        'colEXID_NOTE
        '
        Me.colEXID_NOTE.Caption = "Remarks"
        Me.colEXID_NOTE.ColumnEdit = Me.txtNote
        Me.colEXID_NOTE.FieldName = "EXID_NOTE"
        Me.colEXID_NOTE.Name = "colEXID_NOTE"
        Me.colEXID_NOTE.Visible = True
        Me.colEXID_NOTE.VisibleIndex = 4
        Me.colEXID_NOTE.Width = 300
        '
        'txtNote
        '
        ...
        'GridControl1
        '
        Me.GridControl1.DataSource = Me.EXPENSESINTERESTBindingSource
        Me.GridControl1.Dock = System.Windows.Forms.DockStyle.Fill
        Me.GridControl1.EmbeddedNavigator.Margin = New System.Windows.Forms.Padding(3, 4, 3, 4)
        GridLevelNode1.LevelTemplate = Me.GridView2
        GridLevelNode1.RelationName = "FK_EXPENSES_INTEREST_EXPENSES_INTEREST_DETAIL"
        ...
        Me.GridControl1.Size = New System.Drawing.Size(1080, 474)
        Me.GridControl1.TabIndex = 0
        Me.GridControl1.UseEmbeddedNavigator = True
        Me.GridControl1.ViewCollection.AddRange(New DevExpress.XtraGrid.Views.Base.BaseView() {Me.GridView1, Me.GridView2})
        '
        'EXPENSESINTERESTBindingSource
        '
        Me.EXPENSESINTERESTBindingSource.DataMember = "EXPENSES_INTEREST"
        Me.EXPENSESINTERESTBindingSource.DataSource = Me.DsPNL1
        '
        'DsPNL1
        '
        ...
        'GridView1
        '
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colEXI_KEY, Me.colEXI_EXIKEY, Me.colEXI_SOURCENO, Me.colEXI_DESC, Me.colEXI_AMOUNT, Me.colEXI_NOTE, Me.colEXI_DEDUCTIBLE, Me.colEXI_DEDUCTIBLE_ADD, Me.colEXI_DETAIL, Me.colRowIndex, Me.colPecentageAmount})
        ...
        'colEXI_KEY
        '
        Me.colEXI_KEY.FieldName = "EXI_KEY"
        Me.colEXI_KEY.Name = "colEXI_KEY"
        '
        'colEXI_EXIKEY
        '
        Me.colEXI_EXIKEY.FieldName = "EXI_EXIKEY"
        Me.colEXI_EXIKEY.Name = "colEXI_EXIKEY"
        '
        'colEXI_SOURCENO
        '
        Me.colEXI_SOURCENO.Caption = "Source No"
        Me.colEXI_SOURCENO.ColumnEdit = Me.cboSourceNo
        Me.colEXI_SOURCENO.FieldName = "EXI_SOURCENO"
        Me.colEXI_SOURCENO.Name = "colEXI_SOURCENO"
        Me.colEXI_SOURCENO.Visible = True
        Me.colEXI_SOURCENO.VisibleIndex = 0
        Me.colEXI_SOURCENO.Width = 80
        '
        'cboSourceNo
        '
        ...
        'colEXI_DESC
        '
        Me.colEXI_DESC.Caption = "Description"
        Me.colEXI_DESC.FieldName = "EXI_DESC"
        Me.colEXI_DESC.Name = "colEXI_DESC"
        Me.colEXI_DESC.Visible = True
        Me.colEXI_DESC.VisibleIndex = 1
        Me.colEXI_DESC.Width = 300
        '
        'colEXI_AMOUNT
        '
        Me.colEXI_AMOUNT.Caption = "Amount"
        Me.colEXI_AMOUNT.ColumnEdit = Me.txtNumberic
        Me.colEXI_AMOUNT.FieldName = "EXI_AMOUNT"
        Me.colEXI_AMOUNT.Name = "colEXI_AMOUNT"
        Me.colEXI_AMOUNT.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "EXI_AMOUNT", "SUM={0:0.##}")})
        Me.colEXI_AMOUNT.Visible = True
        Me.colEXI_AMOUNT.VisibleIndex = 2
        Me.colEXI_AMOUNT.Width = 150
        '
        'colEXI_NOTE
        '
        Me.colEXI_NOTE.Caption = "Remarks"
        Me.colEXI_NOTE.ColumnEdit = Me.txtNote
        Me.colEXI_NOTE.FieldName = "EXI_NOTE"
        Me.colEXI_NOTE.Name = "colEXI_NOTE"
        Me.colEXI_NOTE.Visible = True
        Me.colEXI_NOTE.VisibleIndex = 3
        Me.colEXI_NOTE.Width = 300
        '
        'colEXI_DEDUCTIBLE
        '
        Me.colEXI_DEDUCTIBLE.Caption = "Add Back"
        Me.colEXI_DEDUCTIBLE.ColumnEdit = Me.chkBox
        Me.colEXI_DEDUCTIBLE.FieldName = "EXI_DEDUCTIBLE"
        Me.colEXI_DEDUCTIBLE.Name = "colEXI_DEDUCTIBLE"
        Me.colEXI_DEDUCTIBLE.Visible = True
        Me.colEXI_DEDUCTIBLE.VisibleIndex = 4
        Me.colEXI_DEDUCTIBLE.Width = 100
        '
        'colEXI_DEDUCTIBLE_ADD
        '
        Me.colEXI_DEDUCTIBLE_ADD.Caption = "Deduct"
        Me.colEXI_DEDUCTIBLE_ADD.ColumnEdit = Me.chkBox
        Me.colEXI_DEDUCTIBLE_ADD.FieldName = "EXI_DEDUCTIBLE_ADD"
        Me.colEXI_DEDUCTIBLE_ADD.Name = "colEXI_DEDUCTIBLE_ADD"
        Me.colEXI_DEDUCTIBLE_ADD.Visible = True
        Me.colEXI_DEDUCTIBLE_ADD.VisibleIndex = 5
        Me.colEXI_DEDUCTIBLE_ADD.Width = 100
        '
        'colEXI_DETAIL
        '
        Me.colEXI_DETAIL.Caption = "Details"
        Me.colEXI_DETAIL.FieldName = "EXI_DETAIL"
        Me.colEXI_DETAIL.Name = "colEXI_DETAIL"
        Me.colEXI_DETAIL.OptionsColumn.ReadOnly = True
        Me.colEXI_DETAIL.OptionsColumn.TabStop = False
        Me.colEXI_DETAIL.Visible = True
        Me.colEXI_DETAIL.VisibleIndex = 6
        Me.colEXI_DETAIL.Width = 100
        '
        'colRowIndex
        '
    ...
    "ues with select child row(s)."
        ...
        Me.barDockControlTop.Size = New System.Drawing.Size(1080, 39)
        '
        ...
        Me.barDockControlRight.Location = New System.Drawing.Point(1080, 39)
        ...
        '
        'ucPNL_p3OtherInterestExHirePur
        '
        ...
        Me.Name = "ucPNL_p3OtherInterestExHirePur"
        Me.Size = New System.Drawing.Size(1080, 513)
        ...
        CType(Me.EXPENSESINTERESTBindingSource, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents colEXID_KEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXID_EXIKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXID_SOURCENO As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXID_EXIDKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXID_DESC As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXID_DEDUCTIBLE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXID_DEDUCTIBLE_ADD As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXID_AMOUNT As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXID_NOTE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colRowIndex1 As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents EXPENSESINTERESTBindingSource As System.Windows.Forms.BindingSource
    Friend WithEvents colEXI_KEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXI_EXIKEY As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXI_SOURCENO As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXI_DESC As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXI_AMOUNT As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXI_DEDUCTIBLE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXI_DEDUCTIBLE_ADD As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXI_NOTE As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colEXI_DETAIL As DevExpress.XtraGrid.Columns.GridColumn
