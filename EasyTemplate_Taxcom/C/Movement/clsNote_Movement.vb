...
#Region "DATABASE"
    Public Function Load_Note(Optional ByRef ErrorLog As ClsError = Nothing) As DataTable
        Try
            ...
            Dim StrSQL As String = "SELECT * FROM MOVEMENT_NOTE"
    ...
    Public Function Load_Note(ByVal ID As Decimal, Optional ByRef ErrorLog As ClsError = Nothing) As DataTable
        Try
            ...
            Dim SQLcmd As SqlCommand
            Dim StrSQL As String = "SELECT * FROM MOVEMENT_NOTE WHERE ID=@ID"
            SQLcmd = New SqlCommand With {
                .CommandText = StrSQL
            }
    ...
    Public Function Load_Note(ByVal RefNo As String, ByVal YA As String, Optional Title As String = "", Optional ByRef ErrorLog As ClsError = Nothing) As DataTable
        ...
        End Try
    End Function
    Public Function Load_Note(ByVal RefNo As String, ByVal YA As String, ByVal MM_ID As Integer, Optional ByRef ErrorLog As ClsError = Nothing) As DataTable
        Try
            Dim SqlCon As SqlConnection = Nothing
            ...
            Dim SQLcmd As SqlCommand
            Dim isWhere As Boolean = False
            Dim StrSQL As String = "SELECT * FROM MOVEMENT_NOTE WHERE RefNo=@RefNo AND YA=@YA AND MM_ID=@MM_ID"
            SQLcmd = New SqlCommand
            SQLcmd.Parameters.Add("@RefNo", SqlDbType.NVarChar, 20).Value = RefNo
            SQLcmd.Parameters.Add("@YA", SqlDbType.NVarChar, 5).Value = YA
        ...
        End Try
    End Function
    Public Function Load_Note(ByVal TagID As String, ByVal MM_ID As Integer, ByVal Type_Movement As Integer, ByVal Type_Addless As Integer, Optional ByRef ErrorLog As ClsError = Nothing) As DataTable
        Try
            Dim SqlCon As SqlConnection = Nothing
            ...
            Dim SQLcmd As SqlCommand
            Dim StrSQL As String = "SELECT * FROM MOVEMENT_NOTE WHERE TagID=@TagID AND MM_ID=@MM_ID AND Type_Movement=@Type_Movement AND Type_Addless=@Type_Addless"
            SQLcmd = New SqlCommand With {
                .CommandText = StrSQL
            }
            SQLcmd.Parameters.Add("@TagID", SqlDbType.NVarChar, 50).Value = TagID
            SQLcmd.Parameters.Add("@MM_ID", SqlDbType.Int).Value = MM_ID
            SQLcmd.Parameters.Add("@Type_Movement", SqlDbType.Int).Value = Type_Movement
            SQLcmd.Parameters.Add("@Type_Addless", SqlDbType.Int).Value = Type_Addless
    ...
    Public Function Load_Note_Attachment(ByVal ID As Decimal, Optional ByRef ErrorLog As ClsError = Nothing) As DataTable
        Try
            ...
            Dim SQLcmd As SqlCommand
            Dim StrSQL As String = "SELECT * FROM MOVEMENT_NOTE_ATTACHMENT WHERE ParentID=@ParentID"
            SQLcmd = New SqlCommand With {
                .CommandText = StrSQL
            }
    ...
    Public Function Load_Note_Attachment(ByVal ID As Decimal, ByVal ParentID As Decimal, Optional ByRef ErrorLog As ClsError = Nothing) As DataTable
        Try
            ...
            Dim SQLcmd As SqlCommand
            Dim StrSQL As String = "SELECT * FROM MOVEMENT_NOTE_ATTACHMENT WHERE MM_ID=@MM_ID ParentID=@ParentID"
            SQLcmd = New SqlCommand With {
                .CommandText = StrSQL
            }
            SQLcmd.Parameters.Add("@MM_ID", SqlDbType.Decimal).Value = ID
    ...
    Public Function Load_Note_Column(ByVal ID As Decimal, Optional ByRef ErrorLog As ClsError = Nothing) As DataTable
        Try
            ...
            Dim SQLcmd As SqlCommand
            Dim StrSQL As String = "SELECT * FROM MOVEMENT_NOTE_COLUMN WHERE ParentID=@ParentID"
            SQLcmd = New SqlCommand With {
                .CommandText = StrSQL
            }
            SQLcmd.Parameters.Add("@ParentID", SqlDbType.Decimal).Value = ID
    ...
    Public Function Load_Note_Column(ByVal ID As Decimal, ByVal ParentID As Decimal, Optional ByRef ErrorLog As ClsError = Nothing) As DataTable
        Try
            ...
            Dim SQLcmd As SqlCommand
            Dim StrSQL As String = "SELECT * FROM MOVEMENT_NOTE_COLUMN WHERE MM_ID=@MM_ID AND ParentID=@ParentID"
            SQLcmd = New SqlCommand With {
                .CommandText = StrSQL
            }
            SQLcmd.Parameters.Add("@MM_ID", SqlDbType.Decimal).Value = ID
    ...
    Public Function Save_Note(ByVal TitleFront As String, ByVal Title As String, ByVal RefNo As String, ByVal YA As String, _
                              ByVal MM_ID As Integer, ByVal Data_SubID As Integer, ByVal Type_Movement As Integer, _
                              ByVal TypeNote As NoteType, ByVal Type_Addless As Integer, ByVal Note As String, ByVal dtAttachment As DataTable, _
        ...
        Try
            ...
            Dim SQLcmd As SqlCommand
            Dim StrSQL As String = "INSERT INTO MOVEMENT_NOTE (Title,RefNo,YA,MM_ID,Data_SubID,Type_Movement,Type_Addless,TypeNote,Note,TagID,TitleFront) VALUES (@Title,@RefNo,@YA,@MM_ID,@Data_SubID,@Type_Movement,@Type_Addless,@TypeNote,@Note,@TagID,@TitleFront)"
            SQLcmd = New SqlCommand With {
                .CommandText = StrSQL
            }
            SQLcmd.Parameters.Add("@Title", SqlDbType.NVarChar, 250).Value = Title
                    ...
                    Case NoteType.ATTACHMENT
                        ...
                        If dtAttachment IsNot Nothing Then
                            ...
                            For Each rowx As DataRow In dtAttachment.Rows
                                StrSQL = Nothing
                                SQLcmd = Nothing
                                StrSQL = "INSERT INTO MOVEMENT_NOTE_ATTACHMENT(ParentID,Attachment,Extension) VALUES (@ParentID,@Attachment,@Extension)"
                                SQLcmd = New SqlCommand With {
                                    .CommandText = StrSQL
                                }
                    ...
                    Case NoteType.COLUMN
                        If dtColumn IsNot Nothing Then
                            ...
                            For Each rowx As DataRow In dtColumn.Rows
                                StrSQL = Nothing
                                SQLcmd = Nothing
                                StrSQL = "INSERT INTO MOVEMENT_NOTE_COLUMN(ParentID,Col1_Name,Col1_Val,Col2_Name,Col2_Val,Col3_Name,Col3_Val,Col4_Name,Col4_Val,Col5_Name,Col5_Val,Col6_Name,Col6_Val) VALUES (@ParentID,@Col1_Name,@Col1_Val,@Col2_Name,@Col2_Val,@Col3_Name,@Col3_Val,@Col4_Name,@Col4_Val,@Col5_Name,@Col5_Val,@Col6_Name,@Col6_Val)"
                                SQLcmd = New SqlCommand With {
                                    .CommandText = StrSQL
                                }
                                SQLcmd.Parameters.Add("@ParentID", SqlDbType.Decimal).Value = ReturnID
    ...
    Public Function Update_Note(ByVal ID As Decimal, ByVal TitleFront As String, ByVal Title As String, ByVal RefNo As String, ByVal YA As String, _
                              ByVal MM_ID As Integer, ByVal Data_SubID As Integer, ByVal Type_Movement As String, _
                              ByVal TypeNote As NoteType, ByVal Type_AddLess As Integer, ByVal Note As String, ByVal dtAttachment As DataTable, _
        ...
        Try
            ...
            StrSQL = "DELETE MOVEMENT_NOTE_ATTACHMENT WHERE ParentID=@ParentID"
            SQLcmd = New SqlCommand With {
                .CommandText = StrSQL
            }
            SQLcmd.Parameters.Add("@ParentID", SqlDbType.Decimal).Value = ID
            ...
            StrSQL = "DELETE MOVEMENT_NOTE_COLUMN WHERE ParentID=@ParentID"
            SQLcmd = New SqlCommand With {
                .CommandText = StrSQL
            }
            SQLcmd.Parameters.Add("@ParentID", SqlDbType.Decimal).Value = ID
            ...
            StrSQL = "UPDATE MOVEMENT_NOTE SET Title=@Title,RefNo=@RefNo,YA=@YA,MM_ID=@MM_ID,Data_SubID=@Data_SubID,Type_Movement=@Type_Movement,Type_AddLess=@Type_AddLess,TypeNote=@TypeNote,Note=@Note,TagID=@TagID,TitleFront=@TitleFront WHERE ID=@ID"
            SQLcmd = New SqlCommand With {
                .CommandText = StrSQL
            }
            SQLcmd.Parameters.Add("@ID", SqlDbType.Decimal).Value = ID
    ...
    Public Function Delete_Note(ByVal ID As Integer, Optional ByRef ErrorLog As ClsError = Nothing) As Boolean
        Try
            ...
            StrSQL = "DELETE MOVEMENT_NOTE WHERE ID=@ID"
            SQLcmd = New SqlCommand With {
                .CommandText = StrSQL
            }
            SQLcmd.Parameters.Add("@ID", SqlDbType.Decimal).Value = ID
